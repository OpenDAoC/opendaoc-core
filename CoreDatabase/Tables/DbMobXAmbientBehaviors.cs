...
public class DbMobXAmbientBehaviors : DataObject
{
	...
	public DbMobXAmbientBehaviors(string name, string trigger, ushort emote, string text, ushort chance, string voice)
	{
		m_source = name;
		m_trigger = trigger;
		m_emote = emote;
