...
namespace DOL.Database
{
	...
	public class DbKeepHookPointItems : DataObject
	{
		...
		public DbKeepHookPointItems()
			: base()
		{ }

		public DbKeepHookPointItems(int keepID, int componentID, int hookPointID, string classType)
			: base()
		{
			m_keepID = keepID;
