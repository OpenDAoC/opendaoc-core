...
namespace DOL.Database
{
	...
	public class DbKeepComponents : DataObject
	{
		...
		/// Create a component of keep (wall, tower,gate, ...)
		/// </summary>
		public DbKeepComponents(int componentID, int componentSkinID, int componentX, int componentY, int componentHead, int componentHeight, int componentHealth, int keepid, string createInfo) : this()
		{
