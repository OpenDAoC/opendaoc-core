...
namespace DOL.GS.Spells
{
	...
	public class BeadRegen : PropertyChangingSpell 
	{
		...
		public override bool StartSpell(GameLiving target)
		{
			...
			if(Caster.ControlledBrain != null && Caster.ControlledBrain is AI.Brain.PetServantBrain necroPet && necroPet.Body.InCombatInLast(5000))
            {
				if (Caster is GamePlayer p)
			...
			if(Caster.ControlledBrain != null && Caster.ControlledBrain is AI.Brain.PetServantBrain necrop)
            {
