namespace DOL.GS.Spells
{
	...
	public class AtensShield : SummonItemSpellHandler
	{
		...
		private DbItemTemplates m_goldenTridentofFlame;
			...
			: base(caster, spell, line)
		{
			...
			{
				m_goldenTridentofFlame = GameServer.Database.FindObjectByKey<DbItemTemplates>("Golden_Trident_of_Flame") ?? Javelin;
			...
			{
				m_goldenTridentofFlame = GameServer.Database.FindObjectByKey<DbItemTemplates>("Golden_Trident_of_Flame") ?? JavelinM;
				items.Add (GameInventoryItem.Create(m_goldenTridentofFlame));
				return;
			}
			if (caster.Realm == eRealm.Hibernia)
			{
				m_goldenTridentofFlame = GameServer.Database.FindObjectByKey<DbItemTemplates>("Golden_Trident_of_Flame") ?? JavelinH;
				items.Add (GameInventoryItem.Create(m_goldenTridentofFlame));
				return;
			}
		}
		...
		private DbItemTemplates Javelin
		{
			get
			{
				m_goldenTridentofFlame = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("Golden_Trident_of_Flame");
				if (m_goldenTridentofFlame == null)
				{
					if (log.IsWarnEnabled) log.Warn("Could not find Golden_Trident_of_Flame, loading it ...");
					m_goldenTridentofFlame = new DbItemTemplates();
		...
		private DbItemTemplates JavelinM
		{
			get
			{
				m_goldenTridentofFlame = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("Golden_Trident_of_FlameM");
				if (m_goldenTridentofFlame == null)
				{
					if (log.IsWarnEnabled) log.Warn("Could not find Golden_Trident_of_Flame, loading it ...");
					m_goldenTridentofFlame = new DbItemTemplates();
		...
		private DbItemTemplates JavelinH
		{
			get
			{
				m_goldenTridentofFlame = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("Golden_Trident_of_FlameH");
				if (m_goldenTridentofFlame == null)
				{
					if (log.IsWarnEnabled) log.Warn("Could not find Golden_Trident_of_Flame, loading it ...");
					m_goldenTridentofFlame = new DbItemTemplates();
