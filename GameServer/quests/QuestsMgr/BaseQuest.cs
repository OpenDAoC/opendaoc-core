...
namespace DOL.GS.Quests
{
	...
	public abstract class BaseQuest : AbstractQuest
	{
		...
		public BaseQuest(GamePlayer questingPlayer, DbQuests dbQuest)
		...
		protected struct QuestStepInteraction
		{
			...
			public DbItemTemplates itemResult;
		...
		protected void AddInteractStep(int step, string objectName, int numRequired, DbItemTemplates itemResult, string interactText)
		{
			try
			{
