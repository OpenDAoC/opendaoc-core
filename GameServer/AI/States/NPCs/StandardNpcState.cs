...
{
    public class StandardNpcState : FsmAttribute
    {
        protected static readonly ILog log = LogManager.GetLogger(MethodBase.GetCurrentMethod().DeclaringType);

        protected StandardNpcBrain _brain = null;

        public StandardNpcState(StandardNpcBrain brain) : base()
        {
            _brain = brain;
        }
    ...
    public class StandardNpcState_Idle : StandardNpcState
    {
        public StandardNpcState_Idle(StandardNpcBrain brain) : base(brain)
        {
        ...
        public override void Think()
        {
            ...
            _brain.CheckSpells(StandardNpcBrain.eCheckSpellType.Defensive);
            base.Think();
        }
    }

    public class StandardNpcState_WakingUp : StandardNpcState
    {
        public StandardNpcState_WakingUp(StandardNpcBrain brain) : base(brain)
        {
    ...
    public class StandardNpcState_Aggro : StandardNpcState
    {
        ...
        public StandardNpcState_Aggro(StandardNpcBrain brain) : base(brain)
        {
    ...
    public class StandardNpcState_Roaming : StandardNpcState
    {
        private const int ROAM_COOLDOWN = 45 * 1000;
        private long _lastRoamTick = 0;

        public StandardNpcState_Roaming(StandardNpcBrain brain) : base(brain)
        {
    ...
    public class StandardNpcState_ReturnToSpawn : StandardNpcState
    {
        public StandardNpcState_ReturnToSpawn(StandardNpcBrain brain) : base(brain)
        {
    ...
    public class StandardNpcState_Patrolling : StandardNpcState
    {
        public StandardNpcState_Patrolling(StandardNpcBrain brain) : base(brain)
        {
    ...
    public class StandardNpcState_Dead : StandardNpcState
    {
        public StandardNpcState_Dead(StandardNpcBrain brain) : base(brain)
        {
