...
namespace DOL.AI.Brain
{
    ...
    /// </summary>
    public class PetServantBrain : NpcControlledBrain
    {
        public PetServantBrain(GameLiving owner) : base(owner)
        {
            FSM.ClearStates();

            FSM.Add(new PetServantState_WakingUp(this));
            FSM.Add(new PetServantState_Defensive(this));
            FSM.Add(new PetServantState_Aggro(this));
            FSM.Add(new PetServantState_Passive(this));
