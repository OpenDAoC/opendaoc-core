...
namespace DOL.AI.Brain
{
	...
	/// </summary>
	public class NpcControlledBrain : StandardNpcBrain, IControlledBrain
	{
		/// <summary>
		...
		public NpcControlledBrain(GameLiving owner) : base()
		{
			...
			if (owner is GameNPC npcOwner && npcOwner.Brain is StandardNpcBrain npcOwnerBrain)
			...
			FSM.Add(new NpcControlledState_WakingUp(this));
			FSM.Add(new NpcControlledState_Passive(this));
			FSM.Add(new NpcControlledState_Defensive(this));
			FSM.Add(new NpcControlledState_Aggro(this));
		...
		public override void AttackMostWanted()
		{
			...
			if (owner_npc != null && owner_npc.Brain is StandardNpcBrain)
			{
