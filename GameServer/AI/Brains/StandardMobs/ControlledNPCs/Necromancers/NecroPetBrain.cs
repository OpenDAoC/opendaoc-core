...
namespace DOL.AI.Brain
{
    ...
    public class NecroPetBrain : ControlledNpcBrain
    {
        public NecroPetBrain(GameLiving owner) : base(owner)
        {
            FSM.ClearStates();

            FSM.Add(new NecroPetState_WakingUp(FSM, this));
            FSM.Add(new NecroPetState_Defensive(FSM, this));
            FSM.Add(new NecroPetState_Aggro(FSM, this));
