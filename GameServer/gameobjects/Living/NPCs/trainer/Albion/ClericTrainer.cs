...
namespace DOL.GS.Trainer
{
	...
	/// Cleric Trainer
	/// </summary>
	[NpcGuild("Cleric Trainer", ERealm.Albion)]		// this attribute instructs DOL to use this script for all "Cleric Trainer" NPC's in Albion (multiple guilds are possible for one script)
