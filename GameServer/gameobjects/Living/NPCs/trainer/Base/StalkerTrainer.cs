...
namespace DOL.GS.Trainer
{
	...
	/// Stalker Trainer
	/// </summary>
	[NpcGuild("Stalker Trainer", ERealm.Hibernia)]		// this attribute instructs DOL to use this script for all "Stalker Trainer" NPC's in Albion (multiple guilds are possible for one script)
