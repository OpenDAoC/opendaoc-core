...
namespace DOL.GS.Trainer
{
	...
	/// Warden Trainer
	/// </summary>
	[NpcGuild("Warden Trainer", ERealm.Hibernia)]		// this attribute instructs DOL to use this script for all "Warden Trainer" NPC's in Albion (multiple guilds are possible for one script)
