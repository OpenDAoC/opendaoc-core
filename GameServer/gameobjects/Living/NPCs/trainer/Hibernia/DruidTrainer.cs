...
namespace DOL.GS.Trainer
{
	...
	/// Druid Trainer
	/// </summary>
	[NpcGuild("Druid Trainer", ERealm.Hibernia)]		// this attribute instructs DOL to use this script for all "Druid Trainer" NPC's in Albion (multiple guilds are possible for one script)
