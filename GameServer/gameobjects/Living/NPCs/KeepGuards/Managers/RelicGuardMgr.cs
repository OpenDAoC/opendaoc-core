...
namespace DOL.GS.GameEvents
{
    public class RelicGuardMgr
    {
        ...
        private static GuardRelicKeepFighter BenoCE = null;
        private static GuardRelicKeepFighter BenoCM = null;
        private static GuardRelicKeepFighter SursCE = null;
        private static GuardRelicKeepFighter SursCM = null;
        private static GuardRelicKeepFighter ErasCE = null;
        private static GuardRelicKeepFighter ErasCM = null;
        private static GuardRelicKeepFighter BercCE = null;
        private static GuardRelicKeepFighter BercCM = null;
        private static GuardRelicKeepFighter BoldCE = null;
        private static GuardRelicKeepFighter BoldCM = null;
        private static GuardRelicKeepFighter RenaCE = null;
        private static GuardRelicKeepFighter HurbuCM = null;

        #endregion Albion

        #region Midgard

        private static GuardRelicKeepFighter BledGF = null;
        private static GuardRelicKeepFighter BledMF = null;
        private static GuardRelicKeepFighter NottGF = null;
        private static GuardRelicKeepFighter NottMF = null;
        private static GuardRelicKeepFighter BlendGF = null;
        private static GuardRelicKeepFighter BlendMF = null;
        private static GuardRelicKeepFighter GlenGF = null;
        private static GuardRelicKeepFighter GlenMF = null;
        private static GuardRelicKeepFighter HlidGF = null;
        private static GuardRelicKeepFighter HlidMF = null;
        private static GuardRelicKeepFighter ArvaGF = null;
        private static GuardRelicKeepFighter FensMF = null;

        #endregion Midgard

        #region Hibernia

        private static GuardRelicKeepFighter CrauDL = null;
        private static GuardRelicKeepFighter CrauDD = null;
        private static GuardRelicKeepFighter AiliDL = null;
        private static GuardRelicKeepFighter ScatDL = null;
        private static GuardRelicKeepFighter BehnDL = null;
        private static GuardRelicKeepFighter BehnDD = null;
        private static GuardRelicKeepFighter BolgDL = null;
        private static GuardRelicKeepFighter BolgDD = null;
        private static GuardRelicKeepFighter CrimDL = null;
        private static GuardRelicKeepFighter CrimDD = null;
        private static GuardRelicKeepFighter nGedDL = null;
        private static GuardRelicKeepFighter nGedDD = null;
        ...
        {
            RenaCE = new GuardRelicKeepFighter();
            RenaCE.X = 601801;
            RenaCE.Y = 428234;
            RenaCE.Z = 5645;
            RenaCE.Heading = 2055;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(RenaCE);

            HurbuCM = new GuardRelicKeepFighter();
            HurbuCM.X = 508047;
            HurbuCM.Y = 310852;
            HurbuCM.Z = 6832;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(HurbuCM);

            BercCE = new GuardRelicKeepFighter();
            BercCE.X = 602200;
            BercCE.Y = 428233;
            BercCE.Z = 5539;
            BercCE.Heading = 2035;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(BercCE);

            BercCM = new GuardRelicKeepFighter();
            BercCM.X = 508642;
            BercCM.Y = 310348;
            BercCM.Z = 6832;
            BercCM.Heading = 3638;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(BercCM);

            SursCE = new GuardRelicKeepFighter();
            SursCE.X = 601527;
            SursCE.Y = 428233;
            SursCE.Z = 5628;
            SursCE.Heading = 2062;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(SursCE);

            SursCM = new GuardRelicKeepFighter();
            SursCM.X = 507894;
            SursCM.Y = 310323;
            SursCM.Z = 6832;
            SursCM.Heading = 3638;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(SursCM);

            BoldCE = new GuardRelicKeepFighter();
            BoldCE.X = 601769;
            BoldCE.Y = 427991;
            BoldCE.Z = 5544;
            BoldCE.Heading = 2055;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(BoldCE);

            BoldCM = new GuardRelicKeepFighter();
            BoldCM.X = 508354;
            BoldCM.Y = 310593;
            BoldCM.Z = 6832;
            BoldCM.Heading = 3638;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(BoldCM);

            ErasCE = new GuardRelicKeepFighter();
            ErasCE.X = 601096;
            ErasCE.Y = 428255;
            ErasCE.Z = 5606;
            ErasCE.Heading = 2035;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(ErasCE);

            ErasCM = new GuardRelicKeepFighter();
            ErasCM.X = 507705;
            ErasCM.Y = 311142;
            ErasCM.Z = 6832;
            ErasCM.Heading = 3638;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(ErasCM);

            BenoCE = new GuardRelicKeepFighter();
            BenoCE.X = 601595;
            BenoCE.Y = 427989;
            BenoCE.Z = 5547;
            BenoCE.Heading = 2055;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(BenoCE);

            BenoCM = new GuardRelicKeepFighter();
            BenoCM.X = 508253;
            BenoCM.Y = 310751;
            BenoCM.Z = 6832;
            BenoCM.Heading = 3640;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(BenoCM);

            FensMF = new GuardRelicKeepFighter();
            FensMF.X = 771263;
            FensMF.Y = 628729;
            FensMF.Z = 6992;
            FensMF.Heading = 3989;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(FensMF);

            ArvaGF = new GuardRelicKeepFighter();
            ArvaGF.X = 678770;
            ArvaGF.Y = 710252;
            ArvaGF.Z = 6912;
            ArvaGF.Heading = 2963;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(ArvaGF);

            GlenGF = new GuardRelicKeepFighter();
            GlenGF.X = 679248;
            GlenGF.Y = 710497;
            GlenGF.Z = 6836;
            GlenGF.Heading = 2950;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(GlenGF);

            GlenMF = new GuardRelicKeepFighter();
            GlenMF.X = 769816;
            GlenMF.Y = 627702;
            GlenMF.Z = 6992;
            GlenMF.Heading = 923;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(GlenMF);

            BlendGF = new GuardRelicKeepFighter();
            BlendGF.X = 679164;
            BlendGF.Y = 711149;
            BlendGF.Z = 6868;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(BlendGF);

            BlendMF = new GuardRelicKeepFighter();
            BlendMF.X = 770036;
            BlendMF.Y = 628191;
            BlendMF.Z = 6941;
            BlendMF.Heading = 503;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(BlendMF);

            HlidGF = new GuardRelicKeepFighter();
            HlidGF.X = 679128;
            HlidGF.Y = 709873;
            HlidGF.Z = 6787;
            HlidGF.Heading = 2950;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(HlidGF);

            HlidMF = new GuardRelicKeepFighter();
            HlidMF.X = 770615;
            HlidMF.Y = 628037;
            HlidMF.Z = 6992;
            HlidMF.Heading = 521;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(HlidMF);

            NottGF = new GuardRelicKeepFighter();
            NottGF.X = 678654;
            NottGF.Y = 709122;
            NottGF.Z = 6912;
            NottGF.Heading = 2511;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(NottGF);
            NottMF = new GuardRelicKeepFighter();
            NottMF.X = 770531;
            NottMF.Y = 628482;
            NottMF.Z = 6985;
            NottMF.Heading = 503;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(NottMF);

            BledGF = new GuardRelicKeepFighter();
            BledGF.X = 679121;
            BledGF.Y = 710193;
            BledGF.Z = 6873;
            BledGF.Heading = 2965;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(BledGF);

            BledMF = new GuardRelicKeepFighter();
            BledMF.X = 770308;
            BledMF.Y = 628344;
            BledMF.Z = 6969;
            BledMF.Heading = 513;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(BledMF);

            AiliDL = new GuardRelicKeepFighter();
            AiliDL.X = 348542;
            AiliDL.Y = 371526;
            AiliDL.Z = 4880;
            AiliDL.Heading = 2052;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(AiliDL);

            ScatDL = new GuardRelicKeepFighter();
            ScatDL.X = 401953;
            ScatDL.Y = 464351;
            ScatDL.Z = 2888;
            ScatDL.Heading = 2567;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(ScatDL);

            nGedDL = new GuardRelicKeepFighter();
            nGedDL.X = 348211;
            nGedDL.Y = 370945;
            nGedDL.Z = 4784;
            nGedDL.Heading = 2212;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(nGedDL);

            nGedDD = new GuardRelicKeepFighter();
            nGedDD.X = 402193;
            nGedDD.Y = 463725;
            nGedDD.Z = 2854;
            nGedDD.Heading = 2565;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(nGedDD);

            BolgDL = new GuardRelicKeepFighter();
            BolgDL.X = 347374;
            BolgDL.Y = 371175;
            BolgDL.Z = 4809;
            BolgDL.Heading = 1690;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(BolgDL);

            BolgDD = new GuardRelicKeepFighter();
            BolgDD.X = 401172;
            BolgDD.Y = 463380;
            BolgDD.Z = 2884;
            BolgDD.Heading = 2239;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(BolgDD);

            BehnDL = new GuardRelicKeepFighter();
            BehnDL.X = 348841;
            BehnDL.Y = 371000;
            BehnDL.Z = 4688;
            BehnDL.Heading = 2012;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(BehnDL);

            BehnDD = new GuardRelicKeepFighter();
            BehnDD.X = 402899;
            BehnDD.Y = 465176;
            BehnDD.Z = 2848;
            BehnDD.Heading = 2978;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(BehnDD);

            CrimDL = new GuardRelicKeepFighter();
            CrimDL.X = 349191;
            CrimDL.Y = 371458;
            CrimDL.Z = 4877;
            CrimDL.Heading = 2253;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(CrimDL);

            CrimDD = new GuardRelicKeepFighter();
            CrimDD.X = 402337;
            CrimDD.Y = 463993;
            CrimDD.Z = 2862;
            CrimDD.Heading = 2565;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(CrimDD);

            CrauDL = new GuardRelicKeepFighter();
            CrauDL.X = 348634;
            CrauDL.Y = 371189;
            CrauDL.Z = 4825;
            CrauDL.Heading = 2057;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(CrauDL);

            CrauDD = new GuardRelicKeepFighter();
            CrauDD.X = 402670;
            CrauDD.Y = 464400;
            CrauDD.Z = 2888;
            CrauDD.Heading = 2621;
            ...
            KeepGuardTemplateMgr.RefreshTemplate(CrauDD);
        }
