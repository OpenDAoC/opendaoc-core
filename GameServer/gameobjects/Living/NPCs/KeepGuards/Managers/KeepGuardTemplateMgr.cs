...
{
    public class KeepGuardTemplateMgr
    {
        public static void RefreshTemplate(GameKeepGuard guard)
        {
            ...
            SetGuardSpell(guard);
            KeepGuardInventoryMgr.EquipGuard(guard);
            KeepGuardInventoryMgr.SetEmblem(guard);
        }
            ...
            if (guard is GuardHealer)
            {
                if (guard.IsPortalKeepGuard || guard.Level == 255)
                {
                    switch (guard.Realm)
                    {
                        case ERealm.None:
                        case ERealm.Albion:
                            guard.Spells.Add(KeepGuardSpellMgr.AlbLordHealSpell);
                            break;
                        case ERealm.Midgard:
                            guard.Spells.Add(KeepGuardSpellMgr.MidLordHealSpell);
                            break;
                        case ERealm.Hibernia:
                            guard.Spells.Add(KeepGuardSpellMgr.HibLordHealSpell);
                            break;
                    }
                }
                else
                {
                    switch (guard.Realm)
                    {
                        case ERealm.None:
                        case ERealm.Albion:
                            guard.Spells.Add(KeepGuardSpellMgr.AlbGuardHealSmallSpell);
                            break;
                        case ERealm.Midgard:
                            guard.Spells.Add(KeepGuardSpellMgr.MidGuardHealSmallSpell);
                            break;
                        case ERealm.Hibernia:
                            guard.Spells.Add(KeepGuardSpellMgr.HibGuardHealSmallSpell);
                            break;
                    }
                }
            }
            if (guard is GuardCaster)
            {
                if (guard.IsPortalKeepGuard || guard.Level == 255)
                {
                    switch (guard.Realm)
                    {
                        case ERealm.None:
                        case ERealm.Albion:
                            guard.Spells.Add(KeepGuardSpellMgr.AlbGuardBoltSpellPortalKeep);
                            guard.Spells.Add(SkillBase.GetSpellByID(10));
                            break;
                        case ERealm.Midgard:
                            guard.Spells.Add(KeepGuardSpellMgr.MidGuardBoltSpellPortalKeep);
                            guard.Spells.Add(SkillBase.GetSpellByID(2669));
                            break;
                        case ERealm.Hibernia:
                            guard.Spells.Add(KeepGuardSpellMgr.HibGuardBoltSpellPortalKeep);
                ...
                case ERealm.Albion:
                    {
                        ...
                        else if (guard is KeepLord && guard.Component != null && guard.Component.Keep != null)
                        {
                            if (guard.Gender == EGender.Male)
                            {
        ...
        private static void SetBlockEvadeParryChance(GameKeepGuard guard)
        {
            ...
            if (guard is KeepLord || guard is MissionMaster)
            {
        ...
        public static void SetGuardSpeed(GameKeepGuard guard)
        {
            ...
            if (((guard is KeepLord) && guard.Component != null) || guard is GuardArcherStatic || guard is GuardCasterStatic)
            {
