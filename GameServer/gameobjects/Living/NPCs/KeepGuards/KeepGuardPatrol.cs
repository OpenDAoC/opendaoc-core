...
namespace DOL.GS.Keeps
{
	...
	public class KeepGuardPatrol
	{
		...
		private DbKeepPositions m_spawnPosition = null;
		/// <summary>
		/// The Position object the guards are assigned to
		/// </summary>
		public DbKeepPositions SpawnPosition
		{
		...
		public void InitialiseGuards()
		{
			...
			PatrolPath = KeepGuardPositionMgr.LoadPatrolPath(PatrolID, Component);
			...
			{
				KeepGuardPositionMgr.LoadGuardPosition(SpawnPosition, guard);
			}
