...
namespace DOL.GS.Keeps
{
	...
	public class GameKeepGuard : GameNPC, IKeepItem
	{
		...
		public virtual bool AssistLord(KeepLord lord)
		{
		...
		public bool CanUseRanged
		{
			get
			{
				...
				if (this is GuardArcher || this is KeepLord)
				{
		...
		public void LoadFromPosition(DbKeepPositions pos, GameKeepComponent component)
		{
			...
			KeepGuardPositionMgr.LoadGuardPosition(pos, this);
			RefreshTemplate();
			this.AddToWorld();
		}
		...
		{
			KeepGuardPositionMgr.LoadGuardPosition(position, this);
			if (!InCombat)
		...
		{
			KeepGuardInventoryMgr.EquipGuard(this);
		...
		public void RefreshTemplate()
		{
			...
			SetAggression();
			KeepGuardInventoryMgr.EquipGuard(this);
			KeepGuardInventoryMgr.SetEmblem(this);
		}
