...
{
    public class KeepLord : GameKeepGuard
    {
        ...
        public override bool AssistLord(KeepLord lord)
        {
            return false;
        }
        ...
        public override bool WhisperReceive(GameLiving source, string str)
        {
            ...
            switch (str)
            {
                case "Claim Keep":
                    {
                        if (KeepPlayerMgr.IsAllowedToInteract(player, Component.Keep, eInteractType.Claim))
                        {
                ...
                case "Release Keep":
                    {
                        if (KeepPlayerMgr.IsAllowedToInteract(player, Component.Keep, eInteractType.Release))
                        {
                            flag += 4;
                        }
                        break;
