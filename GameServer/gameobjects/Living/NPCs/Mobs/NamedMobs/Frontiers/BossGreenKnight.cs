...
namespace DOL.GS
{
    public class BossGreenKnight : GameEpicBoss
    {
        public BossGreenKnight() : base()
        {
        }
        ...
        public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (npcs.Length == 0)
            {
                ...
                BossGreenKnight OF = new BossGreenKnight();
        ...
        public override void Think()
        {
            ...
            if (Body.IsAlive)
            {
                ...
                if (Body.TargetObject != null && HasAggro)
                    Body.styleComponent.NextCombatStyle = BossGreenKnight.taunt;
            }
