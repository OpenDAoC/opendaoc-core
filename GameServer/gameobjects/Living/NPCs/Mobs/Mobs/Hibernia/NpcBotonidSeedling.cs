...
{
    public class NpcBotonidSeedling : GameNPC
    {
        public NpcBotonidSeedling() : base()
        {
        }

        public NpcBotonidSeedling(ABrain defaultBrain) : base(defaultBrain)
        {
        }

        public NpcBotonidSeedling(INpcTemplate template) : base(template)
        {
        }
