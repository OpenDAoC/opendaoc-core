    ...
    public class BDSubPet : BDPet
    {
            ...
            get {
                ...
                if (m_PetSpecLine == null && Brain is IControlledBrain brain && brain.GetPlayerOwner() is GamePlayer player)
                {
                    ...
                    if (dbSummoningSpell != null)
                    {
                        ...
                        DbLineXSpells dbLineSpell = CoreDb<DbLineXSpells>.SelectObject(DB.Column("SpellID").IsEqualTo(dbSummoningSpell.SpellID));
                        if (dbLineSpell != null)
                        {
        ...
        public override void SortSpells()
        {
            ...
            if (ServerProperties.ServerProperties.PET_SCALE_SPELL_MAX_LEVEL > 0)
            {
                ...
                if (ServerProperties.ServerProperties.PET_CAP_BD_MINION_SPELL_SCALING_BY_SPEC
        ...
        {
            if (ServerProperties.ServerProperties.PET_SCALE_SPELL_MAX_LEVEL < 1 || spell == null || Level < 1)
                return;
