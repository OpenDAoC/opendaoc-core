...
namespace DOL.GS
{
    public static class EffectService
    {
        ...
        public static void Tick()
        {
            ...
            List<EcsGameEffect> list = EntityMgr.UpdateAndGetAll<EcsGameEffect>(EntityMgr.EntityType.Effect, out int lastNonNullIndex);
            ...
            Parallel.For(0, lastNonNullIndex + 1, i =>
            {
                ...
                EntityMgr.Remove(EntityMgr.EntityType.Effect, effect);
        ...
        public static void RequestCancelEffect(EcsGameEffect effect, bool playerCanceled = false)
        {
            ...
            if (effect is QuickCastEcsEffect quickCast)
            {
            ...
            EntityMgr.Add(EntityMgr.EntityType.Effect, effect);
        }
