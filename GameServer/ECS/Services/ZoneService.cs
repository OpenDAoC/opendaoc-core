...
namespace DOL.GS
{
    public static class ZoneService
    {
        ...
        public static void Tick()
        {
            ...
            List<ObjectChangingSubZone> list = EntityMgr.UpdateAndGetAll<ObjectChangingSubZone>(EntityMgr.EntityType.ObjectChangingSubZone, out int lastNonNullIndex);
            ...
            Parallel.For(0, lastNonNullIndex + 1, i =>
            {
                ...
                Zone.eGameObjectType objectType = objectChangingSubZone.ObjectType;
                ...
                EntityMgr.Remove(EntityMgr.EntityType.ObjectChangingSubZone, objectChangingSubZone);
            });
