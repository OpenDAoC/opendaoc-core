...
namespace DOL.GS
{
    public class AuxTimerService
    {
        ...
        public static void Tick(long tick)
        {
            ...
            List<AuxECSGameTimer> list = EntityMgr.UpdateAndGetAll<AuxECSGameTimer>(EntityMgr.EntityType.AuxTimer, out int lastNonNullIndex);
    ...
    public class AuxECSGameTimer : IManagedEntity
    {
        ...
        public void Start(int interval)
        {
            ...
            if (EntityMgr.Add(EntityMgr.EntityType.AuxTimer, this))
                IsAlive = true;
        }

        public void Stop()
        {
            if (EntityMgr.Remove(EntityMgr.EntityType.AuxTimer, this))
               IsAlive = false;
        }
