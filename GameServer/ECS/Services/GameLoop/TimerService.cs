...
namespace DOL.GS
{
    public class TimerService
    {
        ...
        public static void Tick(long tick)
        {
            ...
            List<ECSGameTimer> list = EntityMgr.UpdateAndGetAll<ECSGameTimer>(EntityMgr.EntityType.Timer, out int lastNonNullIndex);
    ...
    public class ECSGameTimer : IManagedEntity
    {
        ...
        public void Start(int interval)
        {
            ...
            if (EntityMgr.Add(EntityMgr.EntityType.Timer, this))
                IsAlive = true;
        }

        public void Stop()
        {
            if (EntityMgr.Remove(EntityMgr.EntityType.Timer, this))
               IsAlive = false;
        }
