...
namespace DOL.GS
{
    public class SavageBuffEcsEffect : StatBuffEcsEffect
    {
        ...
        public override void OnStartEffect()
        {
            ...
            {
                ApplyBonus(Owner, (SpellHandler as SavageBuffHandler).BonusCategory1,
                    (SpellHandler as SavageBuffHandler).Property1, SpellHandler.Spell.Value, Effectiveness, false);
        ...
        {
            ApplyBonus(Owner, (SpellHandler as SavageBuffHandler).BonusCategory1, (SpellHandler as SavageBuffHandler).Property1, SpellHandler.Spell.Value, Effectiveness, true);
            OnHealthCost();           
        }
