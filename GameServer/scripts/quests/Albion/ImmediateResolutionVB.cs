...
namespace DOL.GS.Quests.Albion
{
    public class ImmediateResolutionVB : BaseQuest
    {
        ...
        private static DbItemTemplates waxSealedNote = null;
        ...
        public ImmediateResolutionVB(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest) { }
        ...
        public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            waxSealedNote = GameServer.Database.FindObjectByKey<DbItemTemplates>(waxSealedNoteInDb);
            if (waxSealedNote == null)
            {
                if (log.IsWarnEnabled)
                    log.Warn($"Could not find {waxSealedNoteName}, creating it ...");
                waxSealedNote = new DbItemTemplates();
