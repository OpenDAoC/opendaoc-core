...
namespace DOL.GS
{
    ...
    public class SubZone
    {
        ...
        private LightConcurrentLinkedList<SubZoneObject>[] _objects = new LightConcurrentLinkedList<SubZoneObject>[Enum.GetValues(typeof(Zone.eGameObjectType)).Length];
        ...
        public bool AddObjectNode(LightConcurrentLinkedList<SubZoneObject>.Node node, Zone.eGameObjectType objectType)
        {
            return _objects[(byte)objectType].AddLast(node);
        }

        public bool RemoveObjectNode(LightConcurrentLinkedList<SubZoneObject>.Node node, Zone.eGameObjectType objectType)
        {
            return _objects[(byte)objectType].Remove(node);
        }

        public LightConcurrentLinkedList<SubZoneObject> GetObjects(Zone.eGameObjectType objectType)
        {
    ...
    public class ObjectChangingSubZone : IManagedEntity
    {
        ...
        public Zone.eGameObjectType ObjectType { get; private set; }
        ...
        public ObjectChangingSubZone(LightConcurrentLinkedList<SubZoneObject>.Node subZoneObject, Zone.eGameObjectType objectType, Zone destinationZone, SubZone destinationSubZone)
        {
