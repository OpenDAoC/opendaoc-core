...
namespace GameServerScripts.Titles
{
	...
	/// </summary>
	public abstract class GenericEventTitles : EventPlayerTitle
	{
		/// <summary>
	...
	public abstract class NoGenderGenericEventPlayerTitle : GenericEventTitles
	{
		/// <summary>
		/// Tuple of String Description / Name / Female Description / Female Name 
		/// </summary>
	...
	public abstract class TranslatedGenericEventPlayerTitle : GenericEventTitles
	{
		/// <summary>
		/// Should this Title go through Translator
		/// </summary>
