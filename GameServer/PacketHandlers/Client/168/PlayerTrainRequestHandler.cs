...
namespace DOL.GS.PacketHandler.Client.v168
{
	...
	/// D4 is up to 1.104
	/// </summary>
	[PacketHandlerAttribute(EPacketHandlerType.TCP, EClientPackets.TrainRequest, "Handles Player Train Requests", eClientStatus.PlayerInGame)]
	...
	/// Handles Train clicks from Trainer Window
	/// </summary>
	[PacketHandlerAttribute(EPacketHandlerType.TCP, EClientPackets.TrainHandler, "Handles Player Train", eClientStatus.PlayerInGame)]
	public class PlayerTrainHandler : IPacketHandler
	{
		...
		/// </summary>
		[PacketHandlerAttribute(EPacketHandlerType.TCP, EClientPackets.TrainWindowHandler, "Call Player Train Window", eClientStatus.PlayerInGame)]
