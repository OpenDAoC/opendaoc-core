...
{
	[PacketHandlerAttribute(EPacketHandlerType.TCP, EClientPackets.PlayerRegionChangeRequest, "Player Region Change Request handler.", eClientStatus.PlayerInGame)]
