...
{
	[PacketHandlerAttribute(EPacketHandlerType.TCP, EClientPackets.CheckLOSRequest, "Handles a LoS Check Response", eClientStatus.PlayerInGame)]
	public class CheckLosRequestHandler : IPacketHandler
	{
