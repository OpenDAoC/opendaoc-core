...
namespace DOL.GS.PacketHandler.Client.v168
{
	...
	/// </summary>
	[PacketHandlerAttribute(EPacketHandlerType.TCP, EClientPackets.EmblemDialogResponse, "Handles when a player chooses a guild emblem", eClientStatus.PlayerInGame)]
