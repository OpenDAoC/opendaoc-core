...
namespace DOL.GS.PacketHandler.Client.v168
{
    ...
    /// </summary>
    [PacketHandlerAttribute(EPacketHandlerType.TCP, EClientPackets.DetailRequest, "Handles detail display", eClientStatus.PlayerInGame)]
	public class DetailDisplayHandler : IPacketHandler
	{
		...
		public void WriteTechnicalInfo(IList<string> output, GameClient client, InventoryItem item, int dur, int con)
		{
			...
			output.Add("  Value/Price: " + MoneyUtil.GetShortString(item.Price));
