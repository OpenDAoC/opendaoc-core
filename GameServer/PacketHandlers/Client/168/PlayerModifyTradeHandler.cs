...
{
	[PacketHandlerAttribute(EPacketHandlerType.TCP, EClientPackets.ModifyTrade, "Player Accepts Trade", eClientStatus.PlayerInGame)]
	public class PlayerModifyTradeHandler : IPacketHandler
	{
		public void HandlePacket(GameClient client, GsPacketIn packet)
		{
			...
			else if (isok == 1)
			{
				...
				long money = MoneyUtil.GetMoney(tradeMoney[0], tradeMoney[1], tradeMoney[2], tradeMoney[3], tradeMoney[4]);
