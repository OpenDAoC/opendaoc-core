...
namespace DOL.GS.RealmAbilities
{
	...
	public class TimedRealmAbility : RealmAbility
	{
		...
		public TimedRealmAbility(DbAbilities ability, int level) : base(ability, level) { }
	...
	public abstract class StyleRealmAbility : TimedRealmAbility
	{
		...
		public StyleRealmAbility(DbAbilities ability, int level) : base(ability, level)
		{
	...
	{
		public L5RealmAbility(DbAbilities ability, int level) : base(ability, level) { }
	...
	{
		public RR5RealmAbility(DbAbilities ability, int level) : base(ability, level) { }
