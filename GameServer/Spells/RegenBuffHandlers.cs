...
namespace DOL.GS.Spells
{
	...
	public class HealthRegenHandler : PropertyChangingHandler
	{
		public override EBuffBonusCategory BonusCategory1 { get { return EBuffBonusCategory.BaseBuff; } }
		public override EProperty Property1 { get { return EProperty.HealthRegenerationRate; } }

		public HealthRegenHandler(GameLiving caster, Spell spell, SpellLine line) : base(caster, spell, line) {}
	}
	...
	public class PowerRegenHandler : PropertyChangingHandler
	{
		...
		public PowerRegenHandler(GameLiving caster, Spell spell, SpellLine spellLine) : base(caster, spell, spellLine) {}
	}
	...
	public class EnduranceRegenHandler : PropertyChangingHandler
	{
		public override EBuffBonusCategory BonusCategory1 { get { return EBuffBonusCategory.BaseBuff; } }
		...
		private sealed class RangeCheckAction : RegionAction
		{
			...
			/// The list of effects
			/// </summary>
			private readonly EnduranceRegenHandler m_handler;
			...
			public RangeCheckAction(GameLiving actionSource, EnduranceRegenHandler handler) : base(actionSource)
			{
				m_handler = handler;
			}
...
//						DOLConsole.WriteLine(Caster.Name+" to "+effectOwner.Name+" range="+range);
		...
		public EnduranceRegenHandler(GameLiving caster, Spell spell, SpellLine line) : base(caster, spell, line) {}
	}
}
