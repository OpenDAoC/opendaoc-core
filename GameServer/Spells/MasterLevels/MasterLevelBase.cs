...
namespace DOL.GS.Spells
{
    ...
    /// Contains all common code for Banelord Spells
    /// </summary>
    public abstract class MasterLevelDebuffHandling : SingleStatDebuffHandler
    {
        // bonus category
    ...
    /// Contains all common code for Banelord Spells
    /// </summary>
    public abstract class MasterLevelBuffHandling : SingleStatBuffHandler
    {
        // bonus category
    ...
    /// Contains all common code for Banelord Spells
    /// </summary>
    public abstract class MasterLevelDualBuffHandling : DualStatBuffHandler
    {
        // bonus category
        public override EBuffBonusCategory BonusCategory1 { get { return EBuffBonusCategory.BaseBuff; } }
    ...
    /// Contains all common code for Banelord Spells
    /// </summary>
    public class BanelordSnare : UnbreakableSpeedDecreaseHandler
    {
        public override bool HasPositiveEffect
        {
            get { return false; }
    ...
    #region Fontbase
    public class FontSpellHandler : DotHandler
    {
    ...
    #region Trapbase
    public class MineSpellHandler : DotHandler
    {
