...
namespace DOL.GS.Spells
{
    ...
    public class BoltHandler : SpellHandler
    {
        private bool _combatBlock;

        public BoltHandler(GameLiving caster, Spell spell, SpellLine line) : base(caster, spell, line) { }
        ...
        public override void OnDirectEffect(GameLiving target, double effectiveness)
        {
            ...
            Message.SystemToArea(target, UtilCollection.MakeSentence(Spell.Message2, target.GetName(0, true)), EChatType.CT_System, target, Caster); // "{0} is hit by a bolt of runic energy!"
        ...
        protected class BoltOnTargetTimer
        {
            ...
            private BoltHandler _spellHandler;

            public BoltOnTargetTimer(GameLiving target, BoltHandler spellHandler, int ticksToTarget)
            {
                _target = target;
