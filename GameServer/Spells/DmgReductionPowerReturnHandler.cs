...
namespace DOL.GS.Spells
{
   ...
   public class DmgReductionPowerReturnHandler : SpellHandler
   {
...
//         Log.DebugFormat("sender:{0} res:{1} IsMelee:{2} Type:{3}", living.Name, ad.AttackResult, ad.IsMeleeAttack, ad.AttackType);
	  ...
	  public override int OnRestoredEffectExpires(GameSpellEffect effect, int[] vars, bool noMessages)
	  {
		...
		public DmgReductionPowerReturnHandler(GameLiving caster, Spell spell, SpellLine line) : base(caster, spell, line) { }
   }
}
