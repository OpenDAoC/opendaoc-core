...
namespace DOL.GS.Spells
{
    ...
    public class BeltOfSunHandler : SummonItemSpellHandler
    {
        private static readonly log4net.ILog log = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        private DbItemTemplates m_SunSlash;
        private DbItemTemplates m_SunThrust;
        private DbItemTemplates m_SunTwoHanded;
        private DbItemTemplates m_SunCrush;
        private DbItemTemplates m_SunFlexScytheClaw;
        private DbItemTemplates m_SunAxe;
        private DbItemTemplates m_SunLeftAxe;
        private DbItemTemplates m_Sun2HAxe;
        private DbItemTemplates m_Sun2HCrush;
        private DbItemTemplates m_SunBow;
        private DbItemTemplates m_SunStaff;
        private DbItemTemplates m_SunPolearmSpear;
        private DbItemTemplates m_SunMFist;
        private DbItemTemplates m_SunMStaff;

        public BeltOfSunHandler(GameLiving caster, Spell spell, SpellLine line)
            : base(caster, spell, line)
        {
            ...
            {
                m_SunCrush = GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Crush") ?? Crush;
                items.Add(GameInventoryItem.Create(m_SunCrush));

                m_SunSlash = GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Slash") ?? Slash;
                items.Add(GameInventoryItem.Create(m_SunSlash));

                m_SunThrust = GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Thrust") ?? Thrust;
                items.Add(GameInventoryItem.Create(m_SunThrust));

                m_SunTwoHanded = GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_TwoHanded") ?? TwoHanded;
                items.Add(GameInventoryItem.Create(m_SunTwoHanded));

                m_SunPolearmSpear = GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Polearm") ?? Polearm;
            ...
            if (player.CharacterClass.ID == (int)ECharacterClass.Friar)
            {
                ...
                m_SunStaff = GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Staff") ?? Staff;
            ...
            if (player.CharacterClass.ID == (int)ECharacterClass.Heretic)
            {
                ...
                m_SunFlexScytheClaw = GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Flex") ?? Flex;
            ...
            if (player.CharacterClass.ID == (int)ECharacterClass.Scout)
            {
                ...
                m_SunBow = GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Bow") ?? Bow;
            ...
            {
                m_SunMFist = GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_MFist") ?? MFist;
                items.Add(GameInventoryItem.Create(m_SunMFist));

                m_SunMStaff = GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_MStaff") ?? MStaff;
            ...
            {
                m_SunCrush = GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Crush") ?? CrushM; //
                items.Add(GameInventoryItem.Create(m_SunCrush));

                m_SunSlash = GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Slash") ?? SlashM; //
                items.Add(GameInventoryItem.Create(m_SunSlash));

                m_SunAxe = GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Axe") ?? Axe; //
                items.Add(GameInventoryItem.Create(m_SunAxe));

                m_SunTwoHanded = GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_TwoHanded") ?? TwoHandedM; // 2handed Sword
                items.Add(GameInventoryItem.Create(m_SunTwoHanded));

                m_Sun2HCrush = GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_2HCrush") ?? THCrushM;
                items.Add(GameInventoryItem.Create(m_Sun2HCrush));

                m_Sun2HAxe = GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_2HAxe") ?? THAxe;
            ...
            if (player.CharacterClass.ID == (int)ECharacterClass.Hunter)
            {
                ...
                m_SunPolearmSpear = GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Trust") ?? SpearM; // Spear
                items.Add(GameInventoryItem.Create(m_SunPolearmSpear));

                m_SunBow = GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Bow") ?? BowM; //
                items.Add(GameInventoryItem.Create(m_SunBow));
                return;
            }
            ...
            if (player.CharacterClass.ID == (int)ECharacterClass.Savage)
            {
                ...
                m_SunThrust = GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Claw") ?? Claw; //
                items.Add(GameInventoryItem.Create(m_SunThrust));
                return;
            }
            ...
            if (player.CharacterClass.ID == (int)ECharacterClass.Shadowblade)
            {
                ...
                m_SunLeftAxe = GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_LeftAxe") ?? LeftAxe; //
            ...
            {
                m_SunCrush = GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Crush") ?? CrushH; // Blunt
                items.Add(GameInventoryItem.Create(m_SunCrush));

                m_SunStaff = GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Slash") ?? SlashH; // Blades
                items.Add(GameInventoryItem.Create(m_SunSlash));
                return;
            }
            ...
            if (player.CharacterClass.ID == (int)ECharacterClass.Blademaster)
            {
                ...
                m_SunStaff = GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Thrust") ?? ThrustH; // Piercing
                items.Add(GameInventoryItem.Create(m_SunThrust));
                return;
            }
            ...
            if (player.CharacterClass.ID == (int)ECharacterClass.Champion)
            {
                ...
                m_SunStaff = GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Slash") ?? TwoHandedH; // LargeWeapon
                items.Add(GameInventoryItem.Create(m_SunTwoHanded));
                return;
            }
            ...
            if (player.CharacterClass.ID == (int)ECharacterClass.Hero)
            {
                ...
                m_SunPolearmSpear = GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Spear") ?? SpearH; // Spear
                items.Add(GameInventoryItem.Create(m_SunPolearmSpear));
                return;
            }
            ...
            if (player.CharacterClass.ID == (int)ECharacterClass.Ranger)
            {
                ...
                m_SunBow = GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Bow") ?? BowH; //
                items.Add(GameInventoryItem.Create(m_SunBow));
                return;
            }
            ...
            {
                m_SunStaff = GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_FlexScythe") ?? Scythe;
                items.Add(GameInventoryItem.Create(m_SunFlexScytheClaw));
                return;
            }
        ...
        private DbItemTemplates Crush
        {
            get
            {
                m_SunCrush = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Crush");
                if (m_SunCrush == null)
                {
                    if (log.IsWarnEnabled) log.Warn("Could not find Sun_Crush, loading it ...");
                    m_SunCrush = new DbItemTemplates();
        ...
        private DbItemTemplates Slash
        {
            get
            {
                m_SunSlash = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Slash");
                if (m_SunSlash == null)
                {
                    if (log.IsWarnEnabled) log.Warn("Could not find Sun_Slash, loading it ...");
                    m_SunSlash = new DbItemTemplates();
        ...
        private DbItemTemplates Thrust
        {
            get
            {
                m_SunThrust = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Thrust");
                if (m_SunThrust == null)
                {
                    if (log.IsWarnEnabled) log.Warn("Could not find Sun_Thrust, loading it ...");
                    m_SunThrust = new DbItemTemplates();
        ...
        private DbItemTemplates Flex
        {
            get
            {
                m_SunFlexScytheClaw = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Flex");
                if (m_SunFlexScytheClaw == null)
                {
                    if (log.IsWarnEnabled) log.Warn("Could not find Sun_Flex, loading it ...");
                    m_SunFlexScytheClaw = new DbItemTemplates();
        ...
        private DbItemTemplates Polearm
        {
            get
            {
                m_SunPolearmSpear = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Polearm");
                if (m_SunPolearmSpear == null)
                {
                    if (log.IsWarnEnabled) log.Warn("Could not find Sun_Polearm, loading it ...");
                    m_SunPolearmSpear = new DbItemTemplates();
        ...
        private DbItemTemplates TwoHanded
        {
            get
            {
                m_SunTwoHanded = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_TwoHanded");
                if (m_SunTwoHanded == null)
                {
                    if (log.IsWarnEnabled) log.Warn("Could not find Sun_TwoHanded, loading it ...");
                    m_SunTwoHanded = new DbItemTemplates();
        ...
        private DbItemTemplates Bow
        {
            get
            {
                m_SunBow = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Bow");
                if (m_SunBow == null)
                {
                    if (log.IsWarnEnabled) log.Warn("Could not find Sun_Bow, loading it ...");
                    m_SunBow = new DbItemTemplates();
        ...
        private DbItemTemplates Staff
        {
            get
            {
                m_SunStaff = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Staff");
                if (m_SunStaff == null)
                {
                    if (log.IsWarnEnabled) log.Warn("Could not find Sun_Staff, loading it ...");
                    m_SunStaff = new DbItemTemplates();
        ...
        private DbItemTemplates MStaff
        {
            get
            {
                m_SunMStaff = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_MStaff");
                if (m_SunMStaff == null)
                {
                    if (log.IsWarnEnabled) log.Warn("Could not find Sun_MStaff, loading it ...");
                    m_SunMStaff = new DbItemTemplates();
        ...
        private DbItemTemplates MFist
        {
            get
            {
                m_SunMFist = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_MFist");
                if (m_SunMFist == null)
                {
                    if (log.IsWarnEnabled) log.Warn("Could not find Sun_MFist, loading it ...");
                    m_SunMFist = new DbItemTemplates();
        ...
        private DbItemTemplates CrushM
        {
            get
            {
                m_SunCrush = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Crush");
        ...
        private DbItemTemplates SlashM
        {
            get
            {
                m_SunSlash = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Slash");
        ...
        private DbItemTemplates Axe
        {
            get
            {
                m_SunAxe = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Axe");
                if (m_SunAxe == null)
                {
                    if (log.IsWarnEnabled) log.Warn("Could not find Sun_Axe, loading it ...");
                    m_SunAxe = new DbItemTemplates();
        ...
        private DbItemTemplates LeftAxe
        {
            get
            {
                m_SunLeftAxe = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_LeftAxe");
                if (m_SunLeftAxe == null)
                {
                    if (log.IsWarnEnabled) log.Warn("Could not find Sun_LeftAxe, loading it ...");
                    m_SunLeftAxe = new DbItemTemplates();
        ...
        private DbItemTemplates Claw
        {
            get
            {
                m_SunFlexScytheClaw = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Claw");
                if (m_SunFlexScytheClaw == null)
                {
        ...
        private DbItemTemplates SpearM
        {
            get
            {
                m_SunPolearmSpear = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Spear");
                if (m_SunPolearmSpear == null)
                {
        ...
        private DbItemTemplates TwoHandedM
        {
            get
            {
                m_SunTwoHanded = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_TwoHanded");
        ...
        private DbItemTemplates THCrushM
        {
            get
            {
                m_Sun2HCrush = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_2HCrush");
                if (m_Sun2HCrush == null)
                {
                    if (log.IsWarnEnabled) log.Warn("Could not find Sun_2HCrush, loading it ...");
                    m_Sun2HCrush = new DbItemTemplates();
        ...
        private DbItemTemplates THAxe
        {
            get
            {
                m_Sun2HAxe = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_2HAxe");
                if (m_Sun2HAxe == null)
                {
                    if (log.IsWarnEnabled) log.Warn("Could not find Sun_2HAxe, loading it ...");
                    m_Sun2HAxe = new DbItemTemplates();
        ...
        private DbItemTemplates CrushH
        {
            get
            {
                m_SunCrush = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Crush");
        ...
        private DbItemTemplates SlashH
        {
            get
            {
                m_SunSlash = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Slash");
        ...
        private DbItemTemplates ThrustH
        {
            get
            {
                m_SunThrust = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Thrust");
        ...
        private DbItemTemplates Scythe
        {
            get
            {
                m_SunFlexScytheClaw = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Scythe");
                if (m_SunFlexScytheClaw == null)
                {
        ...
        private DbItemTemplates SpearH
        {
            get
            {
                m_SunPolearmSpear = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_Spear");
        ...
        private DbItemTemplates TwoHandedH
        {
            get
            {
                m_SunTwoHanded = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("Sun_TwoHanded");
