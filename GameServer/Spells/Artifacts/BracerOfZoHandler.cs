...
namespace DOL.GS.Spells
{
    ...
    public class BracerOfZoHandler : SpellHandler
    {
        ...
        public BracerOfZoHandler(GameLiving caster, Spell spell, SpellLine line) : base(caster, spell, line) { }
    }
    
    [SpellHandlerAttribute("Bedazzlement")]
    public class ZoDebuffSpellHandler : DualStatDebuffHandler
    {
