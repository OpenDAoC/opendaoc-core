...
namespace DOL.GS.Spells
{
    ...
    public class EfficientHealingSpellHandler : SpellHandler
    {
        #region Devle Info
        ...
        #endregion
        public EfficientHealingSpellHandler(GameLiving caster, Spell spell, SpellLine line)
    ...
    public class EfficientEnduranceSpellHandler : SpellHandler
    {
        #region Devle Info
        public override IList<string> DelveInfo
        {
        ...
        #endregion
        public EfficientEnduranceSpellHandler(GameLiving caster, Spell spell, SpellLine line)
            : base(caster, spell, line)
        {
        }
    }
    ...
    public class PowershieldSpellHandler : SpellHandler
    {
        ...
        #endregion
        public PowershieldSpellHandler(GameLiving caster, Spell spell, SpellLine line)
            : base(caster, spell, line)
        {
        }
    }
