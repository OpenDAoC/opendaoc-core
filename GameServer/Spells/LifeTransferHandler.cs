...
namespace DOL.GS.Spells
{
	...
	public class LifeTransferHandler : SpellHandler
	{
		// constructor
		public LifeTransferHandler(GameLiving caster, Spell spell, SpellLine line) : base(caster, spell, line) {}
		...
		public virtual bool HealTarget(GameLiving target, int amount)
		{
                ...
                m_caster.CurrentRegionID != 242 && m_spell.Pulse == 0) // On Exclu zone COOP
            {
                ...
                int POURCENTAGE_SOIN_RP = ServerProperties.ServerProperties.HEAL_PVP_DAMAGE_VALUE_RP; // ...% de bonus RP pour les soins effectués
