...
namespace DOL.GS.Spells
{
	...
	public class ConversionHandler : SpellHandler
	{
		...
		public ConversionHandler(GameLiving caster, Spell spell, SpellLine line) : base(caster, spell, line) { }
	}
	
	[SpellHandlerAttribute("MagicConversion")]
	public class MagicConversionSpellHandler : ConversionHandler
	{
		//public const string ConvertDamage = "Conversion";
