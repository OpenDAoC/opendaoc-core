...
namespace DOL.GS.Spells
{
	...
	public class MobRezHandler : ResurrectHandler
	{
		// Constructor
		public MobRezHandler(GameLiving caster, Spell spell, SpellLine line) : base(caster, spell, line)
        {
        }
	...
	public class MonsterDoT : DirectDmgHandler
	{
	...
	public class MonsterDisease : DiseaseHandler
	{
		public override IList<GameLiving> SelectTargets(GameObject castTarget)
		{
			var list = new List<GameLiving>(8);
