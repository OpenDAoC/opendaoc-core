...
{
	public abstract class HereticImmunityEffectSpellHandler : HereticPiercingMagicHandler
	{
		/// <summary>
...
//		}
	...
	public class HereticSpeedDecreaseHandler : HereticImmunityEffectSpellHandler
	{
		...
		protected virtual void OnAttacked(CoreEvent e, object sender, EventArgs arguments)
		{
            ...
            if (attackArgs.AttackData.SpellHandler is StyleBleedingHandler || attackArgs.AttackData.SpellHandler is DotHandler || attackArgs.AttackData.SpellHandler is HereticDotHandler)
            {
		...
		public HereticSpeedDecreaseHandler(GameLiving caster, Spell spell, SpellLine line) : base(caster, spell, line)
		{
			TIMER_PROPERTY = this;
		}
		...
		/// </summary>
		private sealed class RestoreSpeedTimer : RegionAction
		{
			/// <summary>
