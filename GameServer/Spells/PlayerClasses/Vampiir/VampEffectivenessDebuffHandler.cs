...
namespace DOL.GS.Spells
{
	...
	public class VampEffectivenessDebuffHandler : SpellHandler
	{
		...
		public VampEffectivenessDebuffHandler(GameLiving caster, Spell spell, SpellLine line) : base(caster, spell, line) {}
	}
}