...
namespace DOL.GS.Spells
{
  ...
  public class SummonAnimistMainPetHandler : SummonAnimistPetHandler
  {
    public SummonAnimistMainPetHandler(GameLiving caster, Spell spell, SpellLine line) : base(caster, spell, line)
    {
    }
