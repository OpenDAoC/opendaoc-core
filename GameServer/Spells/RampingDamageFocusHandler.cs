...
namespace DOL.GS.Spells
{
	...
	public class RampingDamageFocusHandler : SpellHandler
	{
		private static readonly log4net.ILog log = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
		private int pulseCount = 0;
		private ISpellHandler snareSubSpell;

		public RampingDamageFocusHandler(GameLiving caster, Spell spell, SpellLine spellLine) : base(caster, new FocusSpell(spell), spellLine) 
		{
...
// 				}
		...
		public override void OnDirectEffect(GameLiving target, double effectiveness)
		{
			...
			{
				if (UtilCollection.Chance(CalculateSpellResistChance(t)))
				{
					OnSpellResisted(t);
					continue;
				}
		...
		public override IList<string> DelveInfo
		{
			get
			{
				...
				if (Spell.Duration != 0)
					list.Add(p != null ? LanguageMgr.GetTranslation(p.Client, "DelveInfo.Duration") + " " + (Spell.Duration / 1000).ToString("0' sec';'Permanent.';'Permanent.'") : LanguageMgr.GetTranslation(ServerProperties.ServerProperties.SERV_LANGUAGE, "DelveInfo.Duration") + " (Focus) " + (Spell.Duration / 1000).ToString("0' sec';'Permanent.';'Permanent.'"));
	...
	public class SnareWithoutImmunity : SpeedDecreaseHandler
	{
