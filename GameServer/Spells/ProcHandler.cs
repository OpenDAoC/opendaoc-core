...
namespace DOL.GS.Spells
{
	...
	/// </summary>
	public abstract class ProcHandler : SpellHandler
	{
		/// <summary>
		...
		protected ProcHandler(GameLiving caster, Spell spell, SpellLine spellLine)
...
//                else if (Spell.Duration > 60000) list.Add(string.Format("Duration: {0}:{1} min", Spell.Duration / 60000, (Spell.Duration % 60000 / 1000).ToString("00")));
	...
	public class OffensiveProcSpellHandler : ProcHandler
	{
		private static readonly ILog log = LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
	...
	public class DefensiveProcSpellHandler : ProcHandler
	{
		/// <summary>
		/// The event type to hook on
		/// </summary>
