...
namespace DOL.GS.Spells
{
	...
	public class PveIllnessHandler : AbstractIllnessSpellHandler
	{
		...
		public PveIllnessHandler(GameLiving caster, Spell spell, SpellLine spellLine) : base(caster, spell, spellLine) {}	
	}
	...
	public class AbstractIllnessSpellHandler : SpellHandler
	{
		...
		{
			double modifier = 1.0;
			RealmAbilities.NfRaVeilRecoveryHandler ab = target.GetAbility<RealmAbilities.NfRaVeilRecoveryHandler>();
			if (ab != null)
