...
namespace DOL.GS.Commands
{
    ...
    public class TranslateCommand : AbstractCommandHandler, ICommandHandler
    {
                ...
                case "add":
                    {
                        if (client.Account.PrivLevel != (uint)ePrivLevel.Player)
                        {
                            ...
                            LanguageDataObject translation = LanguageMgr.GetLanguageDataObject(args[2].ToUpper(), args[3], LanguageDataObject.ETranslationIdentifier.System);
                            if (translation != null)
                            {
                ...
                case "memadd":
                    {
                        ...
                        else
                        {
                            ...
                            {
                                lngObj = LanguageMgr.GetLanguageDataObject(args[2].ToUpper(), args[3], LanguageDataObject.ETranslationIdentifier.System);
                ...
                case "refresh":
                    {
                        ...
                        {
                            LanguageDataObject lngObj = LanguageMgr.GetLanguageDataObject(args[2].ToUpper(), args[3], LanguageDataObject.ETranslationIdentifier.System);
