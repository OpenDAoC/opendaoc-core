...
namespace DOL.GS.Commands
{
	...
	public class KeepComponentCommand : AbstractCommandHandler, ICommandHandler
	{
				...
				case "reload":
                    {
                        ...
                        var dbcomponent = CoreDb<DbKeepComponents>.SelectObject(DB.Column("KeepID").IsEqualTo(component.Keep.KeepID).And(DB.Column("ID").IsEqualTo(component.ID)));
