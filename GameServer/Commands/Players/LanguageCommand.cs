...
namespace DOL.GS.Commands
{
    ...
    public class LanguageCommand : AbstractCommandHandler, ICommandHandler
    {
        public void OnCommand(GameClient client, string[] args)
        {
            ...
            if (client.Account.PrivLevel == (uint)EPrivLevel.Player && !DOL.GS.ServerProperties.ServerProperties.ALLOW_CHANGE_LANGUAGE)
            {
