...
namespace DOL.GS.Trainer
{
	...
	/// Skald Trainer
	/// </summary>
	[NpcGuild("Skald Trainer", ERealm.Midgard)]		// this attribute instructs DOL to use this script for all "Skald Trainer" NPC's in Albion (multiple guilds are possible for one script)
