...
namespace DOL.GS.Trainer
{
	...
	/// Acolyte Trainer
	/// </summary>
	[NpcGuild("Acolyte Trainer", ERealm.Albion)]		// this attribute instructs DOL to use this script for all "Acolyte Trainer" NPC's in Albion (multiple guilds are possible for one script)
