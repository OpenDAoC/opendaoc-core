...
namespace DOL.GS.Trainer
{
	...
	/// Sorcerer Trainer
	/// </summary>
	[NpcGuild("Sorcerer Trainer", ERealm.Albion)]		// this attribute instructs DOL to use this script for all "Sorcerer Trainer" NPC's in Albion (multiple guilds are possible for one script)
