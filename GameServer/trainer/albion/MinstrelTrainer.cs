...
namespace DOL.GS.Trainer
{
	...
	/// Minstrel Trainer
	/// </summary>	
	[NpcGuild("Minstrel Trainer", ERealm.Albion)]		// this attribute instructs DOL to use this script for all "Minstrel Trainer" NPC's in Albion (multiple guilds are possible for one script)
