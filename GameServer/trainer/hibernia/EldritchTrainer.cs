...
namespace DOL.GS.Trainer
{
	...
	/// Eldritch Trainer
	/// </summary>
	[NpcGuild("Eldritch Trainer", ERealm.Hibernia)]		// this attribute instructs DOL to use this script for all "Eldritch Trainer" NPC's in Albion (multiple guilds are possible for one script)
