...
namespace DOL.GS.Trainer
{
	...
	/// Champion Trainer
	/// </summary>
	[NpcGuild("Champion Trainer", ERealm.Hibernia)]		// this attribute instructs DOL to use this script for all "Champion Trainer" NPC's in Albion (multiple guilds are possible for one script)
