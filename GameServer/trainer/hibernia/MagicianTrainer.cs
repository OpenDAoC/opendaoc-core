...
namespace DOL.GS.Trainer
{
	...
	/// Magician Trainer
	/// </summary>
	[NpcGuild("Magician Trainer", ERealm.Hibernia)]		// this attribute instructs DOL to use this script for all "Magician Trainer" NPC's in Albion (multiple guilds are possible for one script)
