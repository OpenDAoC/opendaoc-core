...
namespace DOL.GS.Trainer
{
	...
	/// Guardian Trainer
	/// </summary>
	[NpcGuild("Guardian Trainer", ERealm.Hibernia)]		// this attribute instructs DOL to use this script for all "Guardian Trainer" NPC's in Albion (multiple guilds are possible for one script)
