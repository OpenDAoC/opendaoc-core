...
namespace DOL.GS.Behaviour
{
    ...
    /// etc....
    /// </summary>
    public abstract class AbstractAction<TypeP,TypeQ> : IBehaviorAction
    {
		...
		{		
            ...
            this.p = (TypeP)BehaviorUtils.ConvertObject(p, defaultValueP, typeof(TypeP));
            CheckParameter(this.p, attr.IsNullableP, typeof(TypeP));            

            // handle parameter Q
            object defaultValueQ = GetDefaultValue(attr.DefaultValueQ);                            
            this.q = (TypeQ)BehaviorUtils.ConvertObject(q, defaultValueQ, typeof(TypeQ));
