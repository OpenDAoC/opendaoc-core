...
namespace DOL.GS.Behaviour.Requirements
{
	...
	public class PowerMaxRequirement : AbstractRequirement<int,Unused>
	{
        ...
        public PowerMaxRequirement(GameNPC defaultNPC,  Object n, Object v, eComparator comp)
        ...
        public PowerMaxRequirement(GameNPC defaultNPC,  int n, eComparator comp)
