...
namespace DOL.GS.Behaviour
{
    ...
    /// </summary>        
    public abstract class AbstractTrigger<TypeK, TypeI> : IBehaviorTrigger
    {
		...
		public AbstractTrigger(GameLiving defaultNPC,CoreEventHandler notifyHandler, ETriggerType type, object k, object i) : this(defaultNPC,notifyHandler,type)
		{
            ...
            this.k = (TypeK)BehaviorUtils.ConvertObject(k, defaultValueK, typeof(TypeK));
            CheckParameter(K, attr.IsNullableK, typeof(TypeK));

            // handle parameter I
            object defaultValueI = GetDefaultValue(attr.DefaultValueI);
            this.i = (TypeI)BehaviorUtils.ConvertObject(i, defaultValueI, typeof(TypeI));
