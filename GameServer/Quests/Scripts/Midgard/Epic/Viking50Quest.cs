...
{
	public class Viking50Quest : BaseQuest
	{
		/// <summary>
		...
		// Constructors
		public Viking50Quest() : base()
		{
		}

		public Viking50Quest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public Viking50Quest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public Viking50Quest(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
...
//Item Descriptions End
			...
			Lynnleigh.AddQuestToGive(typeof (Viking50Quest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Lynnleigh.RemoveQuestToGive(typeof (Viking50Quest));
		}
		...
		protected static void TalkToLynnleigh(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Lynnleigh.CanGiveQuest(typeof (Viking50Quest), player)  <= 0)
				return;
			...
			Viking50Quest quest = player.IsDoingQuest(typeof (Viking50Quest)) as Viking50Quest;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "worries me":
							...
							break;
						case "face Ydenia":
							player.Out.SendQuestSubscribeCommand(Lynnleigh, QuestMgr.GetIDForQuestType(typeof(Viking50Quest)), "Will you face Ydenia [Viking Level 50 Epic]?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (Viking50Quest)) != null)
				return true;
		...
		protected static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(Viking50Quest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Lynnleigh.GiveQuest(typeof (Viking50Quest), player, 1))
					return;
		...
		public override void Notify(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (player==null || player.IsDoingQuest(typeof (Viking50Quest)) == null)
				return;
