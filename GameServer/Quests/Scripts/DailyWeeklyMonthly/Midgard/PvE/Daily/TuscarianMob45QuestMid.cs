...
{
    public class TuscarianMob45QuestMid : Quests.DailyQuest
    {
        /// <summary>
        ...
        // Constructors
        public TuscarianMob45QuestMid() : base()
        {
        }

        public TuscarianMob45QuestMid(GamePlayer questingPlayer) : base(questingPlayer, 1)
        {
        }

        public TuscarianMob45QuestMid(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
        {
        }

        public TuscarianMob45QuestMid(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
        {
        }
        ...
        public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            Jarek.AddQuestToGive(typeof(TuscarianMob45QuestMid));
        ...
        public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            Jarek.RemoveQuestToGive(typeof(TuscarianMob45QuestMid));
        }
        ...
        public static void TalkToJarek(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (Jarek.CanGiveQuest(typeof(TuscarianMob45QuestMid), player) <= 0)
                return;

            //We also check if the player is already doing the quest
            TuscarianMob45QuestMid quest = player.IsDoingQuest(typeof(TuscarianMob45QuestMid)) as TuscarianMob45QuestMid;
                    ...
                    switch (wArgs.Text)
                    {
                        case "clearing the way":
                            player.Out.SendQuestSubscribeCommand(Jarek,
                                QuestMgr.GetIDForQuestType(typeof(TuscarianMob45QuestMid)),
        ...
        public override bool CheckQuestQualification(GamePlayer player)
        {
            ...
            if (player.IsDoingQuest(typeof(TuscarianMob45QuestMid)) != null)
                return true;
        ...
        public static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(TuscarianMob45QuestMid)))
                return;
        ...
        private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
        {
            ...
            else
            {
                ...
                if (!Jarek.GiveQuest(typeof(TuscarianMob45QuestMid), player, 1))
                    return;
        ...
        public override void FinishQuest()
        {
            ...
            m_questPlayer.AddMoney(Money.GetMoney(0, 0, m_questPlayer.Level, 0, UtilCollection.Random(50)), "You receive {0} as a reward.");
