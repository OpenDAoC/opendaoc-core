...
{
	public class TeamBuilding1QuestMid : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public TeamBuilding1QuestMid() : base() {
		}

		public TeamBuilding1QuestMid(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public TeamBuilding1QuestMid(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public TeamBuilding1QuestMid(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Isaac.AddQuestToGive(typeof (TeamBuilding1QuestMid));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Isaac.RemoveQuestToGive(typeof (TeamBuilding1QuestMid));
		}
		...
		private static void TalkToIsaac(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Isaac.CanGiveQuest(typeof (TeamBuilding1QuestMid), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			TeamBuilding1QuestMid quest = player.IsDoingQuest(typeof (TeamBuilding1QuestMid)) as TeamBuilding1QuestMid;
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (quest == null)
				{
					...
					{
						case "feeling social":
							player.Out.SendQuestSubscribeCommand(Isaac, QuestMgr.GetIDForQuestType(typeof(TeamBuilding1QuestMid)), "Will you help Dean "+questTitle+"");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (TeamBuilding1QuestMid)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(TeamBuilding1QuestMid)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Isaac.GiveQuest(typeof (TeamBuilding1QuestMid), player, 1))
					return;
