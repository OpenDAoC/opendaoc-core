...
{
	public class MegalocerosKill40QuestMid : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public MegalocerosKill40QuestMid() : base()
		{
		}

		public MegalocerosKill40QuestMid(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public MegalocerosKill40QuestMid(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public MegalocerosKill40QuestMid(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Jarek.AddQuestToGive(typeof (MegalocerosKill40QuestMid));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Jarek.RemoveQuestToGive(typeof (MegalocerosKill40QuestMid));
		}
		...
		private static void TalkToJarek(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Jarek.CanGiveQuest(typeof (MegalocerosKill40QuestMid), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			MegalocerosKill40QuestMid quest = player.IsDoingQuest(typeof (MegalocerosKill40QuestMid)) as MegalocerosKill40QuestMid;
				...
				if (quest == null)
				{
					switch (wArgs.Text.ToLower())
					{
						case "clear the megaloceros":
							player.Out.SendQuestSubscribeCommand(Jarek, QuestMgr.GetIDForQuestType(typeof(MegalocerosKill40QuestMid)), "Will you help Jarek "+questTitle+"");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (MegalocerosKill40QuestMid)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(MegalocerosKill40QuestMid)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Jarek.GiveQuest(typeof (MegalocerosKill40QuestMid), player, 1))
					return;
		...
		public override void Notify(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (player == null || player.IsDoingQuest(typeof(MegalocerosKill40QuestMid)) == null)
				return;
