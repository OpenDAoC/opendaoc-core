...
{
	public class MonthlyEpicPve45QuestMid : Quests.MonthlyQuest
	{
		/// <summary>
		...
		// Constructors
		public MonthlyEpicPve45QuestMid() : base()
		{
		}

		public MonthlyEpicPve45QuestMid(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public MonthlyEpicPve45QuestMid(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public MonthlyEpicPve45QuestMid(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Jarek.AddQuestToGive(typeof (MonthlyEpicPve45QuestMid));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Jarek.RemoveQuestToGive(typeof (MonthlyEpicPve45QuestMid));
		}
		...
		private static void TalkToJarek(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Jarek.CanGiveQuest(typeof (MonthlyEpicPve45QuestMid), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			MonthlyEpicPve45QuestMid quest = player.IsDoingQuest(typeof (MonthlyEpicPve45QuestMid)) as MonthlyEpicPve45QuestMid;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "kill Nosdoden and Iarnvidiur":
							player.Out.SendQuestSubscribeCommand(Jarek, QuestMgr.GetIDForQuestType(typeof(MonthlyEpicPve45QuestMid)), "Will you help Jarek "+questTitle+"?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (MonthlyEpicPve45QuestMid)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(MonthlyEpicPve45QuestMid)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Jarek.GiveQuest(typeof (MonthlyEpicPve45QuestMid), player, 1))
					return;
