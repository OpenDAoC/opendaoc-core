...
{
	public class DragonWeekly45QuestMid : Quests.WeeklyQuest
	{
		/// <summary>
		...
		// Constructors
		public DragonWeekly45QuestMid() : base()
		{
		}

		public DragonWeekly45QuestMid(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public DragonWeekly45QuestMid(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public DragonWeekly45QuestMid(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Isaac.AddQuestToGive(typeof (DragonWeekly45QuestMid));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Isaac.RemoveQuestToGive(typeof (DragonWeekly45QuestMid));
		}
		...
		private static void TalkToIsaac(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Isaac.CanGiveQuest(typeof (DragonWeekly45QuestMid), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			DragonWeekly45QuestMid quest = player.IsDoingQuest(typeof (DragonWeekly45QuestMid)) as DragonWeekly45QuestMid;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "kill the dragon":
							player.Out.SendQuestSubscribeCommand(Isaac, QuestMgr.GetIDForQuestType(typeof(DragonWeekly45QuestMid)), "Will you help Isaac "+questTitle+"?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (DragonWeekly45QuestMid)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(DragonWeekly45QuestMid)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Isaac.GiveQuest(typeof (DragonWeekly45QuestMid), player, 1))
					return;
