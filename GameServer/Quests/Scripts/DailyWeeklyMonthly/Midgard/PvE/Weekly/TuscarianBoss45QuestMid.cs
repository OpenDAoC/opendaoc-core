...
{
    public class TuscarianBoss45QuestMid : Quests.WeeklyQuest
    {
        /// <summary>
        ...
        // Constructors
        public TuscarianBoss45QuestMid() : base()
        {
        }

        public TuscarianBoss45QuestMid(GamePlayer questingPlayer) : base(questingPlayer, 1)
        {
        }

        public TuscarianBoss45QuestMid(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
        {
        }

        public TuscarianBoss45QuestMid(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
        {
        }
        ...
        public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            Jarek.AddQuestToGive(typeof(TuscarianBoss45QuestMid));
        ...
        public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            Jarek.RemoveQuestToGive(typeof(TuscarianBoss45QuestMid));
        }
        ...
        private static void TalkToJarek(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (Jarek.CanGiveQuest(typeof(TuscarianBoss45QuestMid), player) <= 0)
                return;

            //We also check if the player is already doing the quest
            TuscarianBoss45QuestMid quest = player.IsDoingQuest(typeof(TuscarianBoss45QuestMid)) as TuscarianBoss45QuestMid;
                    ...
                    switch (wArgs.Text)
                    {
                        case "end their plotting":
                            player.Out.SendQuestSubscribeCommand(Jarek,
                                QuestMgr.GetIDForQuestType(typeof(TuscarianBoss45QuestMid)),
        ...
        public override bool CheckQuestQualification(GamePlayer player)
        {
            ...
            if (player.IsDoingQuest(typeof(TuscarianBoss45QuestMid)) != null)
                return true;
        ...
        private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(TuscarianBoss45QuestMid)))
                return;
        ...
        private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
        {
            ...
            else
            {
                ...
                if (!Jarek.GiveQuest(typeof(TuscarianBoss45QuestMid), player, 1))
                    return;
