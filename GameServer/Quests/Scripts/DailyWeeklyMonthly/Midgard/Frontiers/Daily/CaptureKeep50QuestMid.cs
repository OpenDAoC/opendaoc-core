...
{
	public class CaptureKeep50QuestMid : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public CaptureKeep50QuestMid() : base()
		{
		}

		public CaptureKeep50QuestMid(GamePlayer questingPlayer) : base(questingPlayer, 1)
		{
		}

		public CaptureKeep50QuestMid(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public CaptureKeep50QuestMid(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Herou.AddQuestToGive(typeof (CaptureKeep50QuestMid));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Herou.RemoveQuestToGive(typeof (CaptureKeep50QuestMid));
		}
		...
		private static void TalkToHerou(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Herou.CanGiveQuest(typeof (CaptureKeep50QuestMid), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			CaptureKeep50QuestMid quest = player.IsDoingQuest(typeof (CaptureKeep50QuestMid)) as CaptureKeep50QuestMid;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "securing a foothold":
							player.Out.SendQuestSubscribeCommand(Herou, QuestMgr.GetIDForQuestType(typeof(CaptureKeep50QuestMid)), "Will you help Herou "+questTitle+"");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (CaptureKeep50QuestMid)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(CaptureKeep50QuestMid)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Herou.GiveQuest(typeof (CaptureKeep50QuestMid), player, 1))
					return;
