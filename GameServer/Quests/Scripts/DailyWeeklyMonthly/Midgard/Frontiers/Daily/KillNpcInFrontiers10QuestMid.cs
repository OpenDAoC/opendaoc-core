...
{
	public class KillNpcInFrontiers10QuestMid : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public KillNpcInFrontiers10QuestMid() : base()
		{
		}

		public KillNpcInFrontiers10QuestMid(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public KillNpcInFrontiers10QuestMid(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public KillNpcInFrontiers10QuestMid(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Herou.AddQuestToGive(typeof (KillNpcInFrontiers10QuestMid));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Herou.RemoveQuestToGive(typeof (KillNpcInFrontiers10QuestMid));
		}
		...
		protected static void TalkToHerou(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Herou.CanGiveQuest(typeof (KillNpcInFrontiers10QuestMid), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			KillNpcInFrontiers10QuestMid quest = player.IsDoingQuest(typeof (KillNpcInFrontiers10QuestMid)) as KillNpcInFrontiers10QuestMid;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "clear the frontiers":
							player.Out.SendQuestSubscribeCommand(Herou, QuestMgr.GetIDForQuestType(typeof(KillNpcInFrontiers10QuestMid)), "Will you help Herou "+questTitle+"");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (KillNpcInFrontiers10QuestMid)) != null)
				return true;
		...
		protected static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(KillNpcInFrontiers10QuestMid)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Herou.GiveQuest(typeof (KillNpcInFrontiers10QuestMid), player, 1))
					return;
