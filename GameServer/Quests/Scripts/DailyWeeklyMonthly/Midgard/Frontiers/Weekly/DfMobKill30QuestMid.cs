...
{
	public class DfMobKill30QuestMid : Quests.WeeklyQuest
	{
		/// <summary>
		...
		// Constructors
		public DfMobKill30QuestMid() : base()
		{
		}

		public DfMobKill30QuestMid(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public DfMobKill30QuestMid(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public DfMobKill30QuestMid(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Patrick.AddQuestToGive(typeof (DfMobKill30QuestMid));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Patrick.RemoveQuestToGive(typeof (DfMobKill30QuestMid));
		}
		...
		private static void TalkToPatrick(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Patrick.CanGiveQuest(typeof (DfMobKill30QuestMid), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			DfMobKill30QuestMid quest = player.IsDoingQuest(typeof (DfMobKill30QuestMid)) as DfMobKill30QuestMid;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "stop the invasion":
							player.Out.SendQuestSubscribeCommand(Patrick, QuestMgr.GetIDForQuestType(typeof(DfMobKill30QuestMid)), "Will you help Patrick "+questTitle+"?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (DfMobKill30QuestMid)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(DfMobKill30QuestMid)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Patrick.GiveQuest(typeof (DfMobKill30QuestMid), player, 1))
					return;
