...
{
	public class EpicRvrMobsWeekly50QuestMid : Quests.WeeklyQuest
	{
		/// <summary>
		...
		// Constructors
		public EpicRvrMobsWeekly50QuestMid() : base()
		{
		}

		public EpicRvrMobsWeekly50QuestMid(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public EpicRvrMobsWeekly50QuestMid(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public EpicRvrMobsWeekly50QuestMid(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Herou.AddQuestToGive(typeof (EpicRvrMobsWeekly50QuestMid));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Herou.RemoveQuestToGive(typeof (EpicRvrMobsWeekly50QuestMid));
		}
		...
		private static void TalkToHerou(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Herou.CanGiveQuest(typeof (EpicRvrMobsWeekly50QuestMid), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			EpicRvrMobsWeekly50QuestMid quest = player.IsDoingQuest(typeof (EpicRvrMobsWeekly50QuestMid)) as EpicRvrMobsWeekly50QuestMid;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "kill the epic creatures":
							player.Out.SendQuestSubscribeCommand(Herou, QuestMgr.GetIDForQuestType(typeof(EpicRvrMobsWeekly50QuestMid)), "Will you help Herou "+questTitle+"?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (EpicRvrMobsWeekly50QuestMid)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(EpicRvrMobsWeekly50QuestMid)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Herou.GiveQuest(typeof (EpicRvrMobsWeekly50QuestMid), player, 1))
					return;
