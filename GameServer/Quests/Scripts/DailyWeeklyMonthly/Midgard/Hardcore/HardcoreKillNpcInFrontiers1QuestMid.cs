...
{
	public class HardcoreKillNpcInFrontiers1QuestMid : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public HardcoreKillNpcInFrontiers1QuestMid() : base()
		{
		}

		public HardcoreKillNpcInFrontiers1QuestMid(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public HardcoreKillNpcInFrontiers1QuestMid(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public HardcoreKillNpcInFrontiers1QuestMid(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			SucciMid.AddQuestToGive(typeof (HardcoreKillNpcInFrontiers1QuestMid));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			SucciMid.RemoveQuestToGive(typeof (HardcoreKillNpcInFrontiers1QuestMid));
		}
		...
		private static void TalkToSucci(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(SucciMid.CanGiveQuest(typeof (HardcoreKillNpcInFrontiers1QuestMid), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			HardcoreKillNpcInFrontiers1QuestMid oranges = player.IsDoingQuest(typeof (HardcoreKillNpcInFrontiers1QuestMid)) as HardcoreKillNpcInFrontiers1QuestMid;
				...
				if (oranges == null)
				{
					switch (wArgs.Text.ToLower())
					{
						case "one can be brave":
							player.Out.SendQuestSubscribeCommand(SucciMid, QuestMgr.GetIDForQuestType(typeof(HardcoreKillNpcInFrontiers1QuestMid)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (HardcoreKillNpcInFrontiers1QuestMid)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(HardcoreKillNpcInFrontiers1QuestMid)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!SucciMid.GiveQuest(typeof (HardcoreKillNpcInFrontiers1QuestMid), player, 1))
					return;
