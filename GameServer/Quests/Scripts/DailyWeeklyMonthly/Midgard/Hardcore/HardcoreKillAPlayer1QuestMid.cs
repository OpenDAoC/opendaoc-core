...
{
	public class HardcoreKillAPlayer1QuestMid : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public HardcoreKillAPlayer1QuestMid() : base()
		{
		}

		public HardcoreKillAPlayer1QuestMid(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public HardcoreKillAPlayer1QuestMid(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public HardcoreKillAPlayer1QuestMid(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			SucciMid.AddQuestToGive(typeof (HardcoreKillAPlayer1QuestMid));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			SucciMid.RemoveQuestToGive(typeof (HardcoreKillAPlayer1QuestMid));
		}
		...
		private static void TalkToSucci(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(SucciMid.CanGiveQuest(typeof (HardcoreKillAPlayer1QuestMid), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			HardcoreKillAPlayer1QuestMid oranges = player.IsDoingQuest(typeof (HardcoreKillAPlayer1QuestMid)) as HardcoreKillAPlayer1QuestMid;
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (oranges == null)
				{
					...
					{
						case "predator":
							player.Out.SendQuestSubscribeCommand(SucciMid, QuestMgr.GetIDForQuestType(typeof(HardcoreKillAPlayer1QuestMid)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (HardcoreKillAPlayer1QuestMid)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(HardcoreKillAPlayer1QuestMid)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!SucciMid.GiveQuest(typeof (HardcoreKillAPlayer1QuestMid), player, 1))
					return;
