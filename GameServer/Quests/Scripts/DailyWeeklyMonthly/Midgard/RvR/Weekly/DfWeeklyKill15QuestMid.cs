...
{
	public class DfWeeklyKill15QuestMid : Quests.WeeklyQuest
	{
		/// <summary>
		...
		// Constructors
		public DfWeeklyKill15QuestMid() : base()
		{
		}

		public DfWeeklyKill15QuestMid(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public DfWeeklyKill15QuestMid(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public DfWeeklyKill15QuestMid(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Patrick.AddQuestToGive(typeof (DfWeeklyKill15QuestMid));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Patrick.RemoveQuestToGive(typeof (DfWeeklyKill15QuestMid));
		}
		...
		private static void TalkToPatrick(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Patrick.CanGiveQuest(typeof (DfWeeklyKill15QuestMid), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			DfWeeklyKill15QuestMid quest = player.IsDoingQuest(typeof (DfWeeklyKill15QuestMid)) as DfWeeklyKill15QuestMid;
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (quest == null)
				{
					...
					{
						case "demonic aura":
							player.Out.SendQuestSubscribeCommand(Patrick, QuestMgr.GetIDForQuestType(typeof(DfWeeklyKill15QuestMid)), "Will you help Patrick "+questTitle+"?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (DfWeeklyKill15QuestMid)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(DfWeeklyKill15QuestMid)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Patrick.GiveQuest(typeof (DfWeeklyKill15QuestMid), player, 1))
					return;
