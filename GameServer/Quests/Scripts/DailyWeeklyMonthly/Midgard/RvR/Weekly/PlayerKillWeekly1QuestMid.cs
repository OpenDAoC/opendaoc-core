...
{
	public class PlayerKillWeekly1QuestMid : Quests.WeeklyQuest
	{
		/// <summary>
		...
		// Constructors
		public PlayerKillWeekly1QuestMid() : base()
		{
		}

		public PlayerKillWeekly1QuestMid(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public PlayerKillWeekly1QuestMid(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public PlayerKillWeekly1QuestMid(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyMid.AddQuestToGive(typeof (PlayerKillWeekly1QuestMid));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyMid.RemoveQuestToGive(typeof (PlayerKillWeekly1QuestMid));
		}
		...
		private static void TalkToRey(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(ReyMid.CanGiveQuest(typeof (PlayerKillWeekly1QuestMid), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			PlayerKillWeekly1QuestMid quest = player.IsDoingQuest(typeof (PlayerKillWeekly1QuestMid)) as PlayerKillWeekly1QuestMid;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "bone harvesting":
							player.Out.SendQuestSubscribeCommand(ReyMid, QuestMgr.GetIDForQuestType(typeof(PlayerKillWeekly1QuestMid)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (PlayerKillWeekly1QuestMid)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(PlayerKillWeekly1QuestMid)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!ReyMid.GiveQuest(typeof (PlayerKillWeekly1QuestMid), player, 1))
					return;
