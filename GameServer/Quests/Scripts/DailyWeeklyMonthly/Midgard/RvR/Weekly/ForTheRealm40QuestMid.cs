...
{
	public class ForTheRealm40QuestMid : Quests.WeeklyQuest
	{
		/// <summary>
		...
		// Constructors
		public ForTheRealm40QuestMid() : base()
		{
		}

		public ForTheRealm40QuestMid(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public ForTheRealm40QuestMid(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public ForTheRealm40QuestMid(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyMid.AddQuestToGive(typeof (ForTheRealm40QuestMid));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyMid.RemoveQuestToGive(typeof (ForTheRealm40QuestMid));
		}
		...
		protected static void TalkToRey(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(ReyMid.CanGiveQuest(typeof (ForTheRealm40QuestMid), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			ForTheRealm40QuestMid quest = player.IsDoingQuest(typeof (ForTheRealm40QuestMid)) as ForTheRealm40QuestMid;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "bunch of toeknuckles":
							player.Out.SendQuestSubscribeCommand(ReyMid, QuestMgr.GetIDForQuestType(typeof(ForTheRealm40QuestMid)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (ForTheRealm40QuestMid)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(ForTheRealm40QuestMid)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!ReyMid.GiveQuest(typeof (ForTheRealm40QuestMid), player, 1))
					return;
