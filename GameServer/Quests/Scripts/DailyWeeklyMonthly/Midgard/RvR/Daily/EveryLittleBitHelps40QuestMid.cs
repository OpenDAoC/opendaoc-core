...
{
	public class EveryLittleBitHelps40QuestMid : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public EveryLittleBitHelps40QuestMid() : base()
		{
		}

		public EveryLittleBitHelps40QuestMid(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public EveryLittleBitHelps40QuestMid(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public EveryLittleBitHelps40QuestMid(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyMid.AddQuestToGive(typeof (EveryLittleBitHelps40QuestMid));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyMid.RemoveQuestToGive(typeof (EveryLittleBitHelps40QuestMid));
		}
		...
		private static void TalkToRey(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(ReyMid.CanGiveQuest(typeof (EveryLittleBitHelps40QuestMid), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			EveryLittleBitHelps40QuestMid quest = player.IsDoingQuest(typeof (EveryLittleBitHelps40QuestMid)) as EveryLittleBitHelps40QuestMid;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "take the toeknuckle":
							player.Out.SendQuestSubscribeCommand(ReyMid, QuestMgr.GetIDForQuestType(typeof(EveryLittleBitHelps40QuestMid)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (EveryLittleBitHelps40QuestMid)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(EveryLittleBitHelps40QuestMid)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!ReyMid.GiveQuest(typeof (EveryLittleBitHelps40QuestMid), player, 1))
					return;
