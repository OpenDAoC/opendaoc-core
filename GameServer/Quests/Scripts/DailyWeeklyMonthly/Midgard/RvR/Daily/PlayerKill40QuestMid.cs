...
{
	public class PlayerKill40QuestMid : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public PlayerKill40QuestMid() : base()
		{
		}

		public PlayerKill40QuestMid(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public PlayerKill40QuestMid(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public PlayerKill40QuestMid(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyMid.AddQuestToGive(typeof (PlayerKill40QuestMid));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyMid.RemoveQuestToGive(typeof (PlayerKill40QuestMid));
		}
		...
		private static void TalkToRey(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(ReyMid.CanGiveQuest(typeof (PlayerKill40QuestMid), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			PlayerKill40QuestMid quest = player.IsDoingQuest(typeof (PlayerKill40QuestMid)) as PlayerKill40QuestMid;
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (quest == null)
				{
					...
					{
						case "help me out":
							player.Out.SendQuestSubscribeCommand(ReyMid, QuestMgr.GetIDForQuestType(typeof(PlayerKill40QuestMid)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (PlayerKill40QuestMid)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(PlayerKill40QuestMid)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!ReyMid.GiveQuest(typeof (PlayerKill40QuestMid), player, 1))
					return;
