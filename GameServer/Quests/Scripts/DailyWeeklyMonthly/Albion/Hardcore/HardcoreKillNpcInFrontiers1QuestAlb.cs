...
{
	public class HardcoreKillNpcInFrontiers1QuestAlb : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public HardcoreKillNpcInFrontiers1QuestAlb() : base()
		{
		}

		public HardcoreKillNpcInFrontiers1QuestAlb(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public HardcoreKillNpcInFrontiers1QuestAlb(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public HardcoreKillNpcInFrontiers1QuestAlb(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			SucciAlb.AddQuestToGive(typeof (HardcoreKillNpcInFrontiers1QuestAlb));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			SucciAlb.RemoveQuestToGive(typeof (HardcoreKillNpcInFrontiers1QuestAlb));
		}
		...
		private static void TalkToSucci(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (SucciAlb.CanGiveQuest(typeof(HardcoreKillNpcInFrontiers1QuestAlb), player) <= 0)
				return;

			//We also check if the player is already doing the quest
			HardcoreKillNpcInFrontiers1QuestAlb oranges = player.IsDoingQuest(typeof (HardcoreKillNpcInFrontiers1QuestAlb)) as HardcoreKillNpcInFrontiers1QuestAlb;
				...
				if (oranges == null)
				{
					switch (wArgs.Text.ToLower())
					{
						case "one can be brave":
							player.Out.SendQuestSubscribeCommand(SucciAlb, QuestMgr.GetIDForQuestType(typeof(HardcoreKillNpcInFrontiers1QuestAlb)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (HardcoreKillNpcInFrontiers1QuestAlb)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(HardcoreKillNpcInFrontiers1QuestAlb)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!SucciAlb.GiveQuest(typeof (HardcoreKillNpcInFrontiers1QuestAlb), player, 1))
					return;
