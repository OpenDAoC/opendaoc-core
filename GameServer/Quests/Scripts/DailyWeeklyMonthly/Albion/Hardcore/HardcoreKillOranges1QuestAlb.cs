...
{
	public class HardcoreKillOranges1QuestAlb : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public HardcoreKillOranges1QuestAlb() : base()
		{
		}

		public HardcoreKillOranges1QuestAlb(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public HardcoreKillOranges1QuestAlb(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public HardcoreKillOranges1QuestAlb(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			SucciAlb.AddQuestToGive(typeof (HardcoreKillOranges1QuestAlb));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			SucciAlb.RemoveQuestToGive(typeof (HardcoreKillOranges1QuestAlb));
		}
		...
		private static void TalkToSucci(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(SucciAlb.CanGiveQuest(typeof (HardcoreKillOranges1QuestAlb), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			HardcoreKillOranges1QuestAlb oranges = player.IsDoingQuest(typeof (HardcoreKillOranges1QuestAlb)) as HardcoreKillOranges1QuestAlb;
				...
				if (oranges == null)
				{
					switch (wArgs.Text)
					{
						case "today is not the day":
							player.Out.SendQuestSubscribeCommand(SucciAlb, QuestMgr.GetIDForQuestType(typeof(HardcoreKillOranges1QuestAlb)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (HardcoreKillOranges1QuestAlb)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(HardcoreKillOranges1QuestAlb)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!SucciAlb.GiveQuest(typeof (HardcoreKillOranges1QuestAlb), player, 1))
					return;
