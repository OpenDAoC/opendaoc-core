...
{
    public class SidiBoss45QuestAlb : Quests.WeeklyQuest
    {
        /// <summary>
        ...
        // Constructors
        public SidiBoss45QuestAlb() : base()
        {
        }

        public SidiBoss45QuestAlb(GamePlayer questingPlayer) : base(questingPlayer, 1)
        {
        }

        public SidiBoss45QuestAlb(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
        {
        }

        public SidiBoss45QuestAlb(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
        {
        }
        ...
        public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            James.AddQuestToGive(typeof(SidiBoss45QuestAlb));
        ...
        public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            James.RemoveQuestToGive(typeof(SidiBoss45QuestAlb));
        }
        ...
        protected static void TalkToJames(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (James.CanGiveQuest(typeof(SidiBoss45QuestAlb), player) <= 0)
                return;

            //We also check if the player is already doing the quest
            SidiBoss45QuestAlb quest = player.IsDoingQuest(typeof(SidiBoss45QuestAlb)) as SidiBoss45QuestAlb;
                    ...
                    switch (wArgs.Text)
                    {
                        case "end their plotting":
                            player.Out.SendQuestSubscribeCommand(James,
                                QuestMgr.GetIDForQuestType(typeof(SidiBoss45QuestAlb)),
        ...
        public override bool CheckQuestQualification(GamePlayer player)
        {
            ...
            if (player.IsDoingQuest(typeof(SidiBoss45QuestAlb)) != null)
                return true;
        ...
        protected static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(SidiBoss45QuestAlb)))
                return;
        ...
        private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
        {
            ...
            else
            {
                ...
                if (!James.GiveQuest(typeof(SidiBoss45QuestAlb), player, 1))
                    return;
        ...
        public override void Notify(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (player == null || player.IsDoingQuest(typeof(SidiBoss45QuestAlb)) == null)
                return;
