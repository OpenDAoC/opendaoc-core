...
{
	public class DragonWeekly45QuestAlb : Quests.WeeklyQuest
	{
		/// <summary>
		...
		public DragonWeekly45QuestAlb(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public DragonWeekly45QuestAlb(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public DragonWeekly45QuestAlb(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Hector.AddQuestToGive(typeof (DragonWeekly45QuestAlb));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Hector.RemoveQuestToGive(typeof (DragonWeekly45QuestAlb));
		}
		...
		private static void TalkToHector(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Hector.CanGiveQuest(typeof (DragonWeekly45QuestAlb), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			DragonWeekly45QuestAlb quest = player.IsDoingQuest(typeof (DragonWeekly45QuestAlb)) as DragonWeekly45QuestAlb;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "kill the dragon":
							player.Out.SendQuestSubscribeCommand(Hector, QuestMgr.GetIDForQuestType(typeof(DragonWeekly45QuestAlb)), "Will you help Hector with "+questTitle+"?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (DragonWeekly45QuestAlb)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(DragonWeekly45QuestAlb)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Hector.GiveQuest(typeof (DragonWeekly45QuestAlb), player, 1))
					return;
		...
		public override void Notify(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (player == null || player.IsDoingQuest(typeof(DragonWeekly45QuestAlb)) == null)
				return;
