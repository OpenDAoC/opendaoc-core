...
{
	public class MonthlyEpicPve45QuestAlb : Quests.MonthlyQuest
	{
		/// <summary>
		...
		// Constructors
		public MonthlyEpicPve45QuestAlb() : base()
		{
		}

		public MonthlyEpicPve45QuestAlb(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public MonthlyEpicPve45QuestAlb(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public MonthlyEpicPve45QuestAlb(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			James.AddQuestToGive(typeof (MonthlyEpicPve45QuestAlb));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			James.RemoveQuestToGive(typeof (MonthlyEpicPve45QuestAlb));
		}
		...
		private static void TalkToJames(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(James.CanGiveQuest(typeof (MonthlyEpicPve45QuestAlb), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			MonthlyEpicPve45QuestAlb quest = player.IsDoingQuest(typeof (MonthlyEpicPve45QuestAlb)) as MonthlyEpicPve45QuestAlb;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "kill Orylle and Xanxicar":
							player.Out.SendQuestSubscribeCommand(James, QuestMgr.GetIDForQuestType(typeof(MonthlyEpicPve45QuestAlb)), "Will you help James "+questTitle+"?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (MonthlyEpicPve45QuestAlb)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(MonthlyEpicPve45QuestAlb)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!James.GiveQuest(typeof (MonthlyEpicPve45QuestAlb), player, 1))
					return;
