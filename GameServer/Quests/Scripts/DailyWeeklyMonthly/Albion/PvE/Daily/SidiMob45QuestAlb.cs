...
{
    public class SidiMob45QuestAlb : Quests.DailyQuest
    {
        /// <summary>
        ...
        // Constructors
        public SidiMob45QuestAlb() : base()
        {
        }

        public SidiMob45QuestAlb(GamePlayer questingPlayer) : base(questingPlayer, 1)
        {
        }

        public SidiMob45QuestAlb(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
        {
        }

        public SidiMob45QuestAlb(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
        {
        }
        ...
        public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            James.AddQuestToGive(typeof(SidiMob45QuestAlb));
        ...
        public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            James.RemoveQuestToGive(typeof(SidiMob45QuestAlb));
        }
        ...
        protected static void TalkToJames(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (James.CanGiveQuest(typeof(SidiMob45QuestAlb), player) <= 0)
                return;

            //We also check if the player is already doing the quest
            SidiMob45QuestAlb quest = player.IsDoingQuest(typeof(SidiMob45QuestAlb)) as SidiMob45QuestAlb;
                    ...
                    switch (wArgs.Text)
                    {
                        case "clearing the way":
                            player.Out.SendQuestSubscribeCommand(James,
                                QuestMgr.GetIDForQuestType(typeof(SidiMob45QuestAlb)),
        ...
        public override bool CheckQuestQualification(GamePlayer player)
        {
            ...
            if (player.IsDoingQuest(typeof(SidiMob45QuestAlb)) != null)
                return true;
        ...
        private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(SidiMob45QuestAlb)))
                return;
        ...
        private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
        {
            ...
            else
            {
                ...
                if (!James.GiveQuest(typeof(SidiMob45QuestAlb), player, 1))
                    return;
