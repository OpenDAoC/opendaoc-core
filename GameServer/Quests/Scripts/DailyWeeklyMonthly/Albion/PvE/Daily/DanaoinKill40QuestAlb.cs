...
{
	public class DanaoinKill40QuestAlb : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public DanaoinKill40QuestAlb() : base()
		{
		}

		public DanaoinKill40QuestAlb(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public DanaoinKill40QuestAlb(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public DanaoinKill40QuestAlb(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			James.AddQuestToGive(typeof (DanaoinKill40QuestAlb));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			James.RemoveQuestToGive(typeof (DanaoinKill40QuestAlb));
		}
		...
		private static void TalkToJames(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(James.CanGiveQuest(typeof (DanaoinKill40QuestAlb), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			DanaoinKill40QuestAlb quest = player.IsDoingQuest(typeof (DanaoinKill40QuestAlb)) as DanaoinKill40QuestAlb;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "clear the Danaoin":
							player.Out.SendQuestSubscribeCommand(James, QuestMgr.GetIDForQuestType(typeof(DanaoinKill40QuestAlb)), "Will you help James "+questTitle+"");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (DanaoinKill40QuestAlb)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(DanaoinKill40QuestAlb)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!James.GiveQuest(typeof (DanaoinKill40QuestAlb), player, 1))
					return;
		...
		public override void Notify(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (player == null || player.IsDoingQuest(typeof(DanaoinKill40QuestAlb)) == null)
				return;
