...
{
	public class TeamBuilding1QuestAlb : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public TeamBuilding1QuestAlb() : base() {
		}

		public TeamBuilding1QuestAlb(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public TeamBuilding1QuestAlb(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public TeamBuilding1QuestAlb(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Hector.AddQuestToGive(typeof (TeamBuilding1QuestAlb));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Hector.RemoveQuestToGive(typeof (TeamBuilding1QuestAlb));
		}
		...
		protected static void TalkToHector(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Hector.CanGiveQuest(typeof (TeamBuilding1QuestAlb), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			TeamBuilding1QuestAlb quest = player.IsDoingQuest(typeof (TeamBuilding1QuestAlb)) as TeamBuilding1QuestAlb;
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (quest == null)
				{
					...
					{
						case "feeling social":
							player.Out.SendQuestSubscribeCommand(Hector, QuestMgr.GetIDForQuestType(typeof(TeamBuilding1QuestAlb)), "Will you help Hector "+questTitle+"");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (TeamBuilding1QuestAlb)) != null)
				return true;
		...
		protected static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(TeamBuilding1QuestAlb)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Hector.GiveQuest(typeof (TeamBuilding1QuestAlb), player, 1))
					return;
