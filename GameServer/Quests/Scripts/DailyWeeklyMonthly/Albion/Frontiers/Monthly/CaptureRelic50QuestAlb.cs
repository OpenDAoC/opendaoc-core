...
{
	public class CaptureRelic50QuestAlb : Quests.MonthlyQuest
	{
		/// <summary>
		...
		// Constructors
		public CaptureRelic50QuestAlb() : base()
		{
		}

		public CaptureRelic50QuestAlb(GamePlayer questingPlayer) : base(questingPlayer, 1)
		{
		}

		public CaptureRelic50QuestAlb(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public CaptureRelic50QuestAlb(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Kelteen.AddQuestToGive(typeof (CaptureRelic50QuestAlb));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Kelteen.RemoveQuestToGive(typeof (CaptureRelic50QuestAlb));
		}
		...
		private static void TalkToKelteen(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Kelteen.CanGiveQuest(typeof (CaptureRelic50QuestAlb), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			CaptureRelic50QuestAlb quest = player.IsDoingQuest(typeof (CaptureRelic50QuestAlb)) as CaptureRelic50QuestAlb;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "securing a foothold":
							player.Out.SendQuestSubscribeCommand(Kelteen, QuestMgr.GetIDForQuestType(typeof(CaptureRelic50QuestAlb)), "Will you help Kelteen "+questTitle+"");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (CaptureRelic50QuestAlb)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(CaptureRelic50QuestAlb)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Kelteen.GiveQuest(typeof (CaptureRelic50QuestAlb), player, 1))
					return;
