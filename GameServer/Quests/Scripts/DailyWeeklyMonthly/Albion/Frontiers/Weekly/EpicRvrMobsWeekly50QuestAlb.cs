...
{
	public class EpicRvrMobsWeekly50QuestAlb : Quests.WeeklyQuest
	{
		/// <summary>
		...
		// Constructors
		public EpicRvrMobsWeekly50QuestAlb() : base()
		{
		}

		public EpicRvrMobsWeekly50QuestAlb(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public EpicRvrMobsWeekly50QuestAlb(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public EpicRvrMobsWeekly50QuestAlb(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Haszan.AddQuestToGive(typeof (EpicRvrMobsWeekly50QuestAlb));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Haszan.RemoveQuestToGive(typeof (EpicRvrMobsWeekly50QuestAlb));
		}
		...
		private static void TalkToHaszan(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Haszan.CanGiveQuest(typeof (EpicRvrMobsWeekly50QuestAlb), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			EpicRvrMobsWeekly50QuestAlb quest = player.IsDoingQuest(typeof (EpicRvrMobsWeekly50QuestAlb)) as EpicRvrMobsWeekly50QuestAlb;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "kill the epic creatures":
							player.Out.SendQuestSubscribeCommand(Haszan, QuestMgr.GetIDForQuestType(typeof(EpicRvrMobsWeekly50QuestAlb)), "Will you help Haszan "+questTitle+"?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (EpicRvrMobsWeekly50QuestAlb)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(EpicRvrMobsWeekly50QuestAlb)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Haszan.GiveQuest(typeof (EpicRvrMobsWeekly50QuestAlb), player, 1))
					return;
