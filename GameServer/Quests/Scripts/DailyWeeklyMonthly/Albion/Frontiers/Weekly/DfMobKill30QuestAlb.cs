...
{
	public class DfMobKill30QuestAlb : Quests.WeeklyQuest
	{
		/// <summary>
		...
		// Constructors
		public DfMobKill30QuestAlb() : base()
		{
		}

		public DfMobKill30QuestAlb(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public DfMobKill30QuestAlb(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public DfMobKill30QuestAlb(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Joe.AddQuestToGive(typeof (DfMobKill30QuestAlb));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Joe.RemoveQuestToGive(typeof (DfMobKill30QuestAlb));
		}
		...
		private static void TalkToJoe(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Joe.CanGiveQuest(typeof (DfMobKill30QuestAlb), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			DfMobKill30QuestAlb quest = player.IsDoingQuest(typeof (DfMobKill30QuestAlb)) as DfMobKill30QuestAlb;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "stop the invasion":
							player.Out.SendQuestSubscribeCommand(Joe, QuestMgr.GetIDForQuestType(typeof(DfMobKill30QuestAlb)), "Will you help Joe "+questTitle+"?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (DfMobKill30QuestAlb)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(DfMobKill30QuestAlb)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Joe.GiveQuest(typeof (DfMobKill30QuestAlb), player, 1))
					return;
