...
{
	public class CaptureKeep50QuestAlb : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public CaptureKeep50QuestAlb() : base()
		{
		}

		public CaptureKeep50QuestAlb(GamePlayer questingPlayer) : base(questingPlayer, 1)
		{
		}

		public CaptureKeep50QuestAlb(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public CaptureKeep50QuestAlb(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Haszan.AddQuestToGive(typeof (CaptureKeep50QuestAlb));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Haszan.RemoveQuestToGive(typeof (CaptureKeep50QuestAlb));
		}
		...
		private static void TalkToHaszan(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Haszan.CanGiveQuest(typeof (CaptureKeep50QuestAlb), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			CaptureKeep50QuestAlb quest = player.IsDoingQuest(typeof (CaptureKeep50QuestAlb)) as CaptureKeep50QuestAlb;
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (quest == null)
				{
					...
					{
						case "reclaim a keep":
							player.Out.SendQuestSubscribeCommand(Haszan, QuestMgr.GetIDForQuestType(typeof(CaptureKeep50QuestAlb)), "Will you help Haszan "+questTitle+"");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (CaptureKeep50QuestAlb)) != null)
				return true;
		...
		protected static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(CaptureKeep50QuestAlb)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Haszan.GiveQuest(typeof (CaptureKeep50QuestAlb), player, 1))
					return;
