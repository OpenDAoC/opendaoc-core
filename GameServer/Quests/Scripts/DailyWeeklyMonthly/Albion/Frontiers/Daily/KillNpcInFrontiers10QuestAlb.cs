...
{
	public class KillNpcInFrontiers10QuestAlb : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public KillNpcInFrontiers10QuestAlb() : base() {
		}

		public KillNpcInFrontiers10QuestAlb(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public KillNpcInFrontiers10QuestAlb(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public KillNpcInFrontiers10QuestAlb(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Haszan.AddQuestToGive(typeof (KillNpcInFrontiers10QuestAlb));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Haszan.RemoveQuestToGive(typeof (KillNpcInFrontiers10QuestAlb));
		}
		...
		private static void TalkToHaszan(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Haszan.CanGiveQuest(typeof (KillNpcInFrontiers10QuestAlb), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			KillNpcInFrontiers10QuestAlb quest = player.IsDoingQuest(typeof (KillNpcInFrontiers10QuestAlb)) as KillNpcInFrontiers10QuestAlb;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "clear the frontiers":
							player.Out.SendQuestSubscribeCommand(Haszan, QuestMgr.GetIDForQuestType(typeof(KillNpcInFrontiers10QuestAlb)), "Will you help Haszan "+questTitle+"");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (KillNpcInFrontiers10QuestAlb)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(KillNpcInFrontiers10QuestAlb)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Haszan.GiveQuest(typeof (KillNpcInFrontiers10QuestAlb), player, 1))
					return;
		...
		public override void FinishQuest()
		{
			...
			m_questPlayer.AddMoney(MoneyUtil.GetMoney(0,0,m_questPlayer.Level * 2,50,UtilCollection.Random(50)), "You receive {0} as a reward.");
