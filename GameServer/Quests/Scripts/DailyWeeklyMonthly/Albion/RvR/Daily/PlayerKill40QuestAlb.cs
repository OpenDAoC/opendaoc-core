...
{
	public class PlayerKill40QuestAlb : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public PlayerKill40QuestAlb() : base()
		{
		}

		public PlayerKill40QuestAlb(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public PlayerKill40QuestAlb(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public PlayerKill40QuestAlb(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyAlb.AddQuestToGive(typeof (PlayerKill40QuestAlb));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyAlb.RemoveQuestToGive(typeof (PlayerKill40QuestAlb));
		}
		...
		protected static void TalkToRey(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(ReyAlb.CanGiveQuest(typeof (PlayerKill40QuestAlb), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			PlayerKill40QuestAlb quest = player.IsDoingQuest(typeof (PlayerKill40QuestAlb)) as PlayerKill40QuestAlb;
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (quest == null)
				{
					...
					{
						case "help me out":
							player.Out.SendQuestSubscribeCommand(ReyAlb, QuestMgr.GetIDForQuestType(typeof(PlayerKill40QuestAlb)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (PlayerKill40QuestAlb)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(PlayerKill40QuestAlb)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!ReyAlb.GiveQuest(typeof (PlayerKill40QuestAlb), player, 1))
					return;
