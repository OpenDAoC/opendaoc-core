...
{
	public class EveryLittleBitHelps40QuestAlb : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public EveryLittleBitHelps40QuestAlb() : base()
		{
		}

		public EveryLittleBitHelps40QuestAlb(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public EveryLittleBitHelps40QuestAlb(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public EveryLittleBitHelps40QuestAlb(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyAlb.AddQuestToGive(typeof (EveryLittleBitHelps40QuestAlb));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyAlb.RemoveQuestToGive(typeof (EveryLittleBitHelps40QuestAlb));
		}
		...
		private static void TalkToRey(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(ReyAlb.CanGiveQuest(typeof (EveryLittleBitHelps40QuestAlb), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			EveryLittleBitHelps40QuestAlb quest = player.IsDoingQuest(typeof (EveryLittleBitHelps40QuestAlb)) as EveryLittleBitHelps40QuestAlb;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "take the toeknuckle":
							player.Out.SendQuestSubscribeCommand(ReyAlb, QuestMgr.GetIDForQuestType(typeof(EveryLittleBitHelps40QuestAlb)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (EveryLittleBitHelps40QuestAlb)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(EveryLittleBitHelps40QuestAlb)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!ReyAlb.GiveQuest(typeof (EveryLittleBitHelps40QuestAlb), player, 1))
					return;
		...
		public override void Notify(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (player == null || player.IsDoingQuest(typeof(EveryLittleBitHelps40QuestAlb)) == null)
				return;
