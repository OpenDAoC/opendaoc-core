...
{
	public class PlayerKillWeekly1QuestAlb : Quests.WeeklyQuest
	{
		/// <summary>
		...
		// Constructors
		public PlayerKillWeekly1QuestAlb() : base()
		{
		}

		public PlayerKillWeekly1QuestAlb(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public PlayerKillWeekly1QuestAlb(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public PlayerKillWeekly1QuestAlb(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyAlb.AddQuestToGive(typeof (PlayerKillWeekly1QuestAlb));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyAlb.RemoveQuestToGive(typeof (PlayerKillWeekly1QuestAlb));
		}
		...
		private static void TalkToRey(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(ReyAlb.CanGiveQuest(typeof (PlayerKillWeekly1QuestAlb), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			PlayerKillWeekly1QuestAlb quest = player.IsDoingQuest(typeof (PlayerKillWeekly1QuestAlb)) as PlayerKillWeekly1QuestAlb;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "bone harvesting":
							player.Out.SendQuestSubscribeCommand(ReyAlb, QuestMgr.GetIDForQuestType(typeof(PlayerKillWeekly1QuestAlb)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (PlayerKillWeekly1QuestAlb)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(PlayerKillWeekly1QuestAlb)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!ReyAlb.GiveQuest(typeof (PlayerKillWeekly1QuestAlb), player, 1))
					return;
		...
		public override void Notify(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (player == null || player.IsDoingQuest(typeof(PlayerKillWeekly1QuestAlb)) == null)
				return;
