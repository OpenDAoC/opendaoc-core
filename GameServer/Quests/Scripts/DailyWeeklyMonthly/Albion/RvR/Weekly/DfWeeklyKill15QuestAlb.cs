...
{
	public class DfWeeklyKill15QuestAlb : Quests.WeeklyQuest
	{
		/// <summary>
		...
		// Constructors
		public DfWeeklyKill15QuestAlb() : base()
		{
		}

		public DfWeeklyKill15QuestAlb(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public DfWeeklyKill15QuestAlb(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public DfWeeklyKill15QuestAlb(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Joe.AddQuestToGive(typeof (DfWeeklyKill15QuestAlb));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Joe.RemoveQuestToGive(typeof (DfWeeklyKill15QuestAlb));
		}
		...
		private static void TalkToJoe(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Joe.CanGiveQuest(typeof (DfWeeklyKill15QuestAlb), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			DfWeeklyKill15QuestAlb quest = player.IsDoingQuest(typeof (DfWeeklyKill15QuestAlb)) as DfWeeklyKill15QuestAlb;
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (quest == null)
				{
					...
					{
						case "demonic aura":
							player.Out.SendQuestSubscribeCommand(Joe, QuestMgr.GetIDForQuestType(typeof(DfWeeklyKill15QuestAlb)), "Will you help Joe "+questTitle+"?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (DfWeeklyKill15QuestAlb)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(DfWeeklyKill15QuestAlb)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Joe.GiveQuest(typeof (DfWeeklyKill15QuestAlb), player, 1))
					return;
		...
		public override void Notify(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (player == null || player.IsDoingQuest(typeof(DfWeeklyKill15QuestAlb)) == null)
				return;
