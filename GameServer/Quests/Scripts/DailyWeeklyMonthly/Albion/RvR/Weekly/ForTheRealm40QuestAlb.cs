...
{
	public class ForTheRealm40QuestAlb : Quests.WeeklyQuest
	{
		/// <summary>
		...
		// Constructors
		public ForTheRealm40QuestAlb() : base()
		{
		}

		public ForTheRealm40QuestAlb(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public ForTheRealm40QuestAlb(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public ForTheRealm40QuestAlb(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyAlb.AddQuestToGive(typeof (ForTheRealm40QuestAlb));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyAlb.RemoveQuestToGive(typeof (ForTheRealm40QuestAlb));
		}
		...
		private static void TalkToRey(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(ReyAlb.CanGiveQuest(typeof (ForTheRealm40QuestAlb), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			ForTheRealm40QuestAlb quest = player.IsDoingQuest(typeof (ForTheRealm40QuestAlb)) as ForTheRealm40QuestAlb;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "bunch of toeknuckles":
							player.Out.SendQuestSubscribeCommand(ReyAlb, QuestMgr.GetIDForQuestType(typeof(ForTheRealm40QuestAlb)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (ForTheRealm40QuestAlb)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(ForTheRealm40QuestAlb)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!ReyAlb.GiveQuest(typeof (ForTheRealm40QuestAlb), player, 1))
					return;
