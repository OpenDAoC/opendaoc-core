...
{
	public class TeamBuilding1QuestHib : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public TeamBuilding1QuestHib() : base() {
		}

		public TeamBuilding1QuestHib(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public TeamBuilding1QuestHib(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public TeamBuilding1QuestHib(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Dean.AddQuestToGive(typeof (TeamBuilding1QuestHib));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Dean.RemoveQuestToGive(typeof (TeamBuilding1QuestHib));
		}
		...
		private static void TalkToDean(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Dean.CanGiveQuest(typeof (TeamBuilding1QuestHib), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			TeamBuilding1QuestHib quest = player.IsDoingQuest(typeof (TeamBuilding1QuestHib)) as TeamBuilding1QuestHib;
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (quest == null)
				{
					...
					{
						case "feeling social":
							player.Out.SendQuestSubscribeCommand(Dean, QuestMgr.GetIDForQuestType(typeof(TeamBuilding1QuestHib)), "Will you help Dean "+questTitle+"");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (TeamBuilding1QuestHib)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(TeamBuilding1QuestHib)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Dean.GiveQuest(typeof (TeamBuilding1QuestHib), player, 1))
					return;
