...
{
    public class GalladoriaBoss45QuestHib : Quests.WeeklyQuest
    {
        /// <summary>
        ...
        // Constructors
        public GalladoriaBoss45QuestHib() : base()
        {
        }

        public GalladoriaBoss45QuestHib(GamePlayer questingPlayer) : base(questingPlayer, 1)
        {
        }

        public GalladoriaBoss45QuestHib(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
        {
        }

        public GalladoriaBoss45QuestHib(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
        {
        }
        ...
        public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            Anthony.AddQuestToGive(typeof(GalladoriaBoss45QuestHib));
        ...
        public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            Anthony.RemoveQuestToGive(typeof(GalladoriaBoss45QuestHib));
        }
        ...
        private static void TalkToAnthony(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (Anthony.CanGiveQuest(typeof(GalladoriaBoss45QuestHib), player) <= 0)
                return;

            //We also check if the player is already doing the quest
            GalladoriaBoss45QuestHib quest = player.IsDoingQuest(typeof(GalladoriaBoss45QuestHib)) as GalladoriaBoss45QuestHib;
                    ...
                    switch (wArgs.Text)
                    {
                        case "end their plotting":
                            player.Out.SendQuestSubscribeCommand(Anthony,
                                QuestMgr.GetIDForQuestType(typeof(GalladoriaBoss45QuestHib)),
        ...
        public override bool CheckQuestQualification(GamePlayer player)
        {
            ...
            if (player.IsDoingQuest(typeof(GalladoriaBoss45QuestHib)) != null)
                return true;
        ...
        private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(GalladoriaBoss45QuestHib)))
                return;
        ...
        private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
        {
            ...
            else
            {
                ...
                if (!Anthony.GiveQuest(typeof(GalladoriaBoss45QuestHib), player, 1))
                    return;
