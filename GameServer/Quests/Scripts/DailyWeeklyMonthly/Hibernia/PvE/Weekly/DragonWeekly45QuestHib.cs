...
{
	public class DragonWeekly45QuestHib : Quests.WeeklyQuest
	{
		/// <summary>
		...
		// Constructors
		public DragonWeekly45QuestHib() : base()
		{
		}

		public DragonWeekly45QuestHib(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public DragonWeekly45QuestHib(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public DragonWeekly45QuestHib(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Dean.AddQuestToGive(typeof (DragonWeekly45QuestHib));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Dean.RemoveQuestToGive(typeof (DragonWeekly45QuestHib));
		}
		...
		private static void TalkToDean(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Dean.CanGiveQuest(typeof (DragonWeekly45QuestHib), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			DragonWeekly45QuestHib quest = player.IsDoingQuest(typeof (DragonWeekly45QuestHib)) as DragonWeekly45QuestHib;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "kill the dragon":
							player.Out.SendQuestSubscribeCommand(Dean, QuestMgr.GetIDForQuestType(typeof(DragonWeekly45QuestHib)), "Will you help Dean with "+questTitle+"?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (DragonWeekly45QuestHib)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(DragonWeekly45QuestHib)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Dean.GiveQuest(typeof (DragonWeekly45QuestHib), player, 1))
					return;
