...
{
	public class EpicRvrMobsWeekly50QuestHib : Quests.WeeklyQuest
	{
		/// <summary>
		...
		// Constructors
		public EpicRvrMobsWeekly50QuestHib() : base()
		{
		}

		public EpicRvrMobsWeekly50QuestHib(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public EpicRvrMobsWeekly50QuestHib(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public EpicRvrMobsWeekly50QuestHib(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Cola.AddQuestToGive(typeof (EpicRvrMobsWeekly50QuestHib));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Cola.RemoveQuestToGive(typeof (EpicRvrMobsWeekly50QuestHib));
		}
		...
		private static void TalkToCola(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Cola.CanGiveQuest(typeof (EpicRvrMobsWeekly50QuestHib), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			EpicRvrMobsWeekly50QuestHib quest = player.IsDoingQuest(typeof (EpicRvrMobsWeekly50QuestHib)) as EpicRvrMobsWeekly50QuestHib;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "kill the epic creatures":
							player.Out.SendQuestSubscribeCommand(Cola, QuestMgr.GetIDForQuestType(typeof(EpicRvrMobsWeekly50QuestHib)), "Will you help Cola "+questTitle+"?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (EpicRvrMobsWeekly50QuestHib)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(EpicRvrMobsWeekly50QuestHib)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Cola.GiveQuest(typeof (EpicRvrMobsWeekly50QuestHib), player, 1))
					return;
		...
		public override void FinishQuest()
		{
			...
			RogMgr.GenerateJewel(m_questPlayer, (byte)(m_questPlayer.Level + 1), m_questPlayer.Level + UtilCollection.Random(10, 11));
			_evernKilled = 0;
