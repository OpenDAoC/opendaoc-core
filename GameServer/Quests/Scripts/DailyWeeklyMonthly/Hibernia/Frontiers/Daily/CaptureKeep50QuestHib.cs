...
{
	public class CaptureKeep50QuestHib : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public CaptureKeep50QuestHib() : base()
		{
		}

		public CaptureKeep50QuestHib(GamePlayer questingPlayer) : base(questingPlayer, 1)
		{
		}

		public CaptureKeep50QuestHib(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public CaptureKeep50QuestHib(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Cola.AddQuestToGive(typeof (CaptureKeep50QuestHib));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Cola.RemoveQuestToGive(typeof (CaptureKeep50QuestHib));
		}
		...
		private static void TalkToCola(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Cola.CanGiveQuest(typeof (CaptureKeep50QuestHib), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			CaptureKeep50QuestHib quest = player.IsDoingQuest(typeof (CaptureKeep50QuestHib)) as CaptureKeep50QuestHib;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "securing a foothold":
							player.Out.SendQuestSubscribeCommand(Cola, QuestMgr.GetIDForQuestType(typeof(CaptureKeep50QuestHib)), "Will you help Cola "+questTitle+"");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (CaptureKeep50QuestHib)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(CaptureKeep50QuestHib)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Cola.GiveQuest(typeof (CaptureKeep50QuestHib), player, 1))
					return;
