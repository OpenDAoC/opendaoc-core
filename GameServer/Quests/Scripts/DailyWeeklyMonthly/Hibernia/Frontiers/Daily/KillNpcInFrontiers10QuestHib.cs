...
{
	public class KillNpcInFrontiers10QuestHib : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public KillNpcInFrontiers10QuestHib() : base()
		{
		}

		public KillNpcInFrontiers10QuestHib(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public KillNpcInFrontiers10QuestHib(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public KillNpcInFrontiers10QuestHib(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Cola.AddQuestToGive(typeof (KillNpcInFrontiers10QuestHib));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Cola.RemoveQuestToGive(typeof (KillNpcInFrontiers10QuestHib));
		}
		...
		private static void TalkToCola(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Cola.CanGiveQuest(typeof (KillNpcInFrontiers10QuestHib), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			KillNpcInFrontiers10QuestHib quest = player.IsDoingQuest(typeof (KillNpcInFrontiers10QuestHib)) as KillNpcInFrontiers10QuestHib;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "clear the frontiers":
							player.Out.SendQuestSubscribeCommand(Cola, QuestMgr.GetIDForQuestType(typeof(KillNpcInFrontiers10QuestHib)), "Will you help Cola "+questTitle+"");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (KillNpcInFrontiers10QuestHib)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(KillNpcInFrontiers10QuestHib)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Cola.GiveQuest(typeof (KillNpcInFrontiers10QuestHib), player, 1))
					return;
