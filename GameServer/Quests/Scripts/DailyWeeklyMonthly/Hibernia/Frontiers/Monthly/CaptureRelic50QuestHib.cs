...
{
	public class CaptureRelic50QuestHib : Quests.MonthlyQuest
	{
		/// <summary>
		...
		// Constructors
		public CaptureRelic50QuestHib() : base()
		{
		}

		public CaptureRelic50QuestHib(GamePlayer questingPlayer) : base(questingPlayer, 1)
		{
		}

		public CaptureRelic50QuestHib(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public CaptureRelic50QuestHib(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Kelteen.AddQuestToGive(typeof (CaptureRelic50QuestHib));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Kelteen.RemoveQuestToGive(typeof (CaptureRelic50QuestHib));
		}
		...
		private static void TalkToKelteen(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Kelteen.CanGiveQuest(typeof (CaptureRelic50QuestHib), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			CaptureRelic50QuestHib quest = player.IsDoingQuest(typeof (CaptureRelic50QuestHib)) as CaptureRelic50QuestHib;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "securing a foothold":
							player.Out.SendQuestSubscribeCommand(Kelteen, QuestMgr.GetIDForQuestType(typeof(CaptureRelic50QuestHib)), "Will you help Kelteen "+questTitle+"");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (CaptureRelic50QuestHib)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(CaptureRelic50QuestHib)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Kelteen.GiveQuest(typeof (CaptureRelic50QuestHib), player, 1))
					return;
