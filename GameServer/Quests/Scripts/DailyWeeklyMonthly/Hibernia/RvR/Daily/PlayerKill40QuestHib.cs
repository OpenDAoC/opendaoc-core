...
{
	public class PlayerKill40QuestHib : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public PlayerKill40QuestHib() : base()
		{
		}

		public PlayerKill40QuestHib(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public PlayerKill40QuestHib(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public PlayerKill40QuestHib(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyHib.AddQuestToGive(typeof (PlayerKill40QuestHib));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyHib.RemoveQuestToGive(typeof (PlayerKill40QuestHib));
		}
		...
		private static void TalkToRey(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(ReyHib.CanGiveQuest(typeof (PlayerKill40QuestHib), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			PlayerKill40QuestHib quest = player.IsDoingQuest(typeof (PlayerKill40QuestHib)) as PlayerKill40QuestHib;
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (quest == null)
				{
					...
					{
						case "help me out":
							player.Out.SendQuestSubscribeCommand(ReyHib, QuestMgr.GetIDForQuestType(typeof(PlayerKill40QuestHib)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (PlayerKill40QuestHib)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(PlayerKill40QuestHib)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!ReyHib.GiveQuest(typeof (PlayerKill40QuestHib), player, 1))
					return;
