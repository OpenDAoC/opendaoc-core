...
{
	public class EveryLittleBitHelps40QuestHib : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public EveryLittleBitHelps40QuestHib() : base()
		{
		}

		public EveryLittleBitHelps40QuestHib(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public EveryLittleBitHelps40QuestHib(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public EveryLittleBitHelps40QuestHib(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyHib.AddQuestToGive(typeof (EveryLittleBitHelps40QuestHib));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyHib.RemoveQuestToGive(typeof (EveryLittleBitHelps40QuestHib));
		}
		...
		protected static void TalkToRey(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(ReyHib.CanGiveQuest(typeof (EveryLittleBitHelps40QuestHib), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			EveryLittleBitHelps40QuestHib quest = player.IsDoingQuest(typeof (EveryLittleBitHelps40QuestHib)) as EveryLittleBitHelps40QuestHib;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "take the toeknuckle":
							player.Out.SendQuestSubscribeCommand(ReyHib, QuestMgr.GetIDForQuestType(typeof(EveryLittleBitHelps40QuestHib)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (EveryLittleBitHelps40QuestHib)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(EveryLittleBitHelps40QuestHib)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!ReyHib.GiveQuest(typeof (EveryLittleBitHelps40QuestHib), player, 1))
					return;
