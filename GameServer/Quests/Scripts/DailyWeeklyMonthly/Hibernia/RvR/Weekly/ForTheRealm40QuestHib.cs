...
{
	public class ForTheRealm40QuestHib : Quests.WeeklyQuest
	{
		/// <summary>
		...
		// Constructors
		public ForTheRealm40QuestHib() : base()
		{
		}

		public ForTheRealm40QuestHib(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public ForTheRealm40QuestHib(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public ForTheRealm40QuestHib(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyHib.AddQuestToGive(typeof (ForTheRealm40QuestHib));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyHib.RemoveQuestToGive(typeof (ForTheRealm40QuestHib));
		}
		...
		private static void TalkToRey(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(ReyHib.CanGiveQuest(typeof (ForTheRealm40QuestHib), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			ForTheRealm40QuestHib quest = player.IsDoingQuest(typeof (ForTheRealm40QuestHib)) as ForTheRealm40QuestHib;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "bunch of toeknuckles":
							player.Out.SendQuestSubscribeCommand(ReyHib, QuestMgr.GetIDForQuestType(typeof(ForTheRealm40QuestHib)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (ForTheRealm40QuestHib)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(ForTheRealm40QuestHib)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!ReyHib.GiveQuest(typeof (ForTheRealm40QuestHib), player, 1))
					return;
