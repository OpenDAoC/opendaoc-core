...
{
	public class DfWeeklyKill15QuestHib : Quests.WeeklyQuest
	{
		/// <summary>
		...
		// Constructors
		public DfWeeklyKill15QuestHib() : base()
		{
		}

		public DfWeeklyKill15QuestHib(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public DfWeeklyKill15QuestHib(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public DfWeeklyKill15QuestHib(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Stefano.AddQuestToGive(typeof (DfWeeklyKill15QuestHib));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Stefano.RemoveQuestToGive(typeof (DfWeeklyKill15QuestHib));
		}
		...
		private static void TalkToStefano(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Stefano.CanGiveQuest(typeof (DfWeeklyKill15QuestHib), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			DfWeeklyKill15QuestHib quest = player.IsDoingQuest(typeof (DfWeeklyKill15QuestHib)) as DfWeeklyKill15QuestHib;
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (quest == null)
				{
					...
					{
						case "demonic aura":
							player.Out.SendQuestSubscribeCommand(Stefano, QuestMgr.GetIDForQuestType(typeof(DfWeeklyKill15QuestHib)), "Will you help Stefano with "+questTitle+"?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (DfWeeklyKill15QuestHib)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(DfWeeklyKill15QuestHib)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Stefano.GiveQuest(typeof (DfWeeklyKill15QuestHib), player, 1))
					return;
		...
		public override void Notify(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (player == null || player.IsDoingQuest(typeof(DfWeeklyKill15QuestHib)) == null)
				return;
