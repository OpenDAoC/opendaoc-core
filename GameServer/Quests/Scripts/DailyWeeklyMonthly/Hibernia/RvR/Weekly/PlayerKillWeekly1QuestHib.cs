...
{
	public class PlayerKillWeekly1QuestHib : Quests.WeeklyQuest
	{
		/// <summary>
		...
		// Constructors
		public PlayerKillWeekly1QuestHib() : base()
		{
		}

		public PlayerKillWeekly1QuestHib(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public PlayerKillWeekly1QuestHib(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public PlayerKillWeekly1QuestHib(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyHib.AddQuestToGive(typeof (PlayerKillWeekly1QuestHib));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyHib.RemoveQuestToGive(typeof (PlayerKillWeekly1QuestHib));
		}
		...
		private static void TalkToRey(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(ReyHib.CanGiveQuest(typeof (PlayerKillWeekly1QuestHib), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			PlayerKillWeekly1QuestHib quest = player.IsDoingQuest(typeof (PlayerKillWeekly1QuestHib)) as PlayerKillWeekly1QuestHib;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "bone harvesting":
							player.Out.SendQuestSubscribeCommand(ReyHib, QuestMgr.GetIDForQuestType(typeof(PlayerKillWeekly1QuestHib)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (PlayerKillWeekly1QuestHib)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(PlayerKillWeekly1QuestHib)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!ReyHib.GiveQuest(typeof (PlayerKillWeekly1QuestHib), player, 1))
					return;
