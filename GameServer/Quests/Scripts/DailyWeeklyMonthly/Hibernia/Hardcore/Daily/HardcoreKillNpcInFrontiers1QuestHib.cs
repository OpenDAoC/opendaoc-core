...
{
	public class HardcoreKillNpcInFrontiers1QuestHib : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public HardcoreKillNpcInFrontiers1QuestHib() : base()
		{
		}

		public HardcoreKillNpcInFrontiers1QuestHib(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public HardcoreKillNpcInFrontiers1QuestHib(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public HardcoreKillNpcInFrontiers1QuestHib(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			SucciHib.AddQuestToGive(typeof (HardcoreKillNpcInFrontiers1QuestHib));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			SucciHib.RemoveQuestToGive(typeof (HardcoreKillNpcInFrontiers1QuestHib));
		}
		...
		private static void TalkToSucci(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(SucciHib.CanGiveQuest(typeof (HardcoreKillNpcInFrontiers1QuestHib), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			HardcoreKillNpcInFrontiers1QuestHib oranges = player.IsDoingQuest(typeof (HardcoreKillNpcInFrontiers1QuestHib)) as HardcoreKillNpcInFrontiers1QuestHib;
				...
				if (oranges == null)
				{
					switch (wArgs.Text.ToLower())
					{
						case "one can be brave":
							player.Out.SendQuestSubscribeCommand(SucciHib, QuestMgr.GetIDForQuestType(typeof(HardcoreKillNpcInFrontiers1QuestHib)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (HardcoreKillNpcInFrontiers1QuestHib)) != null)
				return true;
		...
		protected static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(HardcoreKillNpcInFrontiers1QuestHib)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!SucciHib.GiveQuest(typeof (HardcoreKillNpcInFrontiers1QuestHib), player, 1))
					return;
