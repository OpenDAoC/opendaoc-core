...
{
	public class HardcoreKillAPlayer1QuestHib : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public HardcoreKillAPlayer1QuestHib() : base()
		{
		}

		public HardcoreKillAPlayer1QuestHib(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public HardcoreKillAPlayer1QuestHib(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public HardcoreKillAPlayer1QuestHib(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			SucciHib.AddQuestToGive(typeof (HardcoreKillAPlayer1QuestHib));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			SucciHib.RemoveQuestToGive(typeof (HardcoreKillAPlayer1QuestHib));
		}
		...
		protected static void TalkToSucci(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(SucciHib.CanGiveQuest(typeof (HardcoreKillAPlayer1QuestHib), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			HardcoreKillAPlayer1QuestHib oranges = player.IsDoingQuest(typeof (HardcoreKillAPlayer1QuestHib)) as HardcoreKillAPlayer1QuestHib;
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (oranges == null)
				{
					...
					{
						case "predator":
							player.Out.SendQuestSubscribeCommand(SucciHib, QuestMgr.GetIDForQuestType(typeof(HardcoreKillAPlayer1QuestHib)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (HardcoreKillAPlayer1QuestHib)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(HardcoreKillAPlayer1QuestHib)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!SucciHib.GiveQuest(typeof (HardcoreKillAPlayer1QuestHib), player, 1))
					return;
