...
{
	public class HardcoreKillOranges1QuestHib : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public HardcoreKillOranges1QuestHib() : base()
		{
		}

		public HardcoreKillOranges1QuestHib(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public HardcoreKillOranges1QuestHib(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public HardcoreKillOranges1QuestHib(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			SucciHib.AddQuestToGive(typeof (HardcoreKillOranges1QuestHib));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			SucciHib.RemoveQuestToGive(typeof (HardcoreKillOranges1QuestHib));
		}
		...
		private static void TalkToSucci(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(SucciHib.CanGiveQuest(typeof (HardcoreKillOranges1QuestHib), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			HardcoreKillOranges1QuestHib oranges = player.IsDoingQuest(typeof (HardcoreKillOranges1QuestHib)) as HardcoreKillOranges1QuestHib;
				...
				if (oranges == null)
				{
					switch (wArgs.Text)
					{
						case "today is not the day":
							player.Out.SendQuestSubscribeCommand(SucciHib, QuestMgr.GetIDForQuestType(typeof(HardcoreKillOranges1QuestHib)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (HardcoreKillOranges1QuestHib)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(HardcoreKillOranges1QuestHib)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!SucciHib.GiveQuest(typeof (HardcoreKillOranges1QuestHib), player, 1))
					return;
