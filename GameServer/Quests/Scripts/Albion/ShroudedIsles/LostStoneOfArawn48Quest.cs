...
public class LostStoneOfArawn48Quest : BaseQuest
{
    ...
    // Constructors
    public LostStoneOfArawn48Quest()
    {
    }

    public LostStoneOfArawn48Quest(GamePlayer questingPlayer) : base(questingPlayer)
    {
    }

    public LostStoneOfArawn48Quest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
    {
    }

    public LostStoneOfArawn48Quest(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
    {
    }
    ...
    public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
    {
        ...
        Honaytrt.AddQuestToGive(typeof(LostStoneOfArawn48Quest));
    ...
    public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
    {
        ...
        Honaytrt.RemoveQuestToGive(typeof(LostStoneOfArawn48Quest));
    }
    ...
    {
        var quest = player.IsDoingQuest(typeof(LostStoneOfArawn48Quest)) as LostStoneOfArawn48Quest;
    ...
    private static void TalkToHonaytrt(CoreEvent e, object sender, EventArgs args)
    {
        ...
        if (Honaytrt.CanGiveQuest(typeof(LostStoneOfArawn48Quest), player) <= 0)
            return;
                ...
                switch (wArgs.Text)
                {
                    case "help me":
                        player.Out.SendQuestSubscribeCommand(Honaytrt,
                            QuestMgr.GetIDForQuestType(typeof(LostStoneOfArawn48Quest)),
    ...
    public override bool CheckQuestQualification(GamePlayer player)
    {
        ...
        if (player.IsDoingQuest(typeof(LostStoneOfArawn48Quest)) != null)
            return true;
    ...
    private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
    {
        ...
        if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(LostStoneOfArawn48Quest)))
            return;
    ...
    private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
    {
        ...
        else
        {
            ...
            if (!Honaytrt.GiveQuest(typeof(LostStoneOfArawn48Quest), player, 1))
                return;
