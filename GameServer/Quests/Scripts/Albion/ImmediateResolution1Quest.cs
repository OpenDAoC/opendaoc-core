...
{
    public class ImmediateResolution1Quest : BaseQuest
    {
        ...
        public ImmediateResolution1Quest() : base() { }
        public ImmediateResolution1Quest(GamePlayer questingPlayer) : this(questingPlayer, 1) { }
        public ImmediateResolution1Quest(GamePlayer questingPlayer, int step) : base(questingPlayer, step) { }
        public ImmediateResolution1Quest(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest) { }
        ...
        public override void Notify(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if(player.IsDoingQuest(typeof(ImmediateResolution1Quest)) == null)
            {
                return;
            }
        ...
        public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            _masterTor.AddQuestToGive(typeof(ImmediateResolution1Quest));
        ...
        public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            _masterTor.RemoveQuestToGive(typeof(ImmediateResolution1Quest));
        }
        ...
        protected static void TalkToStewardWillie(CoreEvent e, object sender, EventArgs args)
        {
            ...
            ImmediateResolution1Quest quest = player.IsDoingQuest(typeof(ImmediateResolution1Quest)) as ImmediateResolution1Quest;
        ...
        protected static void TalkToMasterTor(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (_masterTor.CanGiveQuest(typeof(ImmediateResolution1Quest), player) <= 0)
                return;
            ...
            else if (e == GameLivingEvent.WhisperReceive)
            {
                ...
                if (quest == null)
                {
                    ...
                    {
                        case "adventurers":
                            player.Out.SendQuestSubscribeCommand(_masterTor, QuestMgr.GetIDForQuestType(typeof(ImmediateResolution1Quest)), $"Do you accept this task?");
                            break;
                    }
                }
                else
        ...
        protected static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(ImmediateResolution1Quest)))
                return;
        ...
        private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
        {
            ...
            {
                if (!_masterTor.GiveQuest(typeof(ImmediateResolution1Quest), player, 1))
                    return;
        ...
        public override void FinishQuest()
        {
            ...
            long money = MoneyUtil.GetMoney(0, 0, 0, 0, 30 + UtilCollection.Random(50));
