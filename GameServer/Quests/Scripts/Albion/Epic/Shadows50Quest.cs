...
{
	public class Shadows50Quest : BaseQuest
	{
		/// <summary>
		...
		// Constructors
		public Shadows50Quest()
			: base()
		{
		}
		public Shadows50Quest(GamePlayer questingPlayer)
			: base(questingPlayer)
		{
		}

		public Shadows50Quest(GamePlayer questingPlayer, int step)
			: base(questingPlayer, step)
		{
		}

		public Shadows50Quest(GamePlayer questingPlayer, DbQuests dbQuest)
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Lidmann.AddQuestToGive(typeof(Shadows50Quest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Lidmann.RemoveQuestToGive(typeof(Shadows50Quest));
		}
		...
		protected static void TalkToLidmann(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (Lidmann.CanGiveQuest(typeof(Shadows50Quest), player) <= 0)
				return;

			//We also check if the player is already doing the quest
			Shadows50Quest quest = player.IsDoingQuest(typeof(Shadows50Quest)) as Shadows50Quest;
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (quest == null)
				{
					...
					{
						case "services":
							player.Out.SendQuestSubscribeCommand(Lidmann, QuestMgr.GetIDForQuestType(typeof(Shadows50Quest)), "Will you help Lidmann [Defenders of Albion Level 50 Epic]?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof(Shadows50Quest)) != null)
				return true;
		...
		protected static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(Shadows50Quest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Lidmann.GiveQuest(typeof(Shadows50Quest), player, 1))
					return;
		...
		public override void Notify(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (player == null || player.IsDoingQuest(typeof(Shadows50Quest)) == null)
				return;
