...
{
    public class WolfPeltCloak1Quest : BaseQuest
    {
        ...
        private static DbItemTemplates _wolfHeadToken = null;

        public WolfPeltCloak1Quest() : base() { }
        public WolfPeltCloak1Quest(GamePlayer questingPlayer) : this(questingPlayer, 1) { }
        public WolfPeltCloak1Quest(GamePlayer questingPlayer, int step) : base(questingPlayer, step) { }
        public WolfPeltCloak1Quest(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest) { }
        ...
        public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            _wolfFur = GameServer.Database.FindObjectByKey<DbItemTemplates>(wolfFur);
            if (_wolfFur == null)
            {
            ...
            _wolfHeadToken = GameServer.Database.FindObjectByKey<DbItemTemplates>(wolfHeadToken);
            ...
            _stewardWillie.AddQuestToGive(typeof(WolfPeltCloak1Quest));
        ...
        public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            _stewardWillie.RemoveQuestToGive(typeof(WolfPeltCloak1Quest));
        }
        ...
        protected static void TalkToStewardWillie(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (_stewardWillie.CanGiveQuest(typeof(WolfPeltCloak1Quest), player) <= 0)
                return;

            WolfPeltCloak1Quest quest = player.IsDoingQuest(typeof(WolfPeltCloak1Quest)) as WolfPeltCloak1Quest;
                ...
                if (quest == null)
                {
                    switch (wArgs.Text)
                    {
                        ...
                        case "like to help":
                            ...
                            break;
                        case "serve him well":
                            player.Out.SendQuestSubscribeCommand(_stewardWillie, QuestMgr.GetIDForQuestType(typeof(WolfPeltCloak1Quest)), "Do you accept the Wolf Pelt Cloak quest?");
                            break;
                    }
                }
                else
        ...
        protected static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(WolfPeltCloak1Quest)))
                return;
        ...
        {            
            if (player.IsDoingQuest(typeof(WolfPeltCloak1Quest)) != null)
                return true;
        ...
        private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
        {
            ...
            {
                if (!_stewardWillie.GiveQuest(typeof(WolfPeltCloak1Quest), player, 1))
                    return;
