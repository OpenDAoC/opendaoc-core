...
{
	public class CaleKillQuestMid34Quest : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public CaleKillQuestMid34Quest() : base()
		{
		}

		public CaleKillQuestMid34Quest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public CaleKillQuestMid34Quest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public CaleKillQuestMid34Quest(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			PazzMid.AddQuestToGive(typeof (CaleKillQuestMid34Quest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			PazzMid.RemoveQuestToGive(typeof (CaleKillQuestMid34Quest));
		}
		...
		private static void TalkToRey(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(PazzMid.CanGiveQuest(typeof (CaleKillQuestMid34Quest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			CaleKillQuestMid34Quest quest = player.IsDoingQuest(typeof (CaleKillQuestMid34Quest)) as CaleKillQuestMid34Quest;
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (quest == null)
				{
					...
					{
						case "help me out":
							player.Out.SendQuestSubscribeCommand(PazzMid, QuestMgr.GetIDForQuestType(typeof(CaleKillQuestMid34Quest)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (CaleKillQuestMid34Quest)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(CaleKillQuestMid34Quest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!PazzMid.GiveQuest(typeof (CaleKillQuestMid34Quest), player, 1))
					return;
