...
{
	public class CaleKillQuestHib34Quest : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public CaleKillQuestHib34Quest() : base()
		{
		}

		public CaleKillQuestHib34Quest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public CaleKillQuestHib34Quest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public CaleKillQuestHib34Quest(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			PazzHib.AddQuestToGive(typeof (CaleKillQuestHib34Quest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			PazzHib.RemoveQuestToGive(typeof (CaleKillQuestHib34Quest));
		}
		...
		private static void TalkToPazz(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(PazzHib.CanGiveQuest(typeof (CaleKillQuestHib34Quest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			CaleKillQuestHib34Quest quest = player.IsDoingQuest(typeof (CaleKillQuestHib34Quest)) as CaleKillQuestHib34Quest;
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (quest == null)
				{
					...
					{
						case "help me out":
							player.Out.SendQuestSubscribeCommand(PazzHib, QuestMgr.GetIDForQuestType(typeof(CaleKillQuestHib34Quest)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (CaleKillQuestHib34Quest)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(CaleKillQuestHib34Quest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!PazzHib.GiveQuest(typeof (CaleKillQuestHib34Quest), player, 1))
					return;
