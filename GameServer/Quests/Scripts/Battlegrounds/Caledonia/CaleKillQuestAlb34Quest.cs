...
{
	public class CaleKillQuestAlb34Quest : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public CaleKillQuestAlb34Quest() : base()
		{
		}

		public CaleKillQuestAlb34Quest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public CaleKillQuestAlb34Quest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public CaleKillQuestAlb34Quest(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			PazzAlb.AddQuestToGive(typeof (CaleKillQuestAlb34Quest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			PazzAlb.RemoveQuestToGive(typeof (CaleKillQuestAlb34Quest));
		}
		...
		protected static void TalkToRey(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(PazzAlb.CanGiveQuest(typeof (CaleKillQuestAlb34Quest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			CaleKillQuestAlb34Quest quest = player.IsDoingQuest(typeof (CaleKillQuestAlb34Quest)) as CaleKillQuestAlb34Quest;
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (quest == null)
				{
					...
					{
						case "help me out":
							player.Out.SendQuestSubscribeCommand(PazzAlb, QuestMgr.GetIDForQuestType(typeof(CaleKillQuestAlb34Quest)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (CaleKillQuestAlb34Quest)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(CaleKillQuestAlb34Quest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!PazzAlb.GiveQuest(typeof (CaleKillQuestAlb34Quest), player, 1))
					return;
