...
{
	public class ThidKeepCaptureMid20Quest : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public ThidKeepCaptureMid20Quest() : base()
		{
		}

		public ThidKeepCaptureMid20Quest(GamePlayer questingPlayer) : base(questingPlayer, 1)
		{
		}

		public ThidKeepCaptureMid20Quest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public ThidKeepCaptureMid20Quest(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			PazzMid.AddQuestToGive(typeof (ThidKeepCaptureMid20Quest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			PazzMid.RemoveQuestToGive(typeof (ThidKeepCaptureMid20Quest));
		}
		...
		private static void TalkToHerou(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(PazzMid.CanGiveQuest(typeof (ThidKeepCaptureMid20Quest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			ThidKeepCaptureMid20Quest quest = player.IsDoingQuest(typeof (ThidKeepCaptureMid20Quest)) as ThidKeepCaptureMid20Quest;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "help a skeleton":
							player.Out.SendQuestSubscribeCommand(PazzMid, QuestMgr.GetIDForQuestType(typeof(ThidKeepCaptureMid20Quest)), "Will you help Pazz with "+questTitle+"");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (ThidKeepCaptureMid20Quest)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(ThidKeepCaptureMid20Quest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!PazzMid.GiveQuest(typeof (ThidKeepCaptureMid20Quest), player, 1))
					return;
