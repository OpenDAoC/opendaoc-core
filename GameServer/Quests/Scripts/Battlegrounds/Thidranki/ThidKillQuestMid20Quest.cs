...
{
	public class ThidKillQuestMid20Quest : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public ThidKillQuestMid20Quest() : base()
		{
		}

		public ThidKillQuestMid20Quest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public ThidKillQuestMid20Quest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public ThidKillQuestMid20Quest(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			PazzMid.AddQuestToGive(typeof (ThidKillQuestMid20Quest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			PazzMid.RemoveQuestToGive(typeof (ThidKillQuestMid20Quest));
		}
		...
		private static void TalkToRey(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(PazzMid.CanGiveQuest(typeof (ThidKillQuestMid20Quest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			ThidKillQuestMid20Quest quest = player.IsDoingQuest(typeof (ThidKillQuestMid20Quest)) as ThidKillQuestMid20Quest;
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (quest == null)
				{
					...
					{
						case "help me out":
							player.Out.SendQuestSubscribeCommand(PazzMid, QuestMgr.GetIDForQuestType(typeof(ThidKillQuestMid20Quest)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (ThidKillQuestMid20Quest)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(ThidKillQuestMid20Quest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!PazzMid.GiveQuest(typeof (ThidKillQuestMid20Quest), player, 1))
					return;
