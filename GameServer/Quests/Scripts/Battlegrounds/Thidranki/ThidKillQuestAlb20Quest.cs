...
{
	public class ThidKillQuestAlb20Quest : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public ThidKillQuestAlb20Quest() : base()
		{
		}

		public ThidKillQuestAlb20Quest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public ThidKillQuestAlb20Quest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public ThidKillQuestAlb20Quest(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			PazzAlb.AddQuestToGive(typeof (ThidKillQuestAlb20Quest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			PazzAlb.RemoveQuestToGive(typeof (ThidKillQuestAlb20Quest));
		}
		...
		protected static void TalkToRey(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(PazzAlb.CanGiveQuest(typeof (ThidKillQuestAlb20Quest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			ThidKillQuestAlb20Quest quest = player.IsDoingQuest(typeof (ThidKillQuestAlb20Quest)) as ThidKillQuestAlb20Quest;
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (quest == null)
				{
					...
					{
						case "help me out":
							player.Out.SendQuestSubscribeCommand(PazzAlb, QuestMgr.GetIDForQuestType(typeof(ThidKillQuestAlb20Quest)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (ThidKillQuestAlb20Quest)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(ThidKillQuestAlb20Quest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!PazzAlb.GiveQuest(typeof (ThidKillQuestAlb20Quest), player, 1))
					return;
		...
		public override void FinishQuest()
		{
			if (m_questPlayer.Inventory.IsSlotsFree(1, eInventorySlot.FirstBackpack, eInventorySlot.LastBackpack))
			{
				...
				m_questPlayer.AddMoney(MoneyUtil.GetMoney(0, 0, m_questPlayer.Level * 2, 32, UtilCollection.Random(50)),
