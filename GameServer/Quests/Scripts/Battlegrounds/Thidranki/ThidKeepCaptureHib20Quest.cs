...
{
	public class ThidKeepCaptureHib20Quest : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public ThidKeepCaptureHib20Quest() : base()
		{
		}

		public ThidKeepCaptureHib20Quest(GamePlayer questingPlayer) : base(questingPlayer, 1)
		{
		}

		public ThidKeepCaptureHib20Quest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public ThidKeepCaptureHib20Quest(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			PazzHib.AddQuestToGive(typeof (ThidKeepCaptureHib20Quest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			PazzHib.RemoveQuestToGive(typeof (ThidKeepCaptureHib20Quest));
		}
		...
		private static void TalkToCola(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(PazzHib.CanGiveQuest(typeof (ThidKeepCaptureHib20Quest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			ThidKeepCaptureHib20Quest quest = player.IsDoingQuest(typeof (ThidKeepCaptureHib20Quest)) as ThidKeepCaptureHib20Quest;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "help a skeleton":
							player.Out.SendQuestSubscribeCommand(PazzHib, QuestMgr.GetIDForQuestType(typeof(ThidKeepCaptureHib20Quest)), "Will you help Pazz with "+questTitle+"");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (ThidKeepCaptureHib20Quest)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(ThidKeepCaptureHib20Quest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!PazzHib.GiveQuest(typeof (ThidKeepCaptureHib20Quest), player, 1))
					return;
