...
{
	public class ThidKillQuestHib20Quest : Quests.DailyQuest
	{
		/// <summary>
		...
		// Constructors
		public ThidKillQuestHib20Quest() : base()
		{
		}

		public ThidKillQuestHib20Quest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public ThidKillQuestHib20Quest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public ThidKillQuestHib20Quest(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			PazzHib.AddQuestToGive(typeof (ThidKillQuestHib20Quest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			PazzHib.RemoveQuestToGive(typeof (ThidKillQuestHib20Quest));
		}
		...
		private static void TalkToPazz(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(PazzHib.CanGiveQuest(typeof (ThidKillQuestHib20Quest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			ThidKillQuestHib20Quest quest = player.IsDoingQuest(typeof (ThidKillQuestHib20Quest)) as ThidKillQuestHib20Quest;
			...
			else if (e == GameLivingEvent.WhisperReceive)
			{
				...
				if (quest == null)
				{
					...
					{
						case "help me out":
							player.Out.SendQuestSubscribeCommand(PazzHib, QuestMgr.GetIDForQuestType(typeof(ThidKillQuestHib20Quest)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (ThidKillQuestHib20Quest)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(ThidKillQuestHib20Quest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!PazzHib.GiveQuest(typeof (ThidKillQuestHib20Quest), player, 1))
					return;
