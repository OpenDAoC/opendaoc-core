...
namespace DOL.GS.Quests.Hibernia
{
    public class WildWilderness : BaseQuest
    {
        ...
        private static DbItemTemplates _lungerTail = null;
        ...
        public WildWilderness(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest) { }
        ...
        public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            _lungerTail = GameServer.Database.FindObjectByKey<DbItemTemplates>("lunger_tail");
            if (_lungerTail == null)
            {
                _lungerTail = new DbItemTemplates();
        ...
        public override void FinishQuest()
        {
            ...
            m_questPlayer.AddMoney(MoneyUtil.GetMoney(0, 0, 0, 6, 0), "You receive {0} as a reward.");
