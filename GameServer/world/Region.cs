...
namespace DOL.GS
{
    ...
    public class Region
    {
        ...
        public virtual bool OnZonePoint(GamePlayer player, DbZonePoints zonePoint)
        {
            return true;
        }
        ...
        public virtual void LoadFromDatabase(DbMobs[] mobObjs, ref long mobCount, ref long merchantCount, ref long itemCount, ref long bindCount)
        {
            if (!LoadObjects)
                return;
            ...
            foreach (DbBindPoints point in bindPoints)
            {
