...
{
    public class EventBuffMerchant : GameMerchant
    {
#region BuffMerchant attrib/spells/casting
        ...
        // removing annoying quest indicator
        ...
        public override bool Interact(GamePlayer player)
        {
            ...
            TurnTo(player, 10000);
            player.Out.SendMessage("Greetings, " + player.Name + ".\n The server staff have instructed me to strengthen you so that you may defend the lands with valor. Simply hand me the token for the enhancement you desire, and I will empower you accordingly.", EChatType.CT_Say, EChatLoc.CL_PopupWindow);
