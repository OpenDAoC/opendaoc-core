...
namespace DOL.GS.Spells
{
    ...
    public class SummonSiegeTrebuchetHandler : SpellHandler
    {
	    public SummonSiegeTrebuchetHandler(GameLiving caster, Spell spell, SpellLine line)
        ...
        public override bool StartSpell(GameLiving target)
        {
			...
			foreach (GameNpc npc in Caster.CurrentRegion.GetNPCsInRadius(Caster.X, Caster.Y, Caster.Z, (ushort)trebSummonRadius, false))
			{
