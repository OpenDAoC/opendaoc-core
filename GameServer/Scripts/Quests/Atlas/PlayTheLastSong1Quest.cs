...
{
	public class PlayTheLastSong1Quest : BaseQuest
	{
		/// <summary>
		...
		// Constructors
		public PlayTheLastSong1Quest() : base()
		{
		}

		public PlayTheLastSong1Quest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public PlayTheLastSong1Quest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public PlayTheLastSong1Quest(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (graveCheck.Count == 0)
			{
				...
				if (SAVE_INTO_DATABASE)
				{
					...
					PlayTheLastSong1Quest.FreeyasGrave = FreeyasGrave;
				}
			...
			VikingDextz.AddQuestToGive(typeof (PlayTheLastSong1Quest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			VikingDextz.RemoveQuestToGive(typeof (PlayTheLastSong1Quest));
		}
		...
		protected static void TalkToVikingDextz(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(VikingDextz.CanGiveQuest(typeof (PlayTheLastSong1Quest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			PlayTheLastSong1Quest quest = player.IsDoingQuest(typeof (PlayTheLastSong1Quest)) as PlayTheLastSong1Quest;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "support Thor Boyaux":
							player.Out.SendQuestSubscribeCommand(VikingDextz, QuestMgr.GetIDForQuestType(typeof(PlayTheLastSong1Quest)), "Will you help Viking Dextz ([Memorial] Play the last Song)?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (PlayTheLastSong1Quest)) != null)
				return true;
		...
		protected static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(PlayTheLastSong1Quest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!VikingDextz.GiveQuest(typeof (PlayTheLastSong1Quest), player, 1))
					return;
			}
			VikingDextz.Interact(player);
		}
		...
		public override void Notify(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (player==null || player.IsDoingQuest(typeof (PlayTheLastSong1Quest)) == null)
				return;
		...
		public class PlayTheLastSongTitle : EventPlayerTitle 
		{
	        ...
	        {
		        return player.HasFinishedQuest(typeof(PlayTheLastSong1Quest)) == 1;
	        }
