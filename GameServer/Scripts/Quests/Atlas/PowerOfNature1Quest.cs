...
{
    public class PowerOfNature1Quest : BaseQuest
    {
        /// <summary>
        ...
        // Constructors
        public PowerOfNature1Quest() : base()
        {
        }

        public PowerOfNature1Quest(GamePlayer questingPlayer) : base(questingPlayer)
        {
        }

        public PowerOfNature1Quest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
        {
        }

        public PowerOfNature1Quest(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
        {
        }
        ...
        public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            Theresa.AddQuestToGive(typeof(PowerOfNature1Quest));
        ...
        public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            Theresa.RemoveQuestToGive(typeof(PowerOfNature1Quest));
        }
        ...
        protected static void TalkToTheresa(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (Theresa.CanGiveQuest(typeof(PowerOfNature1Quest), player) <= 0)
                return;

            //We also check if the player is already doing the quest
            PowerOfNature1Quest quest = player.IsDoingQuest(typeof(PowerOfNature1Quest)) as PowerOfNature1Quest;
                    ...
                    switch (wArgs.Text)
                    {
                        case "help me":
                            player.Out.SendQuestSubscribeCommand(Theresa,
                                QuestMgr.GetIDForQuestType(typeof(PowerOfNature1Quest)),
        ...
        public override bool CheckQuestQualification(GamePlayer player)
        {
            ...
            if (player.IsDoingQuest(typeof(PowerOfNature1Quest)) != null)
                return true;
        ...
        protected static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(PowerOfNature1Quest)))
                return;
        ...
        private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
        {
            ...
            else
            {
                ...
                if (!Theresa.GiveQuest(typeof(PowerOfNature1Quest), player, 1))
                    return;
        ...
        public override void Notify(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (player == null || player.IsDoingQuest(typeof(PowerOfNature1Quest)) == null)
                return;
        }
        ...
        public class PowerOfNatureTitle : EventPlayerTitle
        {
            ...
            {
                return player.HasFinishedQuest(typeof(PowerOfNature1Quest)) == 1;
            }
