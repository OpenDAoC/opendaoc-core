...
namespace DOL.GS
{
	public class LaunchAlb1Quest : Quests.BaseQuest
	{
		/// <summary>
		...
		// Constructors
		public LaunchAlb1Quest() : base()
		{
		}

		public LaunchAlb1Quest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public LaunchAlb1Quest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public LaunchAlb1Quest(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyAlb.AddQuestToGive(typeof (LaunchAlb1Quest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyAlb.RemoveQuestToGive(typeof (LaunchAlb1Quest));
		}
		...
		protected static void TalkToRey(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(ReyAlb.CanGiveQuest(typeof (LaunchAlb1Quest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			LaunchAlb1Quest quest = player.IsDoingQuest(typeof (LaunchAlb1Quest)) as LaunchAlb1Quest;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "causing some mayhem":
							player.Out.SendQuestSubscribeCommand(ReyAlb, QuestMgr.GetIDForQuestType(typeof(LaunchAlb1Quest)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (LaunchAlb1Quest)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(LaunchAlb1Quest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!ReyAlb.GiveQuest(typeof (LaunchAlb1Quest), player, 1))
					return;
