...
namespace DOL.GS
{
	public class LaunchHib1Quest : Quests.BaseQuest
	{
		/// <summary>
		...
		// Constructors
		public LaunchHib1Quest() : base()
		{
		}

		public LaunchHib1Quest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public LaunchHib1Quest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public LaunchHib1Quest(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyHib.AddQuestToGive(typeof (LaunchHib1Quest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyHib.RemoveQuestToGive(typeof (LaunchHib1Quest));
		}
		...
		protected static void TalkToRey(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(ReyHib.CanGiveQuest(typeof (LaunchHib1Quest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			LaunchHib1Quest quest = player.IsDoingQuest(typeof (LaunchHib1Quest)) as LaunchHib1Quest;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "causing some mayhem":
							player.Out.SendQuestSubscribeCommand(ReyHib, QuestMgr.GetIDForQuestType(typeof(LaunchHib1Quest)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (LaunchHib1Quest)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(LaunchHib1Quest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!ReyHib.GiveQuest(typeof (LaunchHib1Quest), player, 1))
					return;
