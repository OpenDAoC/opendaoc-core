...
namespace DOL.GS
{
	public class LaunchMid1Quest : Quests.BaseQuest
	{
		/// <summary>
		...
		// Constructors
		public LaunchMid1Quest() : base()
		{
		}

		public LaunchMid1Quest(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public LaunchMid1Quest(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public LaunchMid1Quest(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyMid.AddQuestToGive(typeof (LaunchMid1Quest));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			ReyMid.RemoveQuestToGive(typeof (LaunchMid1Quest));
		}
		...
		protected static void TalkToRey(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(ReyMid.CanGiveQuest(typeof (LaunchMid1Quest), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			LaunchMid1Quest quest = player.IsDoingQuest(typeof (LaunchMid1Quest)) as LaunchMid1Quest;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "causing some mayhem":
							player.Out.SendQuestSubscribeCommand(ReyMid, QuestMgr.GetIDForQuestType(typeof(LaunchMid1Quest)), "Will you undertake " + questTitle + "?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (LaunchMid1Quest)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(LaunchMid1Quest)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!ReyMid.GiveQuest(typeof (LaunchMid1Quest), player, 1))
					return;
