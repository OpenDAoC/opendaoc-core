...
{
	public class BeetlePve50QuestMid : Quests.AtlasQuest
	{
		/// <summary>
		...
		// Constructors
		public BeetlePve50QuestMid() : base()
		{
		}

		public BeetlePve50QuestMid(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public BeetlePve50QuestMid(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public BeetlePve50QuestMid(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Rengahr.AddQuestToGive(typeof (BeetlePve50QuestMid));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Rengahr.RemoveQuestToGive(typeof (BeetlePve50QuestMid));
		}
		...
		private static void TalkToRengahr(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Rengahr.CanGiveQuest(typeof (BeetlePve50QuestMid), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			BeetlePve50QuestMid quest = player.IsDoingQuest(typeof (BeetlePve50QuestMid)) as BeetlePve50QuestMid;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "help the beetles":
							player.Out.SendQuestSubscribeCommand(Rengahr, QuestMgr.GetIDForQuestType(typeof(BeetlePve50QuestMid)), "Will you help Rengahr "+questTitle+"?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (BeetlePve50QuestMid)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(BeetlePve50QuestMid)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Rengahr.GiveQuest(typeof (BeetlePve50QuestMid), player, 1))
					return;
