...
{
	public class BeetleRvr50QuestHib : Quests.AtlasQuest
	{
		/// <summary>
		...
		// Constructors
		public BeetleRvr50QuestHib() : base()
		{
		}

		public BeetleRvr50QuestHib(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public BeetleRvr50QuestHib(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public BeetleRvr50QuestHib(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Harris.AddQuestToGive(typeof (BeetleRvr50QuestHib));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Harris.RemoveQuestToGive(typeof (BeetleRvr50QuestHib));
		}
		...
		private static void TalkToHarris(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Harris.CanGiveQuest(typeof (BeetleRvr50QuestHib), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			BeetleRvr50QuestHib quest = player.IsDoingQuest(typeof (BeetleRvr50QuestHib)) as BeetleRvr50QuestHib;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "help Hibernia and the beetles":
							player.Out.SendQuestSubscribeCommand(Harris, QuestMgr.GetIDForQuestType(typeof(BeetleRvr50QuestHib)), "Will you help Harris "+questTitle+"?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (BeetleRvr50QuestHib)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(BeetleRvr50QuestHib)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Harris.GiveQuest(typeof (BeetleRvr50QuestHib), player, 1))
					return;
