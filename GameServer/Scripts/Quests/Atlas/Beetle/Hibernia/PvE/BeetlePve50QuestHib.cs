...
{
	public class BeetlePve50QuestHib : Quests.AtlasQuest
	{
		/// <summary>
		...
		// Constructors
		public BeetlePve50QuestHib() : base()
		{
		}

		public BeetlePve50QuestHib(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public BeetlePve50QuestHib(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public BeetlePve50QuestHib(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Harris.AddQuestToGive(typeof (BeetlePve50QuestHib));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Harris.RemoveQuestToGive(typeof (BeetlePve50QuestHib));
		}
		...
		private static void TalkToHarris(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Harris.CanGiveQuest(typeof (BeetlePve50QuestHib), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			BeetlePve50QuestHib quest = player.IsDoingQuest(typeof (BeetlePve50QuestHib)) as BeetlePve50QuestHib;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "help the beetles":
							player.Out.SendQuestSubscribeCommand(Harris, QuestMgr.GetIDForQuestType(typeof(BeetlePve50QuestHib)), "Will you help Harris "+questTitle+"?");
							break;
					}
				}
				else
		...
		public override bool CheckQuestQualification(GamePlayer player)
		{
			...
			if (player.IsDoingQuest(typeof (BeetlePve50QuestHib)) != null)
				return true;
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(BeetlePve50QuestHib)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Harris.GiveQuest(typeof (BeetlePve50QuestHib), player, 1))
					return;
