...
{
	public class BeetlePve50QuestAlb : Quests.AtlasQuest
	{
		/// <summary>
		...
		// Constructors
		public BeetlePve50QuestAlb() : base()
		{
		}

		public BeetlePve50QuestAlb(GamePlayer questingPlayer) : base(questingPlayer)
		{
		}

		public BeetlePve50QuestAlb(GamePlayer questingPlayer, int step) : base(questingPlayer, step)
		{
		}

		public BeetlePve50QuestAlb(GamePlayer questingPlayer, DbQuests dbQuest) : base(questingPlayer, dbQuest)
		{
		}
		...
		public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Laura.AddQuestToGive(typeof (BeetlePve50QuestAlb));
		...
		public static void ScriptUnloaded(CoreEvent e, object sender, EventArgs args)
		{
			...
			Laura.RemoveQuestToGive(typeof (BeetlePve50QuestAlb));
		}
		...
		private static void TalkToLaura(CoreEvent e, object sender, EventArgs args)
		{
			...
			if(Laura.CanGiveQuest(typeof (BeetlePve50QuestAlb), player)  <= 0)
				return;

			//We also check if the player is already doing the quest
			BeetlePve50QuestAlb quest = player.IsDoingQuest(typeof (BeetlePve50QuestAlb)) as BeetlePve50QuestAlb;
				...
				if (quest == null)
				{
					switch (wArgs.Text)
					{
						case "help the beetles":
							player.Out.SendQuestSubscribeCommand(Laura, QuestMgr.GetIDForQuestType(typeof(BeetlePve50QuestAlb)), "Will you help Laura "+questTitle+"?");
							break;
					}
				}
				else
		...
		private static void SubscribeQuest(CoreEvent e, object sender, EventArgs args)
		{
			...
			if (qargs.QuestID != QuestMgr.GetIDForQuestType(typeof(BeetlePve50QuestAlb)))
				return;
		...
		private static void CheckPlayerAcceptQuest(GamePlayer player, byte response)
		{
			...
			else
			{
				...
				if (!Laura.GiveQuest(typeof (BeetlePve50QuestAlb), player, 1))
					return;
