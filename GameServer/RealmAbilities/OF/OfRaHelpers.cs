namespace DOL.GS.RealmAbilities
{
    public static class OfRaHelpers
    {
        ...
        {
            OfRaDexterityEnhancerHandler augDex = player.GetAbility<OfRaDexterityEnhancerHandler>();
            if (augDex == null)
                return 0;
        ...
        {
            OfRaStrengthEnhancerHandler augStr = player.GetAbility<OfRaStrengthEnhancerHandler>();
            if (augStr == null)
                return 0;
        ...
        {
            OfRaConstitutionEnhancerHandler augCon = player.GetAbility<OfRaConstitutionEnhancerHandler>();
            if (augCon == null)
                return 0;
        ...
        {
            OfRaAcuityEnhancerHandler augAcuity = player.GetAbility<OfRaAcuityEnhancerHandler>();
        ...
        {
            OfRaQuicknessEnhancerHandler augQui = player.GetAbility<OfRaQuicknessEnhancerHandler>();
        ...
        {
            OfRaSerenityHandler raSerenity = player.GetAbility<OfRaSerenityHandler>();
        ...
        {
            OfRaFirstAidHandler raFirstAid = player.GetAbility<OfRaFirstAidHandler>();
        ...
        {
            OfRaLongshotHandler raLongshot = player.GetAbility<OfRaLongshotHandler>();
