...
public class OfRaBrilliantAuraHandler : TimedRealmAbility, ISpellCastingAbilityHandler
{
    public OfRaBrilliantAuraHandler(DbAbilities dba, int level) : base(dba, level) { }
