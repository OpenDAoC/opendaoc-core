...
{
    public class OfRaRuneOfDecimationHandler : TimedRealmAbility
    {
        public OfRaRuneOfDecimationHandler(DbAbilities dba, int level) : base(dba, level) { }
        ...
        public override void Execute(GameLiving living)
        {
            ...
            new OfRaRuneOfDecimationEcsEffect(new ECSGameEffectInitParams(trap, m_duration, 1, tmpHandler));
            DisableSkill(living);
        }
    }
}
