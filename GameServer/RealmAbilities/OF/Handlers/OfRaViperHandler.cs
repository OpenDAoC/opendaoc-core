...
namespace DOL.GS.RealmAbilities
{
    ...
    public class OfRaViperHandler : TimedRealmAbility
    {
        public OfRaViperHandler(DbAbilities dba, int level) : base(dba, level) { }
        ...
        public override void Execute(GameLiving living)
        {
            ...
            new OfRaViperEcsEffect(new ECSGameEffectInitParams(player, m_duration, 1, CreateSpell(living)));
        }
