...
{
    public class OfRaPerfectRecoveryHandler : TimedRealmAbility, ISpellCastingAbilityHandler
    {
        public OfRaPerfectRecoveryHandler(DbAbilities dba, int level) : base(dba, level) { }
