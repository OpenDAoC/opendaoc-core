...
{
    public class OfRaPurgeHandler : NfRaPurgeHandler
    {
        public OfRaPurgeHandler(DbAbilities dba, int level) : base(dba, level) { }
    ...
    /// </summary>
    public class OfRaPurgeReducedHandler : OfRaPurgeHandler
    {
        public OfRaPurgeReducedHandler(DbAbilities dba, int level) : base(dba, level) { }
    ...
    /// </summary>
    public class OfRaGroupPurgeHandler : OfRaPurgeHandler
    {
        public OfRaGroupPurgeHandler(DbAbilities dba, int level) : base(dba, level) { }
