...
namespace DOL.GS.RealmAbilities
{
    ...
    public class OfRaVanishHandler : TimedRealmAbility
    {
        public OfRaVanishHandler(DbAbilities dba, int level) : base(dba, level) { }
        ...
        public override void Execute(GameLiving living)
        {
            ...
            new OfRaVanishEcsEffect(new ECSGameEffectInitParams(player, m_duration, 1, CreateSpell(living)));
        }
