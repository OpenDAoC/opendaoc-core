...
namespace DOL.GS.RealmAbilities
{
    ...
    public class OfRaBatteryOfLifeHandler : TimedRealmAbility
    {
        public OfRaBatteryOfLifeHandler(DbAbilities dba, int level) : base(dba, level) { }
        ...
        public override void Execute(GameLiving living)
        {
            ...
            new OfRaBatteryOfLifeEcsEffect(new ECSGameEffectInitParams(player, m_duration, 1, CreateSpell(player)));
        }
