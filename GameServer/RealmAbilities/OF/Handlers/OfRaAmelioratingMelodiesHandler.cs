...
namespace DOL.GS.RealmAbilities
{
	...
	/// </summary>
	public class OfRaAmelioratingMelodiesHandler : NfRaAmelioratingMelodiesHandler
	{
		public OfRaAmelioratingMelodiesHandler(DbAbilities dba, int level) : base(dba, level) { }
