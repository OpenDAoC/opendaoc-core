...
namespace DOL.GS.RealmAbilities
{
    ...
    public class OfRaStrikingTheSoulHandler : TimedRealmAbility
    {
		public OfRaStrikingTheSoulHandler(DbAbilities dba, int level) : base(dba, level) { }
		...
		public override void Execute(GameLiving living)
		{
			...
			new OfRaStrikingTheSoulEcsEffect(new ECSGameEffectInitParams(player, m_duration, m_value));
