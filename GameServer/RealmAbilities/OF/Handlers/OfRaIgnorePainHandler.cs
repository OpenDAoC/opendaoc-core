...
namespace DOL.GS.RealmAbilities
{
	...
	/// </summary>
	public class OfRaIgnorePainHandler : TimedRealmAbility
	{
		public OfRaIgnorePainHandler(DbAbilities dba, int level) : base(dba, level) { }
	...
	public class OfRaIgnorePainHandlerTank : OfRaIgnorePainHandler
	{
		public OfRaIgnorePainHandlerTank(DbAbilities dba, int level) : base(dba, level) { }
