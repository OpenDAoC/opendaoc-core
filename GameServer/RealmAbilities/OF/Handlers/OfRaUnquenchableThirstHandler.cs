...
{
    public class OfRaUnquenchableThirstHandler : TimedRealmAbility, ISpellCastingAbilityHandler
    {
        public OfRaUnquenchableThirstHandler(DbAbilities dba, int level) : base(dba, level) { }
