...
{
    public class OfRaCorporealDisintegrationHandler : TimedRealmAbility, ISpellCastingAbilityHandler
    {
        public OfRaCorporealDisintegrationHandler(DbAbilities dba, int level) : base(dba, level) { }
