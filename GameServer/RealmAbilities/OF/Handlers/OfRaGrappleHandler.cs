...
{
	public class OfRaGrappleHandler : TimedRealmAbility, ISpellCastingAbilityHandler
    {
		public OfRaGrappleHandler(DbAbilities dba, int level) : base(dba, level) { }
		...
		public override bool CheckRequirement(GamePlayer player) { return player.HasAbilityType(typeof(OfRaTripHandler));}
