...
{
    public class OfRaVolcanicPillarHandler : TimedRealmAbility, ISpellCastingAbilityHandler
    {
        public OfRaVolcanicPillarHandler(DbAbilities dba, int level) : base(dba, level) { }
