...
{
    public class OfRaWrathOfTheChampionHandler : TimedRealmAbility, ISpellCastingAbilityHandler
    {
        public OfRaWrathOfTheChampionHandler(DbAbilities dba, int level) : base(dba, level) { }
