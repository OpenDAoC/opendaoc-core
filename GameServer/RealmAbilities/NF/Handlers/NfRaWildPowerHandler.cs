...
namespace DOL.GS.RealmAbilities
{
	...
	/// </summary>
	public class NfRaWildPowerHandler : RaPropertyEnhancer
	{

		public NfRaWildPowerHandler(DbAbilities dba, int level)
	...
	/// </summary>
	public class NfRaMasteryOfMageryHandler : RaPropertyEnhancer
	{
		public NfRaMasteryOfMageryHandler(DbAbilities dba, int level)
	...
	/// </summary>
	public class WildHealingHandler : RaPropertyEnhancer
	{
		public WildHealingHandler(DbAbilities dba, int level)
	...
	/// </summary>
	public class MasteryOfHealingHandler : RaPropertyEnhancer
	{
		public MasteryOfHealingHandler(DbAbilities dba, int level)
	...
	/// </summary>
	public class MasteryOfFocusHandler : RaPropertyEnhancer
	{
		public MasteryOfFocusHandler(DbAbilities dba, int level) : base(dba, level, EProperty.SpellLevel) { }
