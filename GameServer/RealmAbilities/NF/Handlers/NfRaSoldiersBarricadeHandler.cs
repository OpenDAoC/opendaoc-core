...
namespace DOL.GS.RealmAbilities
{
	...
	public class NfRaSoldiersBarricadeHandler : TimedRealmAbility
	{
		public NfRaSoldiersBarricadeHandler(DbAbilities dba, int level) : base(dba, level) { }
...
// 			}
			...
			foreach (GamePlayer target in targets)
			{
				...
				if (success)
					if (target != null)
					{
						new OfRaSoldiersBarricadeEcsEffect(new ECSGameEffectInitParams(target, m_duration, m_value));
					}
			}
