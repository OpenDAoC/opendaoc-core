...
{
	public class NfRaBarrierOfFortitudeHandler : TimedRealmAbility
	{
		public NfRaBarrierOfFortitudeHandler(DbAbilities dba, int level) : base(dba, level) { }
		...
		public override void Execute(GameLiving living)
		{
			...
			foreach (GamePlayer playerInGroup in playersInGroup)
			{
				...
				if (success)
					new OfRaBunkerOfFaithEcsEffect(new ECSGameEffectInitParams(playerInGroup, m_duration, GetAbsorbAmount(), CreateSpell(player)));
			}
