...
namespace DOL.GS.RealmAbilities
{
    ...
    /// </summary>
    public class NfRaPurgeHandler : TimedRealmAbility
    {
        public NfRaPurgeHandler(DbAbilities dba, int level) : base(dba, level) { }
        ...
        protected static bool RemoveNegativeEffects(GameLiving living, NfRaPurgeHandler purge, bool isFromGroupPurge = false)
        {
            bool removed = false;
        ...
        {
            GameLiving m_caster;
            NfRaPurgeHandler m_purge;
            int counter;

            public PurgeTimer(GameLiving caster, NfRaPurgeHandler purge, int count) : base(caster)
            {
                m_caster = caster;
                m_purge = purge;
                counter = count;
