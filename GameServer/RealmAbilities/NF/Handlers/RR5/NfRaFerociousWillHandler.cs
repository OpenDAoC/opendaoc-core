...
namespace DOL.GS.RealmAbilities
{
	...
	/// </summary>
	public class NfRaFerociousWillHandler : Rr5RealmAbility
	{
		public NfRaFerociousWillHandler(DbAbilities dba, int level) : base(dba, level) { }
		...
		public override void Execute(GameLiving living)
		{
			...
			if (player != null)
			{
				...
				NfRaFerociousWillEffect effect = new NfRaFerociousWillEffect();
				effect.Start(player);
			}
			DisableSkill(living);
		}
