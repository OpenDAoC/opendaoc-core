...
namespace DOL.GS.Spells
{
    ...
    public class NfRaChainBoltHandler : BoltHandler
    {
        public NfRaChainBoltHandler(GameLiving caster, Spell spell, SpellLine spellLine) : base(caster, spell, spellLine) { }
