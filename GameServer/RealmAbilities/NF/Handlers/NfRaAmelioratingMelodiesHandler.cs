...
namespace DOL.GS.RealmAbilities
{
	...
	/// </summary>
	public class NfRaAmelioratingMelodiesHandler : TimedRealmAbility
	{
		...
		/// </summary>
		public NfRaAmelioratingMelodiesHandler(DbAbilities dba, int level) : base(dba, level) { }
		...
		public override void Execute(GameLiving living)
		{
			...
			new OfRaAmelioratingMelodiesEcsEffect(new ECSGameEffectInitParams(player, 30000, heal));
