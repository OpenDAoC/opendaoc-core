...
namespace DOL.GS.Effects
{
	...
	/// </summary>
	public class XNfRaSoldiersBarricadeEffect : StaticEffect, IGameEffect
	{
		...
		/// </summary>
		public XNfRaSoldiersBarricadeEffect()
		{
		...
		private static void PlayerLeftWorld(CoreEvent e, object sender, EventArgs args)
		{
			...
			XNfRaSoldiersBarricadeEffect SBEffect = player.EffectList.GetOfType<XNfRaSoldiersBarricadeEffect>();
			if (SBEffect != null)
			{
