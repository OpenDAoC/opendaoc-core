...
namespace DOL.GS.RealmAbilities
{
	...
	public class NfRaBedazzlingAuraEffect : TimedEffect, IGameEffect
	{
		...
		public void Start(GameLiving living, int value)
		{
			...
			if (living.TempProperties.getProperty(RealmAbilities.NfRaBarrierOfFortitudeHandler.BofBaSb, false))
				return;
			...
			living.TempProperties.setProperty(RealmAbilities.NfRaBarrierOfFortitudeHandler.BofBaSb, true);
		}
		...
		public override void Stop()
		{
			...
			m_owner.TempProperties.removeProperty(RealmAbilities.NfRaBarrierOfFortitudeHandler.BofBaSb);
		}
