...
namespace DOL.GS.Effects
{
    ...
    public class NfRaBloodDrinkingEffect : TimedEffect
    {
        ...
        public NfRaBloodDrinkingEffect()
            : base(RealmAbilities.NfRaBloodDrinkingHandler.DURATION)
        { }
        ...
        public override void Start(GameLiving target)
        {
            ...
            if (target is GamePlayer)
            {
                ...
                {
                    p.Out.SendSpellEffectAnimation(EffectOwner, EffectOwner, NfRaBloodDrinkingHandler.EFFECT, 0, false, 1);
                }
        ...
        protected void OnAttack(CoreEvent e, object sender, EventArgs arguments)
        {
            ...
            double healPercent = NfRaBloodDrinkingHandler.HEALPERCENT;
