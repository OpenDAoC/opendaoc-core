...
namespace DOL.GS.Effects
{
    ...
    public class NfRaBoilingCauldronEffect : TimedEffect
    {
        ...
        public NfRaBoilingCauldronEffect()
            : base(RealmAbilities.NfRaBoilingCauldronHandler.DURATION)
        { }
        ...
        private void SummonCauldron()
        {
            ...
            new ECSGameTimer(EffectOwner, new ECSGameTimer.ECSTimerCallback(CauldronCallBack), RealmAbilities.NfRaBoilingCauldronHandler.DURATION - 1000);
        }
