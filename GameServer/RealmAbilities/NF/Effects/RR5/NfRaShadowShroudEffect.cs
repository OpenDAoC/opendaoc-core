...
namespace DOL.GS.Effects
{
    ...
    public class NfRaShadowShroudEffect : TimedEffect
    {
        ...
        public NfRaShadowShroudEffect()
            : base(RealmAbilities.NfRaShadowShroudHandler.DURATION)
        { }
        ...
        public override void Start(GameLiving target)
        {
            ...
            if (target is GamePlayer)
            {
                ...
                {
                    p.Out.SendSpellEffectAnimation(EffectOwner, EffectOwner, NfRaShadowShroudHandler.EFFECT, 0, false, 1);
                }

                EffectOwner.AbilityBonus[(int)EProperty.MissHit] += NfRaShadowShroudHandler.MISSHITBONUS;
        ...
        protected void OnAttack(CoreEvent e, object sender, EventArgs arguments)
        {
            ...
            double absorbPercent = NfRaShadowShroudHandler.ABSPERCENT;
