    ...
    public class NfRaMinionRescueEffect : TimedEffect
    {
        ...
        public override void Start(GameLiving target)
        {
            ...
            if (target is GamePlayer)
            {
                ...
                int targetCount = 0;
                foreach (GamePlayer targetPlayer in EffectOwner.GetPlayersInRadius((ushort)RealmAbilities.NfRaMinionRescueHandler.SpellRadius))
                {
        ...
        private void SummonSpirit(int spiritId, GamePlayer targetPlayer)
        {
            ...
            spirits[spiritId].Follow(targetPlayer, 0, RealmAbilities.NfRaMinionRescueHandler.SpellRadius + 100);
