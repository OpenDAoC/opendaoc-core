...
namespace DOL.GS.RealmAbilities
{
	...
	/// 
	/// </summary>
	public class NfRaDivineInterventionEffect : TimedEffect, IGameEffect
	{
		public NfRaDivineInterventionEffect(int value)
			: base(NfRaDivineInterventionHandler.poolDuration)
		{
			PoolValue = value;
		}
		...
		public override void Stop()
		{
			...
			if (m_group != null)
			{
				GameEventMgr.RemoveHandler(m_group, PlayerGroupEvent.MemberDisbanded, new CoreEventHandler(PlayerDisbandedGroup));
				GameEventMgr.RemoveHandler(m_group, PlayerGroupEvent.MemberJoined, new CoreEventHandler(PlayerJoinedGroup));
			}
