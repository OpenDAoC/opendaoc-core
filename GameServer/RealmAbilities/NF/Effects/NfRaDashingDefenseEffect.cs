...
namespace DOL.GS.Effects
{
    ...
    public class NfRaDashingDefenseEffect : StaticEffect, IGameEffect
    {
        ...
        public void Start(GamePlayer guardSource, GamePlayer guardTarget, int duration)
        {
            ...
            guardTarget.TempProperties.setProperty(RealmAbilities.NfRaDashingDefenseHandler.Dashing, true);
        }
        ...
        public override void Cancel(bool playerCancel)
        {
            ...
            m_guardTarget.TempProperties.removeProperty(RealmAbilities.NfRaDashingDefenseHandler.Dashing);
