...
namespace DOL.GS
{
	...
	public class GameStaticRelic : GameStaticItem
	{
		...
		#region constructor
		public GameStaticRelic() : base() { m_saveInDB = true; }


		public GameStaticRelic(DbRelics obj)
			: this()
		{
		...
		public override void LoadFromDatabase(DataObject obj)
		{
			...
			DbItemTemplates m_itemTemp;
			m_itemTemp = new DbItemTemplates();
