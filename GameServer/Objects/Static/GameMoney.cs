namespace DOL.GS
{
	...
	public class GameMoney: GameStaticItemTimed
	{
		...
		public int Mithril
		{
			get
			{
				return MoneyUtil.GetMithril(m_copperValue);
			}
		}
		...
		public int Platinum
		{
			get
			{
				return MoneyUtil.GetPlatinum(m_copperValue);
			}
		}
		...
		public int Gold
		{
			get
			{
				return MoneyUtil.GetGold(m_copperValue);
			}
		}
		...
		public int Silver
		{
			get
			{
				return MoneyUtil.GetSilver(m_copperValue);
			}
		}
		...
		public int Copper
		{
			get
			{
				return MoneyUtil.GetCopper(m_copperValue);
			}
		}
