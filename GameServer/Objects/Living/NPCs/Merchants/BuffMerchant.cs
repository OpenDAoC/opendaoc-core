...
namespace DOL.GS.Items
{
	...
	public class BPBuffTokens
	{
		...
		public static void OnServerStartup(CoreEvent e, object sender, EventArgs args)
		{
			...
			item = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("BPFull_Buffs_Token");
			if (item == null)
			{
				item = new DbItemTemplates();
			...
			item = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("BPSpecialization_Buffs_Token");
			if (item == null)
			{
				item = new DbItemTemplates();
			...
			item = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("BPBaseline_Buffs_Token");
			if (item == null)
			{
				item = new DbItemTemplates();
			...
			item = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("BPStrength_Buff_Token");
			if (item == null)
			{
				item = new DbItemTemplates();
			...
			item = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("BPFortification_Buff_Token");
			if (item == null)
			{
				item = new DbItemTemplates();
			...
			item = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("BPDexterity_Buff_Token");
			if (item == null)
			{
				item = new DbItemTemplates();
			...
			item = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("BPArmor_Buff_Token");
			if (item == null)
			{
				item = new DbItemTemplates();
			...
			item = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("BPStrCon_Buff_Token");
			if (item == null)
			{
				item = new DbItemTemplates();
			...
			item = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("BPDexQui_Buff_Token");
			if (item == null)
			{
				item = new DbItemTemplates();
			...
			item = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("BPAcu_Buff_Token");
			if (item == null)
			{
				item = new DbItemTemplates();
			...
			item = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("BPSpecAF_Buff_Token");
			if (item == null)
			{
				item = new DbItemTemplates();
			...
			item = (DbItemTemplates)GameServer.Database.FindObjectByKey<DbItemTemplates>("BPHaste_Buff_Token");
			if (item == null)
			{
				item = new DbItemTemplates();
