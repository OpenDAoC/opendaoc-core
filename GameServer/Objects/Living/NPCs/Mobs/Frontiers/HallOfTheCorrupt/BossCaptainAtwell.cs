...
namespace DOL.GS
{
    public class BossCaptainAtwell : GameEpicBoss
    {
        public BossCaptainAtwell() : base()
        {
        }
        ...
        public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (npcs.Length == 0)
            {
                ...
                BossCaptainAtwell HOC = new BossCaptainAtwell();
    ...
    public class CaptainAtwellBrain : StandardMobBrain
    {
        ...
        public override void Think()
        {
            ...
            if (Body.InCombat && HasAggro)
            {
                ...
                {
                    Body.styleComponent.NextCombatBackupStyle = BossCaptainAtwell.PoleAnytimer;
                    Body.styleComponent.NextCombatStyle = BossCaptainAtwell.AfterParry;
                }
            }
            base.Think();
        }
