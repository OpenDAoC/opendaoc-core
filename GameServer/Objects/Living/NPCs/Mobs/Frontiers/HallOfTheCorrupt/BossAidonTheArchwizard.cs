...
namespace DOL.GS
{
    public class BossAidonTheArchwizard : GameEpicBoss
    {
        public BossAidonTheArchwizard() : base()
        {
        }
        ...
        public override bool AddToWorld()
        {
            ...
            RespawnInterval =
                ServerProperties.ServerProperties.SET_EPIC_GAME_ENCOUNTER_RESPAWNINTERVAL * 60000; //1min is 60000 miliseconds
        ...
        public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (npcs.Length == 0)
            {
                ...
                BossAidonTheArchwizard HOC = new BossAidonTheArchwizard();
