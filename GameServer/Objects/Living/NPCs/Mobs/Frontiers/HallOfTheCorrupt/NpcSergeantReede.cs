...
namespace DOL.GS
{
    public class NpcSergeantReede : GameNpc
    {
        public NpcSergeantReede() : base()
        {
        }
        ...
        public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (npcs.Length == 0)
            {
                ...
                NpcSergeantReede HOC = new NpcSergeantReede();
        ...
        public override void Think()
        {
            ...
            if (Body.InCombat && HasAggro)
            {
                if (Body.TargetObject != null)
                {
                    ...
                    {
                        Body.styleComponent.NextCombatBackupStyle = NpcSergeantReede.Side;
                        Body.styleComponent.NextCombatStyle = NpcSergeantReede.SideFollowUp;
                    }
                    else
                    {
                        Body.styleComponent.NextCombatBackupStyle = NpcSergeantReede.Taunt;
                        Body.styleComponent.NextCombatStyle = NpcSergeantReede.AfterEvade;
                    }
