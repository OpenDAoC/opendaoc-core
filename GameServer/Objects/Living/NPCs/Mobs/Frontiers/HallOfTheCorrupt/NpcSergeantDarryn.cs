...
namespace DOL.GS
{
    public class NpcSergeantDarryn : GameNpc
    {
        public NpcSergeantDarryn() : base()
        {
        }
        ...
        public override void OnAttackedByEnemy(AttackData ad) // on Boss actions
        {
            ...
            {
                this.styleComponent.NextCombatBackupStyle = NpcSergeantDarryn.ParryFollowUp;
                this.styleComponent.NextCombatStyle = NpcSergeantDarryn.AfterParry;
            }
        ...
        public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (npcs.Length == 0)
            {
                ...
                NpcSergeantDarryn HOC = new NpcSergeantDarryn();
