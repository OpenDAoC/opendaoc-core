...
namespace DOL.GS
{
    public class BossCaptainBardalph : GameEpicBoss
    {
        public BossCaptainBardalph() : base()
        {
        }
        ...
        public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (npcs.Length == 0)
            {
                ...
                BossCaptainBardalph HOC = new BossCaptainBardalph();
    ...
    public class CaptainBardalphBrain : StandardMobBrain
    {
        ...
        public override void Think()
        {
            ...
            if (Body.InCombat && HasAggro)
            {
                ...
                {
                    Body.styleComponent.NextCombatBackupStyle = BossCaptainBardalph.Taunt;
                    Body.styleComponent.NextCombatStyle = BossCaptainBardalph.AfterEvade;
                }
            }
            base.Think();
        }
