...
namespace DOL.GS
{
    public class BossLadyDarra : GameEpicBoss
    {
        public BossLadyDarra() : base()
        {
        }
        ...
        public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (npcs.Length == 0)
            {
                ...
                BossLadyDarra HOC = new BossLadyDarra();
                HOC.Name = "Lady Darra";
                HOC.Model = 35;
                HOC.Realm = 0;
                HOC.Level = 68;
        ...
        public override void Think()
        {
            ...
            else if (Body.InCombatInLast(30 * 1000) == false && this.Body.InCombatInLast(35 * 1000))
            {
                ...
                if (reset_darra == false)
                {
                    ...
                    {
                        BossLadyDarra.spawn_palas = false;
                        ...
                        BossLadyDarra darra = new BossLadyDarra();
                        darra.SpawnPaladins();
