...
namespace DOL.GS
{
    public class BossChieftainCaimheul : GameEpicBoss
    {
        public BossChieftainCaimheul() : base()
        {
        }
        ...
        public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (npcs.Length == 0)
            {
                ...
                BossChieftainCaimheul HOC = new BossChieftainCaimheul();
    ...
    public class ChieftainCaimheulBrain : StandardMobBrain
    {
        ...
        public override void Think()
        {
            if (!CheckProximityAggro())
            {
                ...
                if (!Body.Styles.Contains(BossChieftainCaimheul.Taunt))
                    Body.Styles.Add(BossChieftainCaimheul.Taunt);
                if (!Body.Styles.Contains(BossChieftainCaimheul.slam))
                    Body.Styles.Add(BossChieftainCaimheul.slam); 
            }
                ...
                if (Body.TargetObject != null)
                {
                    ...
                    if (Phase2 == false)
                    {
                        if (!living.effectListComponent.ContainsEffectForEffectType(EEffect.Stun) && !living.effectListComponent.ContainsEffectForEffectType(EEffect.StunImmunity))
                        {
                            ...
                            Body.SwitchWeapon(EActiveWeaponSlot.Standard);
                            Body.VisibleActiveWeaponSlots = 16;
                            Body.styleComponent.NextCombatStyle = BossChieftainCaimheul.slam;//check if target has stun or immunity if not slam
                            Body.BlockChance = 50;
                            Body.ParryChance = 0;
                        ...
                        if ((angle >= 45 && angle < 150) || (angle >= 210 && angle < 315))//side
                        {
                            ...
                            Body.styleComponent.NextCombatBackupStyle = BossChieftainCaimheul.SideStyle;
                            Body.styleComponent.NextCombatStyle = BossChieftainCaimheul.SideFollowUp;
                        }
                        else if(!living.effectListComponent.ContainsEffectForEffectType(EEffect.Stun) && living.effectListComponent.ContainsEffectForEffectType(EEffect.StunImmunity))
                        {
                            ...
                            Body.SwitchWeapon(EActiveWeaponSlot.Standard);
                            Body.VisibleActiveWeaponSlots = 16;
                            Body.styleComponent.NextCombatStyle = BossChieftainCaimheul.Taunt;
                            Body.MeleeDamageType = EDamageType.Slash;
                            Body.BlockChance = 50;
                            Body.ParryChance = 0;
                        }
                    ...
                    if(Phase2)
                    {
                        ...
                        Body.ParryChance = 50;
                        if(Body.Styles.Contains(BossChieftainCaimheul.slam))
                            Body.Styles.Remove(BossChieftainCaimheul.slam);
                        if(Body.Styles.Contains(BossChieftainCaimheul.Taunt))
                            Body.Styles.Remove(BossChieftainCaimheul.Taunt);
                        Body.MeleeDamageType = EDamageType.Thrust;
                        ...
                        {
                            Body.styleComponent.NextCombatBackupStyle = BossChieftainCaimheul.taunt2h;
                            Body.styleComponent.NextCombatStyle = BossChieftainCaimheul.AfterParry;
                        }
                    }
                }
            }
