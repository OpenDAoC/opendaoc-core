...
namespace DOL.GS
{
    public class NpcBeliathanInit : GameNpc
    {
        public NpcBeliathanInit() : base()
        {
        }
        ...
        public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (npcs.Length == 0)
            {
                ...
                NpcBeliathanInit CO = new NpcBeliathanInit();
...
namespace DOL.AI.Brain
{
    public class BeliathanInitBrain : StandardMobBrain
    {
        ...
        public void SpawnBeliathan()
        {
            ...
            BossBeliathan Add = new BossBeliathan();
            Add.X = Body.X;
            Add.Y = Body.Y;
            Add.Z = Body.Z;
...
namespace DOL.GS
{
    public class BossBeliathan : GameEpicBoss
    {
        [ScriptLoadedEvent]
        public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
        {
