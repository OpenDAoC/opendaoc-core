...
namespace DOL.GS
{
    public class BossAroon : GameEpicBoss
    {
    ...
    public class AroonBrain : StandardMobBrain
    {
        ...
        public override void Think()
        {
            if (!CheckProximityAggro())
            {
                ...
                BossAroon.Aroon_slash = false;
                BossAroon.Aroon_thrust = false;
                BossAroon.Aroon_crush = false;
                BossAroon.Aroon_body = false;
                BossAroon.Aroon_cold = false;
                BossAroon.Aroon_energy = false;
                BossAroon.Aroon_heat = false;
                BossAroon.Aroon_matter = false;
                BossAroon.Aroon_spirit = false;
...
namespace DOL.AI.Brain
{
    public class SpioradScaithBrain : StandardMobBrain
    {
        ...
        public override void Think()
        {
            if(BossAroon.Aroon_slash && Message2==false)
            {
                BroadcastMessage(String.Format(Body.Name + " eyes are glowing, indicating he's being controlled by Aroon."));
                Message2 = true;
            }
...
namespace DOL.GS
{
    public class RopadhScaith : GameNpc //crush resist
    {
        ...
        public override void TakeDamage(GameObject source, EDamageType damageType, int damageAmount, int criticalAmount)
        {
            if (source is GamePlayer || source is GameSummonedPet)
            {
                if (BossAroon.Aroon_slash && BossAroon.Aroon_thrust)
                {
                    base.TakeDamage(source, damageType, damageAmount, criticalAmount);
                }
                else
...
namespace DOL.AI.Brain
{
    public class RopadhScaithBrain : StandardMobBrain
    {
        ...
        public override void Think()
        {
            if (BossAroon.Aroon_thrust && Message3 == false)
            {
                BroadcastMessage(String.Format(Body.Name + " eyes are glowing, indicating he's being controlled by Aroon."));
                Message3 = true;
            }
...
namespace DOL.GS
{
    public class DamhnaScaith : GameNpc //Body resist
    {
        ...
        public override void TakeDamage(GameObject source, EDamageType damageType, int damageAmount, int criticalAmount)
        {
            if (source is GamePlayer || source is GameSummonedPet)
            {
                if (BossAroon.Aroon_slash && BossAroon.Aroon_thrust && BossAroon.Aroon_crush)
                {
                    base.TakeDamage(source, damageType, damageAmount, criticalAmount);
                }
                else
...
namespace DOL.AI.Brain
{
    public class DamhnaScaithBrain : StandardMobBrain
    {
        ...
        public override void Think()
        {
            if (BossAroon.Aroon_crush && Message4 == false)
            {
                BroadcastMessage(String.Format(Body.Name + " eyes are glowing, indicating he's being controlled by Aroon."));
                Message4 = true;
            }
...
namespace DOL.AI.Brain
{
    public class FuinneamgScaithBrain : StandardMobBrain
    {
        ...
        public override void Think()
        {
            if (BossAroon.Aroon_body && Message5 == false)
            {
                BroadcastMessage(String.Format(Body.Name + " eyes are glowing, indicating he's being controlled by Aroon."));
                Message5 = true;
            }
...
namespace DOL.GS
{
    public class BruScaith : GameNpc //Energy resist
    {
        ...
        public override void TakeDamage(GameObject source, EDamageType damageType, int damageAmount, int criticalAmount)
        {
            ...
            {
                if (BossAroon.Aroon_slash && BossAroon.Aroon_thrust && BossAroon.Aroon_crush &&
                    BossAroon.Aroon_body && BossAroon.Aroon_cold)
                {
                    base.TakeDamage(source, damageType, damageAmount, criticalAmount);
                }
                else
...
namespace DOL.AI.Brain
{
    public class BruScaithBrain : StandardMobBrain
    {
        ...
        public override void Think()
        {
            if (BossAroon.Aroon_cold && Message6 == false)
            {
                BroadcastMessage(String.Format(Body.Name + " eyes are glowing, indicating he's being controlled by Aroon."));
                Message6 = true;
            }
...
namespace DOL.GS
{
    public class FuarScaith : GameNpc //Heat resist
    {
        ...
        public override void TakeDamage(GameObject source, EDamageType damageType, int damageAmount, int criticalAmount)
        {
            ...
            {
                if (BossAroon.Aroon_slash && BossAroon.Aroon_thrust && BossAroon.Aroon_crush &&
                    BossAroon.Aroon_body && BossAroon.Aroon_cold && BossAroon.Aroon_energy)
                {
                    base.TakeDamage(source, damageType, damageAmount, criticalAmount);
                }
                else
...
namespace DOL.AI.Brain
{
    public class FuarScaithBrain : StandardMobBrain
    {
        ...
        public override void Think()
        {
            if (BossAroon.Aroon_energy && Message7 == false)
            {
                BroadcastMessage(String.Format(Body.Name + " eyes are glowing, indicating he's being controlled by Aroon."));
                Message7 = true;
            }
...
namespace DOL.AI.Brain
{
    public class TaesScaithBrain : StandardMobBrain
    {
        ...
        public override void Think()
        {
            if (BossAroon.Aroon_heat && Message8 == false)
            {
                BroadcastMessage(String.Format(Body.Name + " eyes are glowing, indicating he's being controlled by Aroon."));
                Message8 = true;
            }
    ...
    public class ScorScaith : GameNpc //Spirit resist
    {
        ...
        public override void TakeDamage(GameObject source, EDamageType damageType, int damageAmount, int criticalAmount)
        {
            if (source is GamePlayer || source is GameSummonedPet)
            {
                if (BossAroon.Aroon_slash && BossAroon.Aroon_thrust && BossAroon.Aroon_crush &&
                    BossAroon.Aroon_body && BossAroon.Aroon_cold && BossAroon.Aroon_energy
                    && BossAroon.Aroon_heat && BossAroon.Aroon_matter)
                {
                    base.TakeDamage(source, damageType, damageAmount, criticalAmount);
                }
                else
...
namespace DOL.AI.Brain
{
    public class ScorScaithBrain : StandardMobBrain
    {
        ...
        public override void Think()
        {
            if (BossAroon.Aroon_heat && Message9 == false)
            {
                BroadcastMessage(String.Format(Body.Name + " eyes are glowing, indicating he's being controlled by Aroon."));
                Message9 = true;
            }
