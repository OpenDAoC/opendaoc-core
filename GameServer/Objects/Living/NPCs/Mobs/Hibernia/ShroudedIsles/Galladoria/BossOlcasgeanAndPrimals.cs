...
namespace DOL.AI.Brain
{
    public class OIBrain : StandardMobBrain
    {
        ...
        {
            BossAirPrimal Add = new BossAirPrimal();
            Add.X = 39713;
            Add.Y = 61264;
            Add.Z = 12372;
        ...
        {
            BossWaterPrimal Add = new BossWaterPrimal();
            Add.X = 39547;
            Add.Y = 62071;
            Add.Z = 11688;
            Add.CurrentRegion = Body.CurrentRegion;
        ...
        {
            BossFirePrimal Add = new BossFirePrimal();
            Add.X = 39481;
            Add.Y = 63240;
            Add.Z = 11699;
            Add.CurrentRegion = Body.CurrentRegion;
        ...
        public void SpawnEarth()
        {
            ...
            BossEarthPrimal Add = new BossEarthPrimal();
            Add.X = 39727;
            Add.Y = 62620;
            Add.Z = 11684;
            Add.CurrentRegion = Body.CurrentRegion;
...
namespace DOL.GS
{
    public class BossOlcasgean : GameEpicBoss
    {
        private static new readonly log4net.ILog log = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        public BossOlcasgean()
            : base()
        {
        }
        ...
        public override void Die(GameObject killer)
        {
            ...
            if (canReportNews)
            {
                if (killer is not BossOlcasgean or Olcasgean2)
                    ReportNews(killer);
            }
            base.Die(killer);
        }
    ...
    public class Olcasgean2 : GameEpicBoss
    {
        ...
        public override void TakeDamage(GameObject source, EDamageType damageType, int damageAmount, int criticalAmount)
        {
            ...
            foreach (GameNpc copy in GetNPCsInRadius(10000))
            {
                if (copy != null)
                {
                    if (copy is BossOlcasgean && copy.IsAlive)
                    {
                        copy.Health = Health;
                    }
                }
...
namespace DOL.GS
{
    public class BossAirPrimal : GameEpicBoss
    {
        private static new readonly log4net.ILog log = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public BossAirPrimal()
            : base()
        {
        }
        public override int GetResist(EDamageType damageType)
...
namespace DOL.GS
{
    public class BossWaterPrimal : GameEpicBoss
    {
        private static new readonly log4net.ILog log = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public BossWaterPrimal()
            : base()
        {
        }
        public override int GetResist(EDamageType damageType)
...
namespace DOL.GS
{
    public class BossFirePrimal : GameEpicBoss
    {
        private static new readonly log4net.ILog log = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public BossFirePrimal()
            : base()
        {
        }
        public override int GetResist(EDamageType damageType)
...
namespace DOL.GS
{
    public class BossEarthPrimal : GameEpicBoss
    {
        private static new readonly log4net.ILog log = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public BossEarthPrimal()
            : base()
        {
        }
        public override int GetResist(EDamageType damageType)
