...
namespace DOL.GS
{
	public class EpicDevelin : GameEpicNpc
	{
		public EpicDevelin() : base() { }
...
namespace DOL.AI.Brain
{
	public class DevelinBrain : StandardMobBrain
	{
		...
		{
			if (DevelinAdd.DevelinAddCount >= EpicDevelin.KillsRequireToSpawn && Body.CurrentRegion.IsNightTime)
			{
				if (changed)
				{
					Body.Flags = oldFlags;
