...
namespace DOL.GS
{
	public class BossSkeaghshee : GameEpicBoss
	{
		public BossSkeaghshee() : base() { }
	...
	public class SkeaghsheeBrain : StandardMobBrain
	{
		...
		public override void Think()
		{
			...
			if(Body.TargetObject != null && HasAggro)
            {
                ...
                {
					Body.styleComponent.NextCombatStyle = BossSkeaghshee.behind;//do backstyle when angle allow it
					Body.styleComponent.NextCombatBackupStyle = BossSkeaghshee.behindFollowUp;
				}
				else
                {
					Body.ParryChance = 15;
					Body.styleComponent.NextCombatStyle = BossSkeaghshee.afterParry;//do backstyle when angle allow it
					Body.styleComponent.NextCombatBackupStyle = BossSkeaghshee.taunt;
				}
			}
			base.Think();
		}
