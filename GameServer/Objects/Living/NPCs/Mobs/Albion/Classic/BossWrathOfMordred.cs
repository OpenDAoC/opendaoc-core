...
namespace DOL.GS
{
	public class BossWrathOfMordred : GameEpicBoss
	{
		public BossWrathOfMordred() : base() { }
		...
		public override void Think()
		{
			...
			if (Body.IsAlive && HasAggro)
			{
				if (Body.TargetObject != null)
				{
					...
					{
						Body.styleComponent.NextCombatBackupStyle = BossWrathOfMordred.Side2H;
						Body.styleComponent.NextCombatStyle = BossWrathOfMordred.SideFollowUP;
					}
