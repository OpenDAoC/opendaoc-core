...
{
    public class NpcMyling : GameNpc
    {
        
        public NpcMyling() : base() { }
        public NpcMyling(ABrain defaultBrain) : base(defaultBrain) { }
        public NpcMyling(INpcTemplate template) : base(template) { }
