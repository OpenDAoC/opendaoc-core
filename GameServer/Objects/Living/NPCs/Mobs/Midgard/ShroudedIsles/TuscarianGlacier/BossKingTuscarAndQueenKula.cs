...
namespace DOL.GS
{
    public class BossQueenKula : GameEpicBoss
    {
        public BossQueenKula() : base() { }
        ...
        {
            if(BossKingTuscar.KingTuscarCount > 0)
        ...
        public override void OnAttackedByEnemy(AttackData ad)// on Boss actions
        {
            ...
            {
                if(BossKingTuscar.KingTuscarCount == 0 || HealthPercent <= 50)
                {
    ...
    public class QueenKulaBrain : StandardMobBrain
    {
        ...
        public override void Think()
        {
            ...
            if (Body.TargetObject != null && HasAggro)
            {
                ...
                {
                    if (BossKingTuscar.KingTuscarCount == 1)
                    {
                    ...
                    else if(BossKingTuscar.KingTuscarCount == 0)
                    {
                ...
                if(Body.TargetObject != null)
                {
                    ...
                    if (BossKingTuscar.KingTuscarCount == 0 || Body.HealthPercent <= 50)
                    {
                        Body.Strength = 500;//king is dead so more dmg
                    }
                    Body.styleComponent.NextCombatStyle = BossQueenKula.taunt;
                }
            }
            base.Think();
        }
...
namespace DOL.GS
{
    public class BossKingTuscar : GameEpicBoss
    {
        public BossKingTuscar() : base() { }
        ...
        public override void OnAttackEnemy(AttackData ad)//on enemy actions
        {
            ...
            if (BossQueenKula.QueenKulaCount == 0 || (HealthPercent <= 50 && KingTuscarBrain.TuscarRage==true))
            {
        ...
        public override void Think()
        {
            ...
            if (Body.InCombat && HasAggro)
            {
                ...
                if (Body.TargetObject != null)
                {
                    ...
                    if(BossQueenKula.QueenKulaCount == 1)
                    {
                        Body.Strength = 350;
                    }
                    if (BossQueenKula.QueenKulaCount == 0 || Body.HealthPercent <= 50)
                    {
                        Body.Strength = 500;
                    }
                }
