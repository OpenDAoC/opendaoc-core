...
namespace DOL.GS
{
    public class BossElderCouncilBirghir : GameEpicBoss
    {
        public BossElderCouncilBirghir() : base()
        {
        }
...
namespace DOL.GS
{
    public class BossElderCouncilGuthlac : GameEpicBoss
    {
        public BossElderCouncilGuthlac() : base()
        {
        }
        public override int GetResist(EDamageType damageType)
        {
