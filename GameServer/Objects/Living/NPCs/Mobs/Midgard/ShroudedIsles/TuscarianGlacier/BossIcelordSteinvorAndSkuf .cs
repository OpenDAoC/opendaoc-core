...
namespace DOL.GS
{
    public class BossIcelordSteinvor : GameEpicBoss
    {
        public BossIcelordSteinvor() : base()
        {
        }
        ...
        public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (npcs.Length == 0)
            {
                ...
                BossIcelordSteinvor TG = new BossIcelordSteinvor();
                ...
                TG.RespawnInterval =
                    ServerProperties.ServerProperties.SET_SI_EPIC_ENCOUNTER_RESPAWNINTERVAL *
...
namespace DOL.GS
{
    public class BossIcelordSkuf : GameEpicBoss
    {
        public BossIcelordSkuf() : base()
        {
        }
        public override int GetResist(EDamageType damageType)
        {
        ...
        public static void ScriptLoaded(CoreEvent e, object sender, EventArgs args)
        {
            ...
            if (npcs.Length == 0)
            {
                ...
                BossIcelordSkuf TG = new BossIcelordSkuf();
