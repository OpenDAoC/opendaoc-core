...
namespace DOL.GS
{
    public class Doppelganger : GameSummoner
    {
        ...
        protected void Disguise()
        {
            ...
            IPlayerClass characterClass = new DefaultPlayerClass();
            ...
            switch (UtilCollection.Random(2))
            {
                case 0: // Albion
                    ...
                    {
                        case 0: // Archer
                            Inventory = GuardInventoryMgr.Albion_Archer.CloneTemplate();
                            SwitchWeapon(EActiveWeaponSlot.Distance);
                            characterClass = new ClassScout();
                            break;
                        case 1: // Caster
                            Inventory = GuardInventoryMgr.Albion_Caster.CloneTemplate();
                            characterClass = new ClassTheurgist();
                            break;
                        case 2: // Fighter
                            Inventory = GuardInventoryMgr.Albion_Fighter.CloneTemplate();
                            characterClass = new ClassArmsman();
                            break;
                        case 3: // GuardHealer
                            Inventory = GuardInventoryMgr.Albion_Healer.CloneTemplate();
                            characterClass = new ClassCleric();
                            break;
                        case 4: // Stealther
                            Inventory = GuardInventoryMgr.Albion_Stealther.CloneTemplate();
                ...
                case 1: // Hibernia
                    ...
                    {
                        case 0: // Archer
                            Inventory = GuardInventoryMgr.Hibernia_Archer.CloneTemplate();
                            SwitchWeapon(EActiveWeaponSlot.Distance);
                            characterClass = new ClassRanger();
                            break;
                        case 1: // Caster
                            Inventory = GuardInventoryMgr.Hibernia_Caster.CloneTemplate();
                            characterClass = new ClassEldritch();
                            break;
                        case 2: // Fighter
                            Inventory = GuardInventoryMgr.Hibernia_Fighter.CloneTemplate();
                            characterClass = new ClassArmsman();
                            break;
                        case 3: // GuardHealer
                            Inventory = GuardInventoryMgr.Hibernia_Healer.CloneTemplate();
                            characterClass = new ClassDruid();
                            break;
                        case 4: // Stealther
                            Inventory = GuardInventoryMgr.Hibernia_Stealther.CloneTemplate();
                ...
                case 2: // Midgard
                    ...
                    {
                        case 0: // Archer
                            Inventory = GuardInventoryMgr.Midgard_Archer.CloneTemplate();
                            SwitchWeapon(EActiveWeaponSlot.Distance);
                            characterClass = new ClassHunter();
                            break;
                        case 1: // Caster
                            Inventory = GuardInventoryMgr.Midgard_Caster.CloneTemplate();
                            characterClass = new ClassRunemaster();
                            break;
                        case 2: // Fighter
                            Inventory = GuardInventoryMgr.Midgard_Fighter.CloneTemplate();
                            characterClass = new ClassWarrior();
                            break;
                        case 3: // GuardHealer
                            Inventory = GuardInventoryMgr.Midgard_Healer.CloneTemplate();
                            characterClass = new ClassHealer();
                            break;
                        case 4: // Stealther
                            Inventory = GuardInventoryMgr.Midgard_Stealther.CloneTemplate();
