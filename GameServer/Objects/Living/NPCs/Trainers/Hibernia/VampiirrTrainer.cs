...
namespace DOL.GS.Trainer
{
	...
	/// Vampiir Trainer
	/// </summary>
	[NpcGuild("Vampiir Trainer", ERealm.Hibernia)]		// this attribute instructs DOL to use this script for all "Vampiir Trainer" NPC's in Albion (multiple guilds are possible for one script)
