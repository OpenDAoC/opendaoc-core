...
namespace DOL.GS.Trainer
{
	...
	/// Scout Trainer
	/// </summary>
	[NpcGuild("Scout Trainer", ERealm.Albion)]		// this attribute instructs DOL to use this script for all "Scout Trainer" NPC's in Albion (multiple guilds are possible for one script)
