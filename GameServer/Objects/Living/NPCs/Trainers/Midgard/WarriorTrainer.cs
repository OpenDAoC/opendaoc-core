...
namespace DOL.GS.Trainer
{
	...
	/// Warrior Trainer
	/// </summary>	
	[NpcGuild("Warrior Trainer", ERealm.Midgard)]		// this attribute instructs DOL to use this script for all "Warrior Trainer" NPC's in Albion (multiple guilds are possible for one script)
