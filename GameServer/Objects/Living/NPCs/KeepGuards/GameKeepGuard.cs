...
namespace DOL.GS.Keeps
{
	...
	public class GameKeepGuard : GameNpc, IKeepItem
	{
		...
		private GuardPatrol m_Patrol = null;
		public GuardPatrol PatrolGroup
		{
			get { return m_Patrol; }
			set { m_Patrol = value; }
		}
		...
		public override bool AddToWorld()
		{
			...
			if (PatrolGroup != null && !m_changingPositions)
			{
				...
				MoveOnPath(GuardPatrol.PATROL_SPEED);
			}
		...
		{
			GuardInventoryMgr.EquipGuard(this);

			if (this is RvrCraftingMerchant)
			{
				if (IsAlive)
				{
		...
		public void RefreshTemplate()
		{
			...
			SetAggression();
			GuardInventoryMgr.EquipGuard(this);
			GuardInventoryMgr.SetEmblem(this);
		}
		...
		private void SetGuild()
		{
			...
			else if ((Component.Keep.Guild == null || Component.Keep.Guild != null)&& this is RvrCraftingMerchant)
			{
				GuildName = "Merchant";
			}
