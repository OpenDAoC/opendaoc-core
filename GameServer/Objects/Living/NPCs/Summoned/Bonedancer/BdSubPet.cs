...
namespace DOL.GS
{
    public class BdSubPet : BdPet
    {
        ...
        public bool MinionsAssisting {
            get { return Owner is BdCommanderPet commander && commander.MinionsAssisting; }
        }
        ...
        /// </summary>
        public void MinionGetWeapon(BdCommanderPet.eWeaponType weaponType)
        {
            DbItemTemplates itemTemp = BdCommanderPet.GetWeaponTemplate(weaponType);
        ...
        {
            BdCommanderPet commander = (this.Brain as IControlledBrain).Owner as BdCommanderPet;
