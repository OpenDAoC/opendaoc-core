    ...
    public class GameEpicBoss : GameNpc {
        ...
        public override void Die(GameObject killer)//current orb reward for epic boss is 1500
        {
            try
            {
                ...
                if (this is BossXanxicar)//Alb dragon SI, he is weaker than realm dragons
                    OrbsReward = 3000;

                if (this is BossNosdoden)//Mid mutated dragon SI, he is weaker than realm dragons
                    OrbsReward = 3000;

                if (this is BossMyrddraxis)//Hib dragon SI, he is weaker than realm dragons
                    OrbsReward = 3000;
