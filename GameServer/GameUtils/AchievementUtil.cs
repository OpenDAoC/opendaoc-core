...
public class AchievementUtil
{
    ...
    public static IList<string> GetAchievementInfoForPlayer(GamePlayer player)
    {
        ...
        var achievements = CoreDb<DbAchievements>.SelectObjects(DB.Column("AccountID")
        ...
        List<DbAchievements> HibAchievements = new List<DbAchievements>();
        List<DbAchievements> MidAchievements= new List<DbAchievements>();
        List<DbAchievements> AlbAchievements = new List<DbAchievements>();
    ...
    public static List<DbAchievements> GetAchievementInfoForPlayerPerRealm(GamePlayer player, int realm)
    {
        var achievements = CoreDb<DbAchievements>.SelectObjects(DB.Column("AccountID")
            .IsEqualTo(player.Client.Account.ObjectId));
        ...
        var RealmAchievements = new List<DbAchievements>();
