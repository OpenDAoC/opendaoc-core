...
public class PlayerDeckMgr
{
    ...
    private void Shuffle()
    {
        ...
        {
            cardsLength--;
            int k = UtilCollection.CryptoNextInt(cardsLength + 1);
    ...
    public double GetPseudoDouble()
    {
        ...
        first--;
        int second = UtilCollection.CryptoNextInt(100); //just use a simple random for the .XX values
