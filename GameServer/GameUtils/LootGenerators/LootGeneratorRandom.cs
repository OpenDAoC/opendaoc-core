		...
		public override LootList GenerateLoot(GameNPC mob, GameObject killer)
		{
			...
			if (UtilCollection.Chance(10))
			{
				...
				if (realm < ERealm._FirstPlayerRealm || realm > ERealm._LastPlayerRealm)
					realm = (ERealm)UtilCollection.Random((int)ERealm._FirstPlayerRealm, (int)ERealm._LastPlayerRealm);
				...
				{
					DbItemTemplates itemTemplate = itemTemplates[UtilCollection.Random(itemTemplates.Length - 1)];
