...
namespace DOL.GS
{
	...
	public class GuildUtil
	{
		...
		public enum EGuildBonusType : byte
		{
			None = 0,
			RealmPoints = 1,
		...
		public static string BonusTypeToName(EGuildBonusType guildBonusType)
		{
			string bonusName = "None";

			switch (guildBonusType)
			{
				case GuildUtil.EGuildBonusType.ArtifactXP:
				...
				case GuildUtil.EGuildBonusType.Experience:
					...
					break;
				case GuildUtil.EGuildBonusType.MasterLevelXP:
		...
		/// </summary>
		public GuildUtil(DbGuilds dbGuild)
		{
		...
		/// </summary>
		/// <returns>true or false</returns>
		public bool HasRank(GamePlayer member, GuildUtil.EGuildRank rankNeeded)
		{
			try
			{
                ...
                switch (rankNeeded)
                {
                    case GuildUtil.EGuildRank.Emblem:
                        {
                            return member.GuildRank.Emblem;
                        }
                    case GuildUtil.EGuildRank.AcHear:
                        {
                            return member.GuildRank.AcHear;
                        }
                    case GuildUtil.EGuildRank.AcSpeak:
                        {
                            return member.GuildRank.AcSpeak;
                        }
                    case GuildUtil.EGuildRank.Demote:
                        {
                            return member.GuildRank.Promote;
                        }
                    case GuildUtil.EGuildRank.Promote:
                        {
                            return member.GuildRank.Promote;
                        }
                    case GuildUtil.EGuildRank.GcHear:
                        {
                            return member.GuildRank.GcHear;
                        }
                    case GuildUtil.EGuildRank.GcSpeak:
                        {
                            return member.GuildRank.GcSpeak;
                        }
                    case GuildUtil.EGuildRank.Invite:
                        {
                            return member.GuildRank.Invite;
                        }
                    case GuildUtil.EGuildRank.OcHear:
                        {
                            return member.GuildRank.OcHear;
                        }
                    case GuildUtil.EGuildRank.OcSpeak:
                        {
                            return member.GuildRank.OcSpeak;
                        }
                    case GuildUtil.EGuildRank.Remove:
                        {
                            return member.GuildRank.Remove;
                        }
                    case GuildUtil.EGuildRank.Alli:
                        {
                            return member.GuildRank.Alli;
                        }
                    case GuildUtil.EGuildRank.View:
                        {
                            return member.GuildRank.View;
                        }
                    case GuildUtil.EGuildRank.Claim:
                        {
                            return member.GuildRank.Claim;
                        }
                    case GuildUtil.EGuildRank.Release:
                        {
                            return member.GuildRank.Release;
                        }
                    case GuildUtil.EGuildRank.Upgrade:
                        {
                            return member.GuildRank.Upgrade;
                        }
                    case GuildUtil.EGuildRank.Dues:
                        {
                            return member.GuildRank.Dues;
                        }
                    case GuildUtil.EGuildRank.Withdraw:
                        {
                            return member.GuildRank.Withdraw;
                        }
                    case GuildUtil.EGuildRank.Leader:
                        {
                            return (member.GuildRank.RankLevel == 0);
                        }
                    case GuildUtil.EGuildRank.Buff:
                        {
		...
		public void SendMessageToGuildMembers(string msg, PacketHandler.EChatType type, PacketHandler.EChatLoc loc)
		{
			...
			{
				if (!HasRank(pl, GuildUtil.EGuildRank.GcHear))
				{
					continue;
				}
		...
		/// </summary>
		public EGuildBonusType GuildBonusType
		{
			get 
			{ 
